# fhir-package-narrative

## Purpose

Defines how the publisher generates FHIR narrative (`text` element) for resources by converting sidecar markdown files to XHTML using CommonMark.
