...
pub static CARDINALITIES: once_cell::sync::Lazy<Vec<rh_foundation::ElementCardinality>> =
    once_cell::sync::Lazy::new(|| {
        vec![
            ...
            rh_foundation::ElementCardinality::new("Signature.type", 0, None),
            rh_foundation::ElementCardinality::new("Signature.when", 0, Some(1)),
            rh_foundation::ElementCardinality::new("Signature.who", 0, Some(1)),
