...
pub struct AppointmentResponse {
    ...
    pub proposed_new_time: Option<BooleanType>,
    /// Extension element for the 'proposedNewTime' primitive field. Contains metadata and extensions.
    #[serde(rename = "_proposedNewTime")]
    pub _proposed_new_time: Option<Element>,
    ...
    pub participant_status: AppointmentresponseStatus,
    ...
    pub recurring: Option<BooleanType>,
    /// Extension element for the 'recurring' primitive field. Contains metadata and extensions.
    pub _recurring: Option<Element>,
    /// Original date within a recurring request
    #[serde(rename = "occurrenceDate")]
    pub occurrence_date: Option<DateType>,
...
impl Default for AppointmentResponse {
    fn default() -> Self {
        Self {
            ...
            proposed_new_time: Default::default(),
            _proposed_new_time: Default::default(),
...
pub static INVARIANTS: once_cell::sync::Lazy<Vec<rh_foundation::Invariant>> =
    once_cell::sync::Lazy::new(|| {
        vec![
    rh_foundation::Invariant::new("apr-1", rh_foundation::Severity::Error, "Either the participantType or actor must be specified", "participantType.exists() or actor.exists()"),
...
pub static CARDINALITIES: once_cell::sync::Lazy<Vec<rh_foundation::ElementCardinality>> =
    once_cell::sync::Lazy::new(|| {
        vec![
            ...
            rh_foundation::ElementCardinality::new("AppointmentResponse.recurring", 0, Some(1)),
            rh_foundation::ElementCardinality::new(
                "AppointmentResponse.occurrenceDate",
                0,
                Some(1),
            ),
            rh_foundation::ElementCardinality::new("AppointmentResponse.recurrenceId", 0, Some(1)),
        ]
    });
...
impl crate::traits::appointment_response::AppointmentResponseMutators for AppointmentResponse {
    ...
    fn set_proposed_new_time(self, value: bool) -> Self {
        let mut resource = self.clone();
        resource.proposed_new_time = Some(value);
        resource
    }
    ...
    fn set_recurring(self, value: bool) -> Self {
        let mut resource = self.clone();
        resource.recurring = Some(value);
        resource
    }
    fn set_occurrence_date(self, value: String) -> Self {
        let mut resource = self.clone();
        resource.occurrence_date = Some(value);
        resource
    }
...
impl crate::traits::appointment_response::AppointmentResponseExistence for AppointmentResponse {
    ...
    fn has_proposed_new_time(&self) -> bool {
        self.proposed_new_time.is_some()
    }
