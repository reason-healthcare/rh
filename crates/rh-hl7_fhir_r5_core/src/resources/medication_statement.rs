...
pub struct MedicationStatement {
    ...
    /// The date/time or interval when the medication is/was/will be taken (Timing)
...
/// MedicationStatement nested structure for the 'adherence' field
#[derive(Debug, Clone, Serialize, Deserialize)]
...
impl Default for MedicationStatement {
    fn default() -> Self {
        Self {
            ...
            related_clinical_information: Default::default(),
...
pub static CARDINALITIES: once_cell::sync::Lazy<Vec<rh_foundation::ElementCardinality>> =
    once_cell::sync::Lazy::new(|| {
        vec![
            ...
            rh_foundation::ElementCardinality::new("MedicationStatement.category", 0, None),
            rh_foundation::ElementCardinality::new("MedicationStatement.medication", 1, Some(1)),
            rh_foundation::ElementCardinality::new("MedicationStatement.subject", 1, Some(1)),
            rh_foundation::ElementCardinality::new("MedicationStatement.encounter", 0, Some(1)),
            ...
            rh_foundation::ElementCardinality::new("MedicationStatement.reason", 0, None),
            ...
            rh_foundation::ElementCardinality::new("MedicationStatement.adherence", 0, Some(1)),
            rh_foundation::ElementCardinality::new("MedicationStatement.adherence.id", 0, Some(1)),
            rh_foundation::ElementCardinality::new(
...
impl crate::traits::medication_statement::MedicationStatementAccessors for MedicationStatement {
    ...
    fn related_clinical_information(&self) -> &[Reference] {
        self.related_clinical_information.as_slice()
    }
...
impl crate::traits::medication_statement::MedicationStatementMutators for MedicationStatement {
    ...
    fn set_related_clinical_information(self, value: Vec<Reference>) -> Self {
        let mut resource = self.clone();
        resource.related_clinical_information = value;
        resource
    }
    fn add_related_clinical_information(self, item: Reference) -> Self {
        let mut resource = self.clone();
        resource.related_clinical_information.push(item);
        resource
    }
...
impl crate::traits::medication_statement::MedicationStatementExistence for MedicationStatement {
    ...
    fn has_related_clinical_information(&self) -> bool {
        !self.related_clinical_information.is_empty()
    }
