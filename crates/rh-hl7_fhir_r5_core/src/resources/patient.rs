...
pub static INVARIANTS: once_cell::sync::Lazy<Vec<rh_foundation::Invariant>> =
    ...
    rh_foundation::Invariant::new("pat-1", rh_foundation::Severity::Error, "SHALL at least contain a contact's details or a reference to an organization", "name.exists() or telecom.exists() or address.exists() or organization.exists()"),
]
    });
...
pub static BINDINGS: once_cell::sync::Lazy<Vec<rh_foundation::ElementBinding>> =
    once_cell::sync::Lazy::new(|| {
        vec![
    rh_foundation::ElementBinding::new("Patient.communication.language", rh_foundation::BindingStrength::Required, "http://hl7.org/fhir/ValueSet/all-languages|5.0.0").with_description("IETF language tag for a human language"),
    rh_foundation::ElementBinding::new("Patient.contact.gender", rh_foundation::BindingStrength::Required, "http://hl7.org/fhir/ValueSet/administrative-gender|5.0.0").with_description("The gender of a person used for administrative purposes."),
    rh_foundation::ElementBinding::new("Patient.gender", rh_foundation::BindingStrength::Required, "http://hl7.org/fhir/ValueSet/administrative-gender|5.0.0").with_description("The gender of a person used for administrative purposes."),
    rh_foundation::ElementBinding::new("Patient.language", rh_foundation::BindingStrength::Required, "http://hl7.org/fhir/ValueSet/all-languages|5.0.0").with_description("IETF language tag for a human language"),
    rh_foundation::ElementBinding::new("Patient.link.type", rh_foundation::BindingStrength::Required, "http://hl7.org/fhir/ValueSet/link-type|5.0.0").with_description("The type of link between this patient resource and another Patient resource, or Patient/RelatedPerson when using the `seealso` code"),
]
    });
