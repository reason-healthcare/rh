...
pub struct ExplanationOfBenefit {
    ...
    #[serde(default, skip_serializing_if = "Vec::is_empty")]
    pub pre_auth_ref_period: Vec<Period>,
...
/// ExplanationOfBenefitItem nested structure for the 'bodySite' field
#[derive(Debug, Clone, Serialize, Deserialize)]
...
pub struct ExplanationOfBenefitProcessnote {
    ...
    /// Note purpose
    ///
    /// Binding: extensible (The presentation types of notes.)
    ///
...
pub struct ExplanationOfBenefitSupportinginfo {
    ...
    /// Data to be provided (Identifier)
...
/// ExplanationOfBenefitAdditem nested structure for the 'bodySite' field
#[derive(Debug, Clone, Serialize, Deserialize)]
...
/// ExplanationOfBenefitItem nested structure for the 'reviewOutcome' field
#[derive(Debug, Clone, Serialize, Deserialize)]
...
pub struct ExplanationOfBenefitAdditem {
    ...
    #[serde(default, skip_serializing_if = "Vec::is_empty")]
    pub _sub_detail_sequence: Vec<Element>,
    /// Number for tracking
    #[serde(rename = "traceNumber")]
    #[serde(default, skip_serializing_if = "Vec::is_empty")]
    pub trace_number: Vec<Identifier>,
...
/// ExplanationOfBenefit nested structure for the 'event' field
#[derive(Debug, Clone, Serialize, Deserialize)]
...
impl Default for ExplanationOfBenefit {
    fn default() -> Self {
        Self {
            ...
            diagnosis_related_group: Default::default(),
...
impl Default for ExplanationOfBenefitItemDetail {
    fn default() -> Self {
        Self {
            ...
            product_or_service_end: Default::default(),
            ...
            review_outcome: Default::default(),
            adjudication: Default::default(),
        }
    }
}
    ...
    once_cell::sync::Lazy::new(|| {
        vec![
            ...
            rh_foundation::ElementBinding::new(
                ...
                rh_foundation::BindingStrength::Required,
                "http://hl7.org/fhir/ValueSet/claim-outcome|5.0.0",
            )
            ...
            rh_foundation::ElementBinding::new(
                ...
                rh_foundation::BindingStrength::Required,
                "http://hl7.org/fhir/ValueSet/explanationofbenefit-status|5.0.0",
            )
            .with_description("A code specifying the state of the resource instance."),
            rh_foundation::ElementBinding::new(
                "ExplanationOfBenefit.use",
                rh_foundation::BindingStrength::Required,
                "http://hl7.org/fhir/ValueSet/claim-use|5.0.0",
            )
...
pub static CARDINALITIES: once_cell::sync::Lazy<Vec<rh_foundation::ElementCardinality>> =
    once_cell::sync::Lazy::new(|| {
        vec![
            ...
            rh_foundation::ElementCardinality::new("ExplanationOfBenefit.traceNumber", 0, None),
            ...
            rh_foundation::ElementCardinality::new("ExplanationOfBenefit.insurer", 0, Some(1)),
            rh_foundation::ElementCardinality::new("ExplanationOfBenefit.provider", 0, Some(1)),
            ...
            rh_foundation::ElementCardinality::new("ExplanationOfBenefit.event", 0, None),
            rh_foundation::ElementCardinality::new("ExplanationOfBenefit.event.id", 0, Some(1)),
            rh_foundation::ElementCardinality::new("ExplanationOfBenefit.event.extension", 0, None),
            rh_foundation::ElementCardinality::new(
                "ExplanationOfBenefit.event.modifierExtension",
                0,
                None,
            ),
            rh_foundation::ElementCardinality::new("ExplanationOfBenefit.event.type", 1, Some(1)),
            rh_foundation::ElementCardinality::new(
            ...
            rh_foundation::ElementCardinality::new("ExplanationOfBenefit.encounter", 0, None),
            ...
            rh_foundation::ElementCardinality::new("ExplanationOfBenefit.decision", 0, Some(1)),
            ...
            rh_foundation::ElementCardinality::new("ExplanationOfBenefit.insurance", 0, None),
            ...
            rh_foundation::ElementCardinality::new("ExplanationOfBenefit.patientPaid", 0, Some(1)),
            ...
            rh_foundation::ElementCardinality::new("ExplanationOfBenefit.item.request", 0, None),
            ...
            rh_foundation::ElementCardinality::new("ExplanationOfBenefit.item.tax", 0, Some(1)),
            ...
            rh_foundation::ElementCardinality::new("ExplanationOfBenefit.item.bodySite", 0, None),
            rh_foundation::ElementCardinality::new(
            ...
            rh_foundation::ElementCardinality::new("ExplanationOfBenefit.addItem.request", 0, None),
            rh_foundation::ElementCardinality::new(
            ...
            rh_foundation::ElementCardinality::new("ExplanationOfBenefit.addItem.tax", 0, Some(1)),
...
impl crate::traits::explanation_of_benefit::ExplanationOfBenefitAccessors for ExplanationOfBenefit {
    ...
    fn event(&self) -> &[ExplanationOfBenefitEvent] {
        self.event.as_slice()
    }
    ...
    fn pre_auth_ref(&self) -> &[StringType] {
        self.pre_auth_ref.as_slice()
    }
    fn pre_auth_ref_period(&self) -> &[Period] {
        self.pre_auth_ref_period.as_slice()
    }
    ...
    fn patient_paid(&self) -> Option<Money> {
...
impl crate::traits::explanation_of_benefit::ExplanationOfBenefitMutators for ExplanationOfBenefit {
    ...
    fn set_event(self, value: Vec<ExplanationOfBenefitEvent>) -> Self {
        let mut resource = self.clone();
        resource.event = value;
        resource
    }
    fn add_event(self, item: ExplanationOfBenefitEvent) -> Self {
        let mut resource = self.clone();
    ...
    fn set_patient_paid(self, value: Money) -> Self {
        let mut resource = self.clone();
        resource.patient_paid = Some(value);
        resource
    }
...
impl crate::traits::explanation_of_benefit::ExplanationOfBenefitExistence for ExplanationOfBenefit {
    ...
    fn has_pre_auth_ref(&self) -> bool {
        !self.pre_auth_ref.is_empty()
    }
    fn has_pre_auth_ref_period(&self) -> bool {
        !self.pre_auth_ref_period.is_empty()
    }
