...
pub static INVARIANTS: once_cell::sync::Lazy<Vec<rh_foundation::Invariant>> =
    ...
    rh_foundation::Invariant::new("tcp-1", rh_foundation::Severity::Error, "If there is more than one version, a version code must be defined", "version.count() > 1 implies version.all(code.exists())"),
    rh_foundation::Invariant::new("tcp-2", rh_foundation::Severity::Error, "A Terminology Capability statement SHALL have at least one of description, software, or implementation element", "(description.count() + software.count() + implementation.count()) > 0"),
    rh_foundation::Invariant::new("tcp-3", rh_foundation::Severity::Error, "If kind = instance, implementation must be present and software may be present", "(kind != 'instance') or implementation.exists()"),
    rh_foundation::Invariant::new("tcp-4", rh_foundation::Severity::Error, "If kind = capability, implementation must be absent, software must be present", "(kind != 'capability') or (implementation.exists().not() and software.exists())"),
    rh_foundation::Invariant::new("tcp-5", rh_foundation::Severity::Error, "If kind = requirements, implementation and software must be absent", "(kind!='requirements') or (implementation.exists().not() and software.exists().not())"),
    rh_foundation::Invariant::new("tcp-6", rh_foundation::Severity::Error, "Each instance of the codeSystem element must represent a distinct code system.", "codeSystem.uri.isDistinct()"),
    rh_foundation::Invariant::new("tcp-7", rh_foundation::Severity::Error, "Each version.code element must be distinct for a particular code system.", "version.code.isDistinct()"),
    rh_foundation::Invariant::new("tcp-8", rh_foundation::Severity::Error, "A codeSystem element instance may have at most one version.isDefault element with a value of 'true'.", "version.where(isDefault = true).count() <= 1"),
]
    });
...
pub static BINDINGS: once_cell::sync::Lazy<Vec<rh_foundation::ElementBinding>> =
    once_cell::sync::Lazy::new(|| {
        vec![
    rh_foundation::ElementBinding::new("TerminologyCapabilities.codeSearch", rh_foundation::BindingStrength::Required, "http://hl7.org/fhir/ValueSet/code-search-support|5.0.0").with_description("The degree to which the server supports the code search parameter on ValueSet, if it is supported."),
    rh_foundation::ElementBinding::new("TerminologyCapabilities.codeSystem.content", rh_foundation::BindingStrength::Required, "http://hl7.org/fhir/ValueSet/codesystem-content-mode|5.0.0").with_description("The extent of the content of the code system (the concepts and codes it defines) are represented in a code system resource."),
    rh_foundation::ElementBinding::new("TerminologyCapabilities.codeSystem.version.language", rh_foundation::BindingStrength::Required, "http://hl7.org/fhir/ValueSet/languages|5.0.0").with_description("IETF language tag"),
    rh_foundation::ElementBinding::new("TerminologyCapabilities.kind", rh_foundation::BindingStrength::Required, "http://hl7.org/fhir/ValueSet/capability-statement-kind|5.0.0").with_description("How a capability statement is intended to be used."),
    rh_foundation::ElementBinding::new("TerminologyCapabilities.language", rh_foundation::BindingStrength::Required, "http://hl7.org/fhir/ValueSet/all-languages|5.0.0").with_description("IETF language tag for a human language"),
    rh_foundation::ElementBinding::new("TerminologyCapabilities.status", rh_foundation::BindingStrength::Required, "http://hl7.org/fhir/ValueSet/publication-status|5.0.0").with_description("The lifecycle status of an artifact."),
]
    });
...
pub static CARDINALITIES: once_cell::sync::Lazy<Vec<rh_foundation::ElementCardinality>> =
    once_cell::sync::Lazy::new(|| {
        vec![
            ...
            rh_foundation::ElementCardinality::new("TerminologyCapabilities.identifier", 0, None),
...
impl crate::validation::ValidatableResource for TerminologyCapabilities {
