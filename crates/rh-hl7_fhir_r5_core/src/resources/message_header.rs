...
pub struct MessageHeader {
    ...
    /// Event code or link to EventDefinition (Coding)
    #[serde(rename = "eventCoding")]
    pub event_coding: Coding,
    /// Event code or link to EventDefinition (canonical)
...
pub struct MessageHeaderSource {
    ...
    #[serde(flatten)]
    pub base: BackboneElement,
    /// Actual source address or Endpoint resource (url)
    #[serde(rename = "endpointUrl")]
    pub endpoint_url: Option<StringType>,
    /// Actual source address or Endpoint resource (Reference)
    #[serde(rename = "endpointReference")]
    pub endpoint_reference: Option<Reference>,
    /// Name of system
    pub name: Option<StringType>,
...
impl Default for MessageHeader {
    fn default() -> Self {
        Self {
            ...
            event_canonical: Default::default(),
    ...
    once_cell::sync::Lazy::new(|| {
        vec![
            ...
            rh_foundation::ElementBinding::new(
                ...
                rh_foundation::BindingStrength::Required,
                "http://hl7.org/fhir/ValueSet/response-code|5.0.0",
            )
...
pub static CARDINALITIES: once_cell::sync::Lazy<Vec<rh_foundation::ElementCardinality>> =
    once_cell::sync::Lazy::new(|| {
        vec![
            ...
            rh_foundation::ElementCardinality::new("MessageHeader.source.endpoint[x]", 0, Some(1)),
