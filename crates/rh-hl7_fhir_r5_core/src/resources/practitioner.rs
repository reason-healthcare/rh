...
pub struct Practitioner {
    ...
    /// Indicates if the practitioner is deceased or not (boolean)
    #[serde(rename = "deceasedBoolean")]
    pub deceased_boolean: Option<BooleanType>,
    /// Indicates if the practitioner is deceased or not (dateTime)
...
pub static CARDINALITIES: once_cell::sync::Lazy<Vec<rh_foundation::ElementCardinality>> =
    once_cell::sync::Lazy::new(|| {
        vec![
            ...
            rh_foundation::ElementCardinality::new("Practitioner.deceased[x]", 0, Some(1)),
            ...
            rh_foundation::ElementCardinality::new("Practitioner.communication.id", 0, Some(1)),
            rh_foundation::ElementCardinality::new("Practitioner.communication.extension", 0, None),
            rh_foundation::ElementCardinality::new(
...
impl crate::traits::practitioner::PractitionerAccessors for Practitioner {
    ...
    fn communication(&self) -> &[PractitionerCommunication] {
...
impl crate::traits::practitioner::PractitionerMutators for Practitioner {
    ...
    fn set_communication(self, value: Vec<PractitionerCommunication>) -> Self {
        let mut resource = self.clone();
        resource.communication = Some(value);
        resource
    }
    fn add_communication(self, item: PractitionerCommunication) -> Self {
        let mut resource = self.clone();
        resource
            .communication
            .get_or_insert_with(Vec::new)
