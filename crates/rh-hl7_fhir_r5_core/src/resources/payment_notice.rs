...
pub static CARDINALITIES: once_cell::sync::Lazy<Vec<rh_foundation::ElementCardinality>> =
    once_cell::sync::Lazy::new(|| {
        vec![
            ...
            rh_foundation::ElementCardinality::new("PaymentNotice.reporter", 0, Some(1)),
            rh_foundation::ElementCardinality::new("PaymentNotice.payment", 0, Some(1)),
...
impl crate::traits::payment_notice::PaymentNoticeAccessors for PaymentNotice {
    ...
    fn payment(&self) -> Option<Reference> {
        self.payment.clone()
    }
