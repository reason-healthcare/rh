use crate::bindings::specimen_combined::SpecimenCombined;
...
pub struct Specimen {
    ...
    /// grouped | pooled
    pub combined: Option<SpecimenCombined>,
    /// Extension element for the 'combined' primitive field. Contains metadata and extensions.
    pub _combined: Option<Element>,
    /// The role the specimen serves
    ///
    /// Binding: preferred (Codes describing specimen role.)
    ///
...
pub struct SpecimenCollection {
    ...
    ///
    /// Binding: example (The device that was used to obtain the specimen (e.g. a catheter or catheter part used to draw the blood via a central line).)
    ...
    once_cell::sync::Lazy::new(|| {
        vec![
            rh_foundation::ElementBinding::new(
                ...
                "http://hl7.org/fhir/ValueSet/specimen-combined|5.0.0",
            )
            .with_description("Codes for the combined status of a specimen."),
            rh_foundation::ElementBinding::new(
                "Specimen.language",
                rh_foundation::BindingStrength::Required,
            ...
            rh_foundation::ElementBinding::new(
                "Specimen.status",
                rh_foundation::BindingStrength::Required,
                "http://hl7.org/fhir/ValueSet/specimen-status|5.0.0",
            )
...
pub static CARDINALITIES: once_cell::sync::Lazy<Vec<rh_foundation::ElementCardinality>> =
    once_cell::sync::Lazy::new(|| {
        vec![
            ...
            rh_foundation::ElementCardinality::new("Specimen.combined", 0, Some(1)),
            rh_foundation::ElementCardinality::new("Specimen.role", 0, None),
            rh_foundation::ElementCardinality::new("Specimen.feature", 0, None),
            rh_foundation::ElementCardinality::new("Specimen.feature.id", 0, Some(1)),
            rh_foundation::ElementCardinality::new("Specimen.feature.extension", 0, None),
            rh_foundation::ElementCardinality::new("Specimen.feature.modifierExtension", 0, None),
            rh_foundation::ElementCardinality::new("Specimen.feature.type", 1, Some(1)),
            rh_foundation::ElementCardinality::new("Specimen.feature.description", 1, Some(1)),
            ...
            rh_foundation::ElementCardinality::new("Specimen.collection.device", 0, Some(1)),
            rh_foundation::ElementCardinality::new("Specimen.collection.procedure", 0, Some(1)),
            ...
            rh_foundation::ElementCardinality::new("Specimen.processing.method", 0, Some(1)),
            ...
            rh_foundation::ElementCardinality::new("Specimen.container.device", 1, Some(1)),
            rh_foundation::ElementCardinality::new("Specimen.container.location", 0, Some(1)),
            rh_foundation::ElementCardinality::new(
...
impl crate::traits::specimen::SpecimenAccessors for Specimen {
    ...
    fn combined(&self) -> Option<SpecimenCombined> {
        self.combined.clone()
    }
    fn role(&self) -> &[CodeableConcept] {
        self.role.as_deref().unwrap_or(&[])
    }
    fn feature(&self) -> &[SpecimenFeature] {
...
impl crate::traits::specimen::SpecimenMutators for Specimen {
    ...
    fn set_combined(self, value: SpecimenCombined) -> Self {
        let mut resource = self.clone();
        resource.combined = Some(value);
        resource
    }
    fn set_role(self, value: Vec<CodeableConcept>) -> Self {
        let mut resource = self.clone();
        resource.role = Some(value);
        resource
    }
    fn add_role(self, item: CodeableConcept) -> Self {
        let mut resource = self.clone();
        resource.role.get_or_insert_with(Vec::new).push(item);
        resource
    }
    fn set_feature(self, value: Vec<SpecimenFeature>) -> Self {
        let mut resource = self.clone();
        resource.feature = Some(value);
        resource
    }
    fn add_feature(self, item: SpecimenFeature) -> Self {
        let mut resource = self.clone();
        resource.feature.get_or_insert_with(Vec::new).push(item);
        resource
    }
...
impl crate::traits::specimen::SpecimenExistence for Specimen {
    ...
    fn has_role(&self) -> bool {
        self.role.as_ref().is_some_and(|v| !v.is_empty())
    }
    fn has_feature(&self) -> bool {
        self.feature.as_ref().is_some_and(|v| !v.is_empty())
    }
...
impl crate::validation::ValidatableResource for Specimen {
