...
pub struct DetectedIssue {
    ...
    pub status: DetectedissueStatus,
    /// Extension element for the 'status' primitive field. Contains metadata and extensions.
    pub _status: Option<Element>,
    /// Type of detected issue, e.g. drug-drug, duplicate therapy, etc
    ///
    /// Binding: preferred (Codes for high level detected issue categories.)
    ///
    ...
    ///
    /// Binding: preferred (Codes identifying the type of detected issue; e.g. Drug-drug interaction, Timing issue, Duplicate therapy, etc.)
    ///
    /// ValueSet: http://hl7.org/fhir/ValueSet/detectedissue-category
...
impl Default for DetectedIssue {
    fn default() -> Self {
        Self {
            ...
            status: DetectedissueStatus::default(),
...
pub static CARDINALITIES: once_cell::sync::Lazy<Vec<rh_foundation::ElementCardinality>> =
    once_cell::sync::Lazy::new(|| {
        vec![
            ...
            rh_foundation::ElementCardinality::new("DetectedIssue.category", 0, None),
            ...
            rh_foundation::ElementCardinality::new("DetectedIssue.subject", 0, Some(1)),
            rh_foundation::ElementCardinality::new("DetectedIssue.encounter", 0, Some(1)),
            ...
            rh_foundation::ElementCardinality::new("DetectedIssue.mitigation.note", 0, None),
        ]
    });
