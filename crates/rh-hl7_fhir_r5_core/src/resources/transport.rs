...
pub struct Transport {
    ...
    /// Transport Type
    ///
    /// Binding: example (Codes to identify what the transport involves.  These will typically be specific to a particular workflow.)
    ///
    ...
    pub completion_time: Option<DateTimeType>,
    /// Extension element for the 'completionTime' primitive field. Contains metadata and extensions.
    #[serde(rename = "_completionTime")]
    pub _completion_time: Option<Element>,
    ...
    /// Requested performer
    ///
    /// Binding: preferred (The type(s) of transport performers allowed.)
    ///
    ...
    ///
    /// Binding: example (Indicates why the transport is needed.  E.g. Suspended because patient admitted to hospital.)
...
pub struct TransportInput {
    ...
    /// Content to use in performing the transport (base64Binary)
    #[serde(rename = "valueBase64Binary")]
    pub value_base64_binary: Base64BinaryType,
    /// Content to use in performing the transport (boolean)
    #[serde(rename = "valueBoolean")]
    pub value_boolean: BooleanType,
    /// Content to use in performing the transport (canonical)
    #[serde(rename = "valueCanonical")]
    pub value_canonical: StringType,
    /// Content to use in performing the transport (code)
    #[serde(rename = "valueCode")]
    pub value_code: StringType,
    /// Content to use in performing the transport (date)
    #[serde(rename = "valueDate")]
    pub value_date: DateType,
    /// Content to use in performing the transport (dateTime)
    #[serde(rename = "valueDateTime")]
    pub value_date_time: DateTimeType,
    /// Content to use in performing the transport (decimal)
    #[serde(rename = "valueDecimal")]
    pub value_decimal: DecimalType,
    /// Content to use in performing the transport (id)
    #[serde(rename = "valueId")]
    pub value_id: StringType,
    /// Content to use in performing the transport (instant)
    #[serde(rename = "valueInstant")]
    pub value_instant: InstantType,
    /// Content to use in performing the transport (integer)
    #[serde(rename = "valueInteger")]
    pub value_integer: IntegerType,
    /// Content to use in performing the transport (integer64)
    #[serde(rename = "valueInteger64")]
    pub value_integer64: Integer64Type,
    /// Content to use in performing the transport (markdown)
    #[serde(rename = "valueMarkdown")]
    pub value_markdown: StringType,
    /// Content to use in performing the transport (oid)
    #[serde(rename = "valueOid")]
    pub value_oid: StringType,
    /// Content to use in performing the transport (positiveInt)
    #[serde(rename = "valuePositiveInt")]
    pub value_positive_int: PositiveIntType,
    /// Content to use in performing the transport (string)
    #[serde(rename = "valueString")]
    pub value_string: StringType,
    /// Content to use in performing the transport (time)
    #[serde(rename = "valueTime")]
    pub value_time: TimeType,
    /// Content to use in performing the transport (unsignedInt)
    #[serde(rename = "valueUnsignedInt")]
    pub value_unsigned_int: UnsignedIntType,
    /// Content to use in performing the transport (uri)
    #[serde(rename = "valueUri")]
    pub value_uri: StringType,
    /// Content to use in performing the transport (url)
    #[serde(rename = "valueUrl")]
    pub value_url: StringType,
    /// Content to use in performing the transport (uuid)
    #[serde(rename = "valueUuid")]
    pub value_uuid: StringType,
    /// Content to use in performing the transport (Address)
    #[serde(rename = "valueAddress")]
    pub value_address: Address,
    /// Content to use in performing the transport (Age)
    #[serde(rename = "valueAge")]
    pub value_age: Age,
    /// Content to use in performing the transport (Annotation)
    #[serde(rename = "valueAnnotation")]
    pub value_annotation: Annotation,
    /// Content to use in performing the transport (Attachment)
    #[serde(rename = "valueAttachment")]
    pub value_attachment: Attachment,
    /// Content to use in performing the transport (CodeableConcept)
    #[serde(rename = "valueCodeableConcept")]
    pub value_codeable_concept: CodeableConcept,
    /// Content to use in performing the transport (CodeableReference)
    #[serde(rename = "valueCodeableReference")]
    pub value_codeable_reference: CodeableReference,
    /// Content to use in performing the transport (Coding)
    #[serde(rename = "valueCoding")]
    pub value_coding: Coding,
    /// Content to use in performing the transport (ContactPoint)
    #[serde(rename = "valueContactPoint")]
    pub value_contact_point: ContactPoint,
    /// Content to use in performing the transport (Count)
    #[serde(rename = "valueCount")]
    pub value_count: Count,
    /// Content to use in performing the transport (Distance)
    #[serde(rename = "valueDistance")]
    pub value_distance: Distance,
    /// Content to use in performing the transport (Duration)
    #[serde(rename = "valueDuration")]
    pub value_duration: Duration,
    /// Content to use in performing the transport (HumanName)
    #[serde(rename = "valueHumanName")]
    pub value_human_name: HumanName,
    /// Content to use in performing the transport (Identifier)
    #[serde(rename = "valueIdentifier")]
    pub value_identifier: Identifier,
    /// Content to use in performing the transport (Money)
    #[serde(rename = "valueMoney")]
    pub value_money: Money,
    /// Content to use in performing the transport (Period)
    #[serde(rename = "valuePeriod")]
    pub value_period: Period,
    /// Content to use in performing the transport (Quantity)
    #[serde(rename = "valueQuantity")]
    pub value_quantity: Quantity,
    /// Content to use in performing the transport (Range)
    #[serde(rename = "valueRange")]
    pub value_range: Range,
    /// Content to use in performing the transport (Ratio)
    #[serde(rename = "valueRatio")]
    pub value_ratio: Ratio,
    /// Content to use in performing the transport (RatioRange)
    #[serde(rename = "valueRatioRange")]
    pub value_ratio_range: RatioRange,
    /// Content to use in performing the transport (Reference)
    #[serde(rename = "valueReference")]
    pub value_reference: Reference,
    /// Content to use in performing the transport (SampledData)
    #[serde(rename = "valueSampledData")]
    pub value_sampled_data: SampledData,
    /// Content to use in performing the transport (Signature)
    #[serde(rename = "valueSignature")]
    pub value_signature: Signature,
    /// Content to use in performing the transport (Timing)
    #[serde(rename = "valueTiming")]
    pub value_timing: Timing,
    /// Content to use in performing the transport (ContactDetail)
    #[serde(rename = "valueContactDetail")]
    pub value_contact_detail: ContactDetail,
    /// Content to use in performing the transport (DataRequirement)
    #[serde(rename = "valueDataRequirement")]
    pub value_data_requirement: DataRequirement,
    /// Content to use in performing the transport (Expression)
    #[serde(rename = "valueExpression")]
    pub value_expression: Expression,
    /// Content to use in performing the transport (ParameterDefinition)
    #[serde(rename = "valueParameterDefinition")]
    pub value_parameter_definition: ParameterDefinition,
    /// Content to use in performing the transport (RelatedArtifact)
    #[serde(rename = "valueRelatedArtifact")]
    pub value_related_artifact: RelatedArtifact,
    /// Content to use in performing the transport (TriggerDefinition)
    #[serde(rename = "valueTriggerDefinition")]
    pub value_trigger_definition: TriggerDefinition,
    /// Content to use in performing the transport (UsageContext)
    #[serde(rename = "valueUsageContext")]
    pub value_usage_context: UsageContext,
    /// Content to use in performing the transport (Availability)
    #[serde(rename = "valueAvailability")]
    pub value_availability: Availability,
    /// Content to use in performing the transport (ExtendedContactDetail)
    #[serde(rename = "valueExtendedContactDetail")]
    pub value_extended_contact_detail: ExtendedContactDetail,
    /// Content to use in performing the transport (Dosage)
...
impl Default for Transport {
    fn default() -> Self {
        Self {
            ...
            intent: TransportIntent::default(),
            ...
            completion_time: Default::default(),
            _completion_time: Default::default(),
            ...
            requested_location: Reference::default(),
            current_location: Reference::default(),
...
pub static BINDINGS: once_cell::sync::Lazy<Vec<rh_foundation::ElementBinding>> =
    once_cell::sync::Lazy::new(|| {
        vec![
            ...
            .with_description(
                "The priority of a transport (may affect service level applied to the transport).",
            ),
            rh_foundation::ElementBinding::new(
                "Transport.status",
                rh_foundation::BindingStrength::Required,
            ...
            .with_description("Status of the transport."),
        ]
    });
...
pub static CARDINALITIES: once_cell::sync::Lazy<Vec<rh_foundation::ElementCardinality>> =
    once_cell::sync::Lazy::new(|| {
        vec![
            rh_foundation::ElementCardinality::new("Transport.id", 0, Some(1)),
            rh_foundation::ElementCardinality::new("Transport.meta", 0, Some(1)),
            rh_foundation::ElementCardinality::new("Transport.implicitRules", 0, Some(1)),
            rh_foundation::ElementCardinality::new("Transport.language", 0, Some(1)),
            rh_foundation::ElementCardinality::new("Transport.text", 0, Some(1)),
            rh_foundation::ElementCardinality::new("Transport.contained", 0, None),
            rh_foundation::ElementCardinality::new("Transport.extension", 0, None),
            rh_foundation::ElementCardinality::new("Transport.modifierExtension", 0, None),
            rh_foundation::ElementCardinality::new("Transport.identifier", 0, None),
            rh_foundation::ElementCardinality::new("Transport.instantiatesCanonical", 0, Some(1)),
            rh_foundation::ElementCardinality::new("Transport.instantiatesUri", 0, Some(1)),
            rh_foundation::ElementCardinality::new("Transport.basedOn", 0, None),
            rh_foundation::ElementCardinality::new("Transport.groupIdentifier", 0, Some(1)),
            rh_foundation::ElementCardinality::new("Transport.partOf", 0, None),
            rh_foundation::ElementCardinality::new("Transport.status", 0, Some(1)),
            rh_foundation::ElementCardinality::new("Transport.statusReason", 0, Some(1)),
            rh_foundation::ElementCardinality::new("Transport.intent", 1, Some(1)),
            rh_foundation::ElementCardinality::new("Transport.priority", 0, Some(1)),
            rh_foundation::ElementCardinality::new("Transport.code", 0, Some(1)),
            rh_foundation::ElementCardinality::new("Transport.description", 0, Some(1)),
            rh_foundation::ElementCardinality::new("Transport.focus", 0, Some(1)),
            rh_foundation::ElementCardinality::new("Transport.for", 0, Some(1)),
            rh_foundation::ElementCardinality::new("Transport.encounter", 0, Some(1)),
            rh_foundation::ElementCardinality::new("Transport.completionTime", 0, Some(1)),
            rh_foundation::ElementCardinality::new("Transport.authoredOn", 0, Some(1)),
            rh_foundation::ElementCardinality::new("Transport.lastModified", 0, Some(1)),
            rh_foundation::ElementCardinality::new("Transport.requester", 0, Some(1)),
            rh_foundation::ElementCardinality::new("Transport.performerType", 0, None),
            rh_foundation::ElementCardinality::new("Transport.owner", 0, Some(1)),
            rh_foundation::ElementCardinality::new("Transport.location", 0, Some(1)),
            rh_foundation::ElementCardinality::new("Transport.insurance", 0, None),
            rh_foundation::ElementCardinality::new("Transport.note", 0, None),
            rh_foundation::ElementCardinality::new("Transport.relevantHistory", 0, None),
            rh_foundation::ElementCardinality::new("Transport.restriction", 0, Some(1)),
            rh_foundation::ElementCardinality::new("Transport.restriction.id", 0, Some(1)),
            rh_foundation::ElementCardinality::new("Transport.restriction.extension", 0, None),
            rh_foundation::ElementCardinality::new(
                "Transport.restriction.modifierExtension",
                0,
                None,
            ),
            rh_foundation::ElementCardinality::new("Transport.restriction.repetitions", 0, Some(1)),
            rh_foundation::ElementCardinality::new("Transport.restriction.period", 0, Some(1)),
            rh_foundation::ElementCardinality::new("Transport.restriction.recipient", 0, None),
            rh_foundation::ElementCardinality::new("Transport.input", 0, None),
            rh_foundation::ElementCardinality::new("Transport.input.id", 0, Some(1)),
            rh_foundation::ElementCardinality::new("Transport.input.extension", 0, None),
            rh_foundation::ElementCardinality::new("Transport.input.modifierExtension", 0, None),
            rh_foundation::ElementCardinality::new("Transport.input.type", 1, Some(1)),
            rh_foundation::ElementCardinality::new("Transport.input.value[x]", 1, Some(1)),
            rh_foundation::ElementCardinality::new("Transport.output", 0, None),
            rh_foundation::ElementCardinality::new("Transport.output.id", 0, Some(1)),
            rh_foundation::ElementCardinality::new("Transport.output.extension", 0, None),
            rh_foundation::ElementCardinality::new("Transport.output.modifierExtension", 0, None),
            rh_foundation::ElementCardinality::new("Transport.output.type", 1, Some(1)),
            rh_foundation::ElementCardinality::new("Transport.output.value[x]", 1, Some(1)),
            rh_foundation::ElementCardinality::new("Transport.requestedLocation", 1, Some(1)),
            rh_foundation::ElementCardinality::new("Transport.currentLocation", 1, Some(1)),
            rh_foundation::ElementCardinality::new("Transport.reason", 0, Some(1)),
            rh_foundation::ElementCardinality::new("Transport.history", 0, Some(1)),
        ]
    });

// Trait implementations
impl crate::traits::resource::ResourceAccessors for Transport {
...
impl crate::traits::resource::ResourceMutators for Transport {
    fn new() -> Self {
        Self::default()
    }
...
impl crate::traits::resource::ResourceExistence for Transport {
    fn has_id(&self) -> bool {
...
impl crate::traits::domain_resource::DomainResourceAccessors for Transport {
...
impl crate::traits::domain_resource::DomainResourceMutators for Transport {
    fn new() -> Self {
        Self::default()
    }
...
impl crate::traits::transport::TransportMutators for Transport {
    fn new() -> Self {
        Self::default()
    }
    ...
    fn set_completion_time(self, value: String) -> Self {
        let mut resource = self.clone();
        resource.completion_time = Some(value);
        resource
    }
    ...
    fn set_requested_location(self, value: Reference) -> Self {
        let mut resource = self.clone();
        resource.requested_location = value;
        resource
    }
    fn set_current_location(self, value: Reference) -> Self {
        let mut resource = self.clone();
        resource.current_location = value;
        resource
    }
...
impl crate::validation::ValidatableResource for Transport {
    ...
    fn profile_url() -> Option<&'static str> {
        Some("http://hl7.org/fhir/StructureDefinition/Transport")
    }
}

// Re-export traits for convenient importing
// This allows users to just import the resource module and get all associated traits
pub use crate::traits::transport::{TransportAccessors, TransportExistence, TransportMutators};
