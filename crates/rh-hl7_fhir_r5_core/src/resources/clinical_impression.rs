...
impl Default for ClinicalImpression {
    fn default() -> Self {
        Self {
            ...
            change_pattern: Default::default(),
...
pub static CARDINALITIES: once_cell::sync::Lazy<Vec<rh_foundation::ElementCardinality>> =
    once_cell::sync::Lazy::new(|| {
        vec![
            ...
            rh_foundation::ElementCardinality::new("ClinicalImpression.performer", 0, Some(1)),
            ...
            rh_foundation::ElementCardinality::new("ClinicalImpression.changePattern", 0, Some(1)),
            ...
            rh_foundation::ElementCardinality::new("ClinicalImpression.finding.item", 0, Some(1)),
...
impl crate::traits::clinical_impression::ClinicalImpressionMutators for ClinicalImpression {
    ...
    fn set_change_pattern(self, value: CodeableConcept) -> Self {
        let mut resource = self.clone();
        resource.change_pattern = Some(value);
        resource
    }
