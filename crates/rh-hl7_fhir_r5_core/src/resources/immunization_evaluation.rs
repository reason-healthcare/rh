...
pub struct ImmunizationEvaluation {
    ...
    pub dose_number: Option<StringType>,
    ...
    once_cell::sync::Lazy::new(|| {
        vec![
            ...
            rh_foundation::ElementBinding::new(
                ...
                rh_foundation::BindingStrength::Required,
                "http://hl7.org/fhir/ValueSet/immunization-evaluation-status|5.0.0",
            )
...
pub static CARDINALITIES: once_cell::sync::Lazy<Vec<rh_foundation::ElementCardinality>> =
    once_cell::sync::Lazy::new(|| {
        vec![
            ...
            rh_foundation::ElementCardinality::new("ImmunizationEvaluation.doseNumber", 0, Some(1)),
            rh_foundation::ElementCardinality::new(
    ...
    for ImmunizationEvaluation
{
    ...
    fn dose_number(&self) -> Option<StringType> {
        self.dose_number.clone()
    }
    fn series_doses(&self) -> Option<StringType> {
        self.series_doses.clone()
    }
}
    ...
    for ImmunizationEvaluation
{
    ...
    fn set_dose_number(self, value: String) -> Self {
        let mut resource = self.clone();
        resource.dose_number = Some(value);
        resource
    }
    fn set_series_doses(self, value: String) -> Self {
        let mut resource = self.clone();
        resource.series_doses = Some(value);
        resource
    }
}
    ...
    for ImmunizationEvaluation
{
    ...
    fn has_dose_number(&self) -> bool {
        self.dose_number.is_some()
    }
    fn has_series_doses(&self) -> bool {
        self.series_doses.is_some()
    }
}
