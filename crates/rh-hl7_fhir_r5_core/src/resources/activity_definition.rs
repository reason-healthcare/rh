...
pub struct ActivityDefinition {
    ...
    /// Type of individual the activity definition is intended for (canonical)
...
impl Default for ActivityDefinition {
    fn default() -> Self {
        Self {
            ...
            _specimen_requirement: Default::default(),
            observation_requirement: Default::default(),
            _observation_requirement: Default::default(),
            observation_result_requirement: Default::default(),
            _observation_result_requirement: Default::default(),
...
impl crate::traits::activity_definition::ActivityDefinitionAccessors for ActivityDefinition {
    ...
    fn location(&self) -> Option<CodeableReference> {
        self.location.clone()
    }
...
impl crate::traits::activity_definition::ActivityDefinitionMutators for ActivityDefinition {
    ...
    fn set_location(self, value: CodeableReference) -> Self {
        let mut resource = self.clone();
