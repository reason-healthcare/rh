...
pub struct CompartmentDefinitionResource {
    ...
    pub start_param: Option<StringType>,
    /// Extension element for the 'startParam' primitive field. Contains metadata and extensions.
    #[serde(rename = "_startParam")]
    pub _start_param: Option<Element>,
    /// Search Param for interpreting $everything.end
    #[serde(rename = "endParam")]
    pub end_param: Option<StringType>,
    /// Extension element for the 'endParam' primitive field. Contains metadata and extensions.
    #[serde(rename = "_endParam")]
    pub _end_param: Option<Element>,
}
...
impl Default for CompartmentDefinitionResource {
    fn default() -> Self {
        Self {
            ...
            start_param: Default::default(),
            _start_param: Default::default(),
            end_param: Default::default(),
            _end_param: Default::default(),
        }
    }
}
...
pub static CARDINALITIES: once_cell::sync::Lazy<Vec<rh_foundation::ElementCardinality>> =
    once_cell::sync::Lazy::new(|| {
        vec![
            ...
            rh_foundation::ElementCardinality::new("CompartmentDefinition.title", 0, Some(1)),
