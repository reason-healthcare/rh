...
pub struct DeviceMetric {
    ...
    ///
    /// Binding: preferred (IEEE 11073-10101)
    ///
...
impl Default for DeviceMetric {
    fn default() -> Self {
        Self {
            ...
            measurement_frequency: Default::default(),
    ...
    once_cell::sync::Lazy::new(|| {
        vec![
            rh_foundation::ElementBinding::new(
                ...
                "http://hl7.org/fhir/ValueSet/metric-calibration-state|5.0.0",
            )
            .with_description("Describes the state of a metric calibration."),
            rh_foundation::ElementBinding::new(
                "DeviceMetric.calibration.type",
                rh_foundation::BindingStrength::Required,
                "http://hl7.org/fhir/ValueSet/metric-calibration-type|5.0.0",
            )
            .with_description("Describes the type of a metric calibration."),
            rh_foundation::ElementBinding::new(
                "DeviceMetric.category",
                rh_foundation::BindingStrength::Required,
                "http://hl7.org/fhir/ValueSet/metric-category|5.0.0",
            )
            .with_description("Describes the category of the metric."),
            rh_foundation::ElementBinding::new(
                "DeviceMetric.color",
                rh_foundation::BindingStrength::Required,
                "http://hl7.org/fhir/ValueSet/color-codes|5.0.0",
            )
            ...
            rh_foundation::ElementBinding::new(
                ...
                rh_foundation::BindingStrength::Required,
                "http://hl7.org/fhir/ValueSet/metric-operational-status|5.0.0",
            )
...
pub static CARDINALITIES: once_cell::sync::Lazy<Vec<rh_foundation::ElementCardinality>> =
    once_cell::sync::Lazy::new(|| {
        vec![
            ...
            rh_foundation::ElementCardinality::new("DeviceMetric.device", 1, Some(1)),
            ...
            rh_foundation::ElementCardinality::new("DeviceMetric.measurementFrequency", 0, Some(1)),
...
impl crate::traits::device_metric::DeviceMetricAccessors for DeviceMetric {
    ...
    fn measurement_frequency(&self) -> Option<Quantity> {
        self.measurement_frequency.clone()
    }
...
impl crate::traits::device_metric::DeviceMetricMutators for DeviceMetric {
    ...
    fn set_measurement_frequency(self, value: Quantity) -> Self {
        let mut resource = self.clone();
        resource.measurement_frequency = Some(value);
        resource
    }
...
impl crate::traits::device_metric::DeviceMetricExistence for DeviceMetric {
    ...
    fn has_measurement_frequency(&self) -> bool {
        self.measurement_frequency.is_some()
    }
