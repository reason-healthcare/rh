...
pub static CARDINALITIES: once_cell::sync::Lazy<Vec<rh_foundation::ElementCardinality>> =
    once_cell::sync::Lazy::new(|| {
        vec![
            ...
            rh_foundation::ElementCardinality::new("HealthcareService.offeredIn", 0, None),
            ...
            rh_foundation::ElementCardinality::new("HealthcareService.contact", 0, None),
            ...
            rh_foundation::ElementCardinality::new("HealthcareService.availability", 0, None),
