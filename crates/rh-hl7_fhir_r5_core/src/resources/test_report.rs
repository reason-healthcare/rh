...
pub struct TestReport {
    ...
    pub test_script: StringType,
    /// Extension element for the 'testScript' primitive field. Contains metadata and extensions.
    #[serde(rename = "_testScript")]
    pub _test_script: Option<Element>,
    /// pass | fail | pending
...
/// TestReportSetupActionAssert nested structure for the 'requirement' field
#[derive(Debug, Clone, Serialize, Deserialize)]
...
impl Default for TestReport {
    fn default() -> Self {
        Self {
            ...
            test_script: StringType::default(),
            _test_script: Default::default(),
...
pub static INVARIANTS: once_cell::sync::Lazy<Vec<rh_foundation::Invariant>> =
    ...
    rh_foundation::Invariant::new("inv-1", rh_foundation::Severity::Error, "Setup action SHALL contain either an operation or assert but not both.", "operation.exists() xor assert.exists()"),
    rh_foundation::Invariant::new("inv-2", rh_foundation::Severity::Error, "Test action SHALL contain either an operation or assert but not both.", "operation.exists() xor assert.exists()"),
]
    });
    ...
    once_cell::sync::Lazy::new(|| {
        vec![
            ...
            rh_foundation::ElementBinding::new(
                ...
                rh_foundation::BindingStrength::Required,
                "http://hl7.org/fhir/ValueSet/report-participant-type|5.0.0",
            )
            .with_description("The type of participant."),
            rh_foundation::ElementBinding::new(
                "TestReport.result",
                rh_foundation::BindingStrength::Required,
                "http://hl7.org/fhir/ValueSet/report-result-codes|5.0.0",
            )
            .with_description("The overall execution result of the TestScript."),
            rh_foundation::ElementBinding::new(
                "TestReport.setup.action.assert.result",
                rh_foundation::BindingStrength::Required,
                "http://hl7.org/fhir/ValueSet/report-action-result-codes|5.0.0",
            )
            .with_description("The result of the execution of an individual action."),
            rh_foundation::ElementBinding::new(
            ...
            rh_foundation::ElementBinding::new(
                "TestReport.status",
                rh_foundation::BindingStrength::Required,
                "http://hl7.org/fhir/ValueSet/report-status-codes|5.0.0",
            )
            .with_description("The current status of the test script execution."),
        ]
    });
...
impl crate::traits::test_report::TestReportAccessors for TestReport {
    ...
    fn test_script(&self) -> StringType {
...
impl crate::traits::test_report::TestReportMutators for TestReport {
    ...
    fn set_test_script(self, value: String) -> Self {
        let mut resource = self.clone();
