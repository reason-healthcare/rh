...
pub struct SupplyDeliverySupplieditem {
    ...
    /// Medication, Substance, Device or Biologically Derived Product supplied (CodeableConcept)
    #[serde(rename = "itemCodeableConcept")]
    pub item_codeable_concept: Option<CodeableConcept>,
    /// Medication, Substance, Device or Biologically Derived Product supplied (Reference)
    ...
    once_cell::sync::Lazy::new(|| {
        vec![
            ...
            rh_foundation::ElementBinding::new(
                ...
                rh_foundation::BindingStrength::Required,
                "http://hl7.org/fhir/ValueSet/supplydelivery-status|5.0.0",
            )
...
pub static CARDINALITIES: once_cell::sync::Lazy<Vec<rh_foundation::ElementCardinality>> =
    once_cell::sync::Lazy::new(|| {
        vec![
            ...
            rh_foundation::ElementCardinality::new("SupplyDelivery.suppliedItem", 0, None),
...
impl crate::traits::supply_delivery::SupplyDeliveryAccessors for SupplyDelivery {
    ...
    fn supplied_item(&self) -> &[SupplyDeliverySupplieditem] {
        self.supplied_item.as_slice()
    }
...
impl crate::traits::supply_delivery::SupplyDeliveryMutators for SupplyDelivery {
    ...
    fn set_supplied_item(self, value: Vec<SupplyDeliverySupplieditem>) -> Self {
        let mut resource = self.clone();
        resource.supplied_item = value;
        resource
    }
    fn add_supplied_item(self, item: SupplyDeliverySupplieditem) -> Self {
        let mut resource = self.clone();
        resource.supplied_item.push(item);
        resource
    }
