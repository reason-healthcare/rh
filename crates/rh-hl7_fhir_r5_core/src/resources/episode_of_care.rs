...
pub static CARDINALITIES: once_cell::sync::Lazy<Vec<rh_foundation::ElementCardinality>> =
    once_cell::sync::Lazy::new(|| {
        vec![
            ...
            rh_foundation::ElementCardinality::new("EpisodeOfCare.reason", 0, None),
            rh_foundation::ElementCardinality::new("EpisodeOfCare.reason.id", 0, Some(1)),
            rh_foundation::ElementCardinality::new("EpisodeOfCare.reason.extension", 0, None),
            rh_foundation::ElementCardinality::new(
                "EpisodeOfCare.reason.modifierExtension",
                0,
                None,
            ),
            rh_foundation::ElementCardinality::new("EpisodeOfCare.reason.use", 0, Some(1)),
            rh_foundation::ElementCardinality::new("EpisodeOfCare.reason.value", 0, None),
            ...
            rh_foundation::ElementCardinality::new("EpisodeOfCare.diagnosis.condition", 0, None),
            rh_foundation::ElementCardinality::new("EpisodeOfCare.diagnosis.use", 0, Some(1)),
            ...
            rh_foundation::ElementCardinality::new("EpisodeOfCare.careTeam", 0, None),
