...
pub static CARDINALITIES: once_cell::sync::Lazy<Vec<rh_foundation::ElementCardinality>> =
    once_cell::sync::Lazy::new(|| {
        vec![
            ...
            rh_foundation::ElementCardinality::new("Substance.instance", 1, Some(1)),
            ...
            rh_foundation::ElementCardinality::new("Substance.expiry", 0, Some(1)),
            rh_foundation::ElementCardinality::new("Substance.quantity", 0, Some(1)),
