...
pub struct SupplyRequest {
    ...
    ///
    /// Binding: example (The item that was requested.)
    ///
    ...
    once_cell::sync::Lazy::new(|| {
        vec![
            ...
            rh_foundation::ElementBinding::new(
                ...
                rh_foundation::BindingStrength::Required,
                "http://hl7.org/fhir/ValueSet/supplyrequest-status|5.0.0",
            )
...
pub static CARDINALITIES: once_cell::sync::Lazy<Vec<rh_foundation::ElementCardinality>> =
    once_cell::sync::Lazy::new(|| {
        vec![
            ...
            rh_foundation::ElementCardinality::new("SupplyRequest.basedOn", 0, None),
            ...
            rh_foundation::ElementCardinality::new("SupplyRequest.deliverFor", 0, Some(1)),
            rh_foundation::ElementCardinality::new("SupplyRequest.item", 1, Some(1)),
            ...
            rh_foundation::ElementCardinality::new("SupplyRequest.reason", 0, None),
...
impl crate::traits::supply_request::SupplyRequestAccessors for SupplyRequest {
    ...
    fn deliver_for(&self) -> Option<Reference> {
        self.deliver_for.clone()
    }
    fn item(&self) -> CodeableReference {
        self.item.clone()
    }
...
impl crate::traits::supply_request::SupplyRequestMutators for SupplyRequest {
    ...
    fn set_deliver_for(self, value: Reference) -> Self {
        let mut resource = self.clone();
        resource.deliver_for = Some(value);
        resource
    }
    fn set_item(self, value: CodeableReference) -> Self {
        let mut resource = self.clone();
        resource.item = value;
        resource
    }
...
impl crate::traits::supply_request::SupplyRequestExistence for SupplyRequest {
    ...
    fn has_deliver_for(&self) -> bool {
        self.deliver_for.is_some()
    }
