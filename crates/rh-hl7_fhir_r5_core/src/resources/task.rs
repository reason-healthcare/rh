...
pub struct TaskInput {
    ...
    #[serde(rename = "valueInteger")]
    pub value_integer: IntegerType,
    /// Content to use in performing the task (integer64)
    #[serde(rename = "valueInteger64")]
    pub value_integer64: Integer64Type,
    ...
    #[serde(rename = "valueCodeableConcept")]
    pub value_codeable_concept: CodeableConcept,
    /// Content to use in performing the task (CodeableReference)
    #[serde(rename = "valueCodeableReference")]
    pub value_codeable_reference: CodeableReference,
    ...
    #[serde(rename = "valueRatio")]
    pub value_ratio: Ratio,
    /// Content to use in performing the task (RatioRange)
    #[serde(rename = "valueRatioRange")]
    pub value_ratio_range: RatioRange,
    ...
    #[serde(rename = "valueUsageContext")]
    pub value_usage_context: UsageContext,
    /// Content to use in performing the task (Availability)
    #[serde(rename = "valueAvailability")]
    pub value_availability: Availability,
    /// Content to use in performing the task (ExtendedContactDetail)
    #[serde(rename = "valueExtendedContactDetail")]
    pub value_extended_contact_detail: ExtendedContactDetail,
...
impl Default for Task {
    fn default() -> Self {
        Self {
            ...
            requested_performer: Default::default(),
...
pub static INVARIANTS: once_cell::sync::Lazy<Vec<rh_foundation::Invariant>> =
    ...
    rh_foundation::Invariant::new("inv-1", rh_foundation::Severity::Error, "Last modified date must be greater than or equal to authored-on date.", "lastModified.exists().not() or authoredOn.exists().not() or lastModified >= authoredOn"),
    rh_foundation::Invariant::new("tsk-1", rh_foundation::Severity::Error, "Task.restriction is only allowed if the Task is seeking fulfillment and a focus is specified.", "restriction.exists() implies code.coding.where(code='fulfill' and system='http://hl7.org/fhir/CodeSystem/task-code').exists() and focus.exists()"),
]
    });
    ...
    once_cell::sync::Lazy::new(|| {
        vec![
            rh_foundation::ElementBinding::new(
                ...
                "http://hl7.org/fhir/ValueSet/task-intent|5.0.0",
            )
            ...
            rh_foundation::ElementBinding::new(
                "Task.status",
                rh_foundation::BindingStrength::Required,
                "http://hl7.org/fhir/ValueSet/task-status|5.0.0",
            )
...
pub static CARDINALITIES: once_cell::sync::Lazy<Vec<rh_foundation::ElementCardinality>> =
    once_cell::sync::Lazy::new(|| {
        vec![
            ...
            rh_foundation::ElementCardinality::new("Task.doNotPerform", 0, Some(1)),
            ...
            rh_foundation::ElementCardinality::new("Task.requestedPeriod", 0, Some(1)),
            ...
            rh_foundation::ElementCardinality::new("Task.requestedPerformer", 0, None),
            rh_foundation::ElementCardinality::new("Task.owner", 0, Some(1)),
            rh_foundation::ElementCardinality::new("Task.performer", 0, None),
            rh_foundation::ElementCardinality::new("Task.performer.id", 0, Some(1)),
            rh_foundation::ElementCardinality::new("Task.performer.extension", 0, None),
            rh_foundation::ElementCardinality::new("Task.performer.modifierExtension", 0, None),
            rh_foundation::ElementCardinality::new("Task.performer.function", 0, Some(1)),
            rh_foundation::ElementCardinality::new("Task.performer.actor", 1, Some(1)),
            rh_foundation::ElementCardinality::new("Task.location", 0, Some(1)),
            rh_foundation::ElementCardinality::new("Task.reason", 0, None),
