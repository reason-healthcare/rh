...
pub struct Goal {
    ...
    pub _continuous: Option<Element>,
...
pub static INVARIANTS: once_cell::sync::Lazy<Vec<rh_foundation::Invariant>> =
    ...
    rh_foundation::Invariant::new("gol-1", rh_foundation::Severity::Error, "Goal.target.measure is required if Goal.target.detail is populated", "(detail.exists() and measure.exists()) or detail.exists().not()"),
]
    });
...
pub static BINDINGS: once_cell::sync::Lazy<Vec<rh_foundation::ElementBinding>> =
    once_cell::sync::Lazy::new(|| {
        vec![
    rh_foundation::ElementBinding::new("Goal.language", rh_foundation::BindingStrength::Required, "http://hl7.org/fhir/ValueSet/all-languages|5.0.0").with_description("IETF language tag for a human language"),
    rh_foundation::ElementBinding::new("Goal.lifecycleStatus", rh_foundation::BindingStrength::Required, "http://hl7.org/fhir/ValueSet/goal-status|5.0.0").with_description("Codes that reflect the current state of a goal and whether the goal is still being targeted."),
]
    });
...
pub static CARDINALITIES: once_cell::sync::Lazy<Vec<rh_foundation::ElementCardinality>> =
    once_cell::sync::Lazy::new(|| {
        vec![
            ...
            rh_foundation::ElementCardinality::new("Goal.continuous", 0, Some(1)),
            ...
            rh_foundation::ElementCardinality::new("Goal.source", 0, Some(1)),
            rh_foundation::ElementCardinality::new("Goal.addresses", 0, None),
            rh_foundation::ElementCardinality::new("Goal.note", 0, None),
            rh_foundation::ElementCardinality::new("Goal.outcome", 0, None),
        ]
    });
...
impl crate::traits::goal::GoalMutators for Goal {
    ...
    fn set_continuous(self, value: bool) -> Self {
        let mut resource = self.clone();
        resource.continuous = Some(value);
        resource
    }
