use crate::bindings::eligibility_outcome::EligibilityOutcome;
...
impl Default for CoverageEligibilityResponse {
    fn default() -> Self {
        Self {
            ...
            outcome: EligibilityOutcome::default(),
...
pub static INVARIANTS: once_cell::sync::Lazy<Vec<rh_foundation::Invariant>> =
    once_cell::sync::Lazy::new(|| {
        vec![
    rh_foundation::Invariant::new("ces-1", rh_foundation::Severity::Error, "SHALL contain a category or a billcode but not both.", "category.exists() xor productOrService.exists()"),
...
pub static CARDINALITIES: once_cell::sync::Lazy<Vec<rh_foundation::ElementCardinality>> =
    once_cell::sync::Lazy::new(|| {
        vec![
            rh_foundation::ElementCardinality::new("CoverageEligibilityResponse.id", 0, Some(1)),
            rh_foundation::ElementCardinality::new("CoverageEligibilityResponse.meta", 0, Some(1)),
            ...
            rh_foundation::ElementCardinality::new("CoverageEligibilityResponse.text", 0, Some(1)),
            rh_foundation::ElementCardinality::new(
            ...
            rh_foundation::ElementCardinality::new("CoverageEligibilityResponse.purpose", 1, None),
            rh_foundation::ElementCardinality::new(
                "CoverageEligibilityResponse.patient",
                1,
                Some(1),
            ),
            rh_foundation::ElementCardinality::new("CoverageEligibilityResponse.event", 0, None),
            rh_foundation::ElementCardinality::new(
                "CoverageEligibilityResponse.event.id",
                0,
                Some(1),
            ),
            rh_foundation::ElementCardinality::new(
            ...
            rh_foundation::ElementCardinality::new("CoverageEligibilityResponse.form", 0, Some(1)),
            rh_foundation::ElementCardinality::new("CoverageEligibilityResponse.error", 0, None),
            rh_foundation::ElementCardinality::new(
    ...
    for CoverageEligibilityResponse
{
    ...
    fn event(&self) -> &[CoverageEligibilityResponseEvent] {
        self.event.as_slice()
    }
    ...
    fn outcome(&self) -> EligibilityOutcome {
        self.outcome.clone()
    }
    ...
    for CoverageEligibilityResponse
{
    ...
    fn set_event(self, value: Vec<CoverageEligibilityResponseEvent>) -> Self {
        let mut resource = self.clone();
        resource.event = value;
        resource
    }
    fn add_event(self, item: CoverageEligibilityResponseEvent) -> Self {
        let mut resource = self.clone();
    ...
    fn set_outcome(self, value: EligibilityOutcome) -> Self {
        let mut resource = self.clone();
...
pub use crate::traits::coverage_eligibility_response::{
    CoverageEligibilityResponseAccessors, CoverageEligibilityResponseExistence,
    CoverageEligibilityResponseMutators,
};
