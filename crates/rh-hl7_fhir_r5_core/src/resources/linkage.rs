...
pub static INVARIANTS: once_cell::sync::Lazy<Vec<rh_foundation::Invariant>> =
    ...
    rh_foundation::Invariant::new("lnk-1", rh_foundation::Severity::Error, "Must have at least two items", "item.count()>1"),
]
    });
...
pub static BINDINGS: once_cell::sync::Lazy<Vec<rh_foundation::ElementBinding>> =
    once_cell::sync::Lazy::new(|| {
        vec![
    rh_foundation::ElementBinding::new("Linkage.item.type", rh_foundation::BindingStrength::Required, "http://hl7.org/fhir/ValueSet/linkage-type|5.0.0").with_description("Used to distinguish different roles a resource can play within a set of linked resources."),
    rh_foundation::ElementBinding::new("Linkage.language", rh_foundation::BindingStrength::Required, "http://hl7.org/fhir/ValueSet/all-languages|5.0.0").with_description("IETF language tag for a human language"),
]
    });
...
impl crate::validation::ValidatableResource for Linkage {
