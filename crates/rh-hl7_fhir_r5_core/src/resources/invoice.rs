...
pub struct Invoice {
    ...
    /// Billing date or period (date)
    #[serde(rename = "periodDate")]
    pub period_date: Option<DateType>,
    /// Billing date or period (Period)
...
pub struct InvoiceLineitem {
    ...
    /// Service data or period (date)
    #[serde(rename = "servicedDate")]
    pub serviced_date: Option<DateType>,
    /// Service data or period (Period)
...
impl Default for Invoice {
    fn default() -> Self {
        Self {
            ...
            period_date: Default::default(),
            period_period: Default::default(),
    ...
    once_cell::sync::Lazy::new(|| {
        vec![
            ...
            rh_foundation::ElementBinding::new(
                "Invoice.status",
                rh_foundation::BindingStrength::Required,
                "http://hl7.org/fhir/ValueSet/invoice-status|5.0.0",
            )
...
pub static CARDINALITIES: once_cell::sync::Lazy<Vec<rh_foundation::ElementCardinality>> =
    once_cell::sync::Lazy::new(|| {
        vec![
            ...
            rh_foundation::ElementCardinality::new("Invoice.creation", 0, Some(1)),
            rh_foundation::ElementCardinality::new("Invoice.period[x]", 0, Some(1)),
            ...
            rh_foundation::ElementCardinality::new("Invoice.lineItem.serviced[x]", 0, Some(1)),
...
impl crate::traits::invoice::InvoiceAccessors for Invoice {
    ...
    fn creation(&self) -> Option<DateTimeType> {
        self.creation.clone()
    }
...
impl crate::traits::invoice::InvoiceMutators for Invoice {
    ...
    fn set_creation(self, value: String) -> Self {
        let mut resource = self.clone();
        resource.creation = Some(value);
        resource
    }
