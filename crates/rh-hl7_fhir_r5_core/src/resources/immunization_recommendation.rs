...
pub static INVARIANTS: once_cell::sync::Lazy<Vec<rh_foundation::Invariant>> =
    ...
    rh_foundation::Invariant::new("imr-1", rh_foundation::Severity::Error, "One of vaccineCode or targetDisease SHALL be present", "vaccineCode.exists() or targetDisease.exists()"),
]
    });
