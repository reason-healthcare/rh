...
pub static CARDINALITIES: once_cell::sync::Lazy<Vec<rh_foundation::ElementCardinality>> =
    once_cell::sync::Lazy::new(|| {
        vec![
            ...
            rh_foundation::ElementCardinality::new("Claim.traceNumber", 0, None),
            ...
            rh_foundation::ElementCardinality::new("Claim.provider", 0, Some(1)),
            rh_foundation::ElementCardinality::new("Claim.priority", 0, Some(1)),
            ...
            rh_foundation::ElementCardinality::new("Claim.encounter", 0, None),
            rh_foundation::ElementCardinality::new("Claim.facility", 0, Some(1)),
            rh_foundation::ElementCardinality::new("Claim.diagnosisRelatedGroup", 0, Some(1)),
            rh_foundation::ElementCardinality::new("Claim.event", 0, None),
            rh_foundation::ElementCardinality::new("Claim.event.id", 0, Some(1)),
            rh_foundation::ElementCardinality::new("Claim.event.extension", 0, None),
            rh_foundation::ElementCardinality::new("Claim.event.modifierExtension", 0, None),
            rh_foundation::ElementCardinality::new("Claim.event.type", 1, Some(1)),
            rh_foundation::ElementCardinality::new("Claim.event.when[x]", 1, Some(1)),
            ...
            rh_foundation::ElementCardinality::new("Claim.careTeam.specialty", 0, Some(1)),
            ...
            rh_foundation::ElementCardinality::new("Claim.insurance", 0, None),
            ...
            rh_foundation::ElementCardinality::new("Claim.patientPaid", 0, Some(1)),
            ...
            rh_foundation::ElementCardinality::new("Claim.item.traceNumber", 0, None),
            ...
            rh_foundation::ElementCardinality::new("Claim.item.productOrService", 0, Some(1)),
            rh_foundation::ElementCardinality::new("Claim.item.productOrServiceEnd", 0, Some(1)),
            rh_foundation::ElementCardinality::new("Claim.item.request", 0, None),
            ...
            rh_foundation::ElementCardinality::new("Claim.item.patientPaid", 0, Some(1)),
            ...
            rh_foundation::ElementCardinality::new("Claim.item.tax", 0, Some(1)),
            rh_foundation::ElementCardinality::new("Claim.item.net", 0, Some(1)),
            rh_foundation::ElementCardinality::new("Claim.item.udi", 0, None),
            rh_foundation::ElementCardinality::new("Claim.item.bodySite", 0, None),
            rh_foundation::ElementCardinality::new("Claim.item.bodySite.id", 0, Some(1)),
            rh_foundation::ElementCardinality::new("Claim.item.bodySite.extension", 0, None),
            rh_foundation::ElementCardinality::new(
                "Claim.item.bodySite.modifierExtension",
                0,
                None,
            ),
            rh_foundation::ElementCardinality::new("Claim.item.bodySite.site", 1, None),
            rh_foundation::ElementCardinality::new("Claim.item.bodySite.subSite", 0, None),
            ...
            rh_foundation::ElementCardinality::new("Claim.item.detail.traceNumber", 0, None),
            ...
            rh_foundation::ElementCardinality::new("Claim.item.detail.patientPaid", 0, Some(1)),
            ...
            rh_foundation::ElementCardinality::new("Claim.item.detail.tax", 0, Some(1)),
            ...
            rh_foundation::ElementCardinality::new("Claim.item.detail.subDetail.tax", 0, Some(1)),
