...
pub struct ParametersParameter {
    ...
    /// If parameter is a data type (integer64)
    #[serde(rename = "valueInteger64")]
    pub value_integer64: Option<Integer64Type>,
    ...
    /// If parameter is a data type (CodeableReference)
    ...
    /// If parameter is a data type (RatioRange)
    ...
    /// If parameter is a data type (Availability)
    #[serde(rename = "valueAvailability")]
    pub value_availability: Option<Availability>,
    /// If parameter is a data type (ExtendedContactDetail)
...
pub static INVARIANTS: once_cell::sync::Lazy<Vec<rh_foundation::Invariant>> =
    ...
    rh_foundation::Invariant::new("inv-1", rh_foundation::Severity::Error, "A parameter must have one and only one of (value, resource, part)", "(part.exists() and value.empty() and resource.empty()) or (part.empty() and (value.exists() xor resource.exists()))"),
]
    });
