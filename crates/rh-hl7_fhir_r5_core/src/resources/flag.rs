...
pub static BINDINGS: once_cell::sync::Lazy<Vec<rh_foundation::ElementBinding>> =
    once_cell::sync::Lazy::new(|| {
        vec![
    rh_foundation::ElementBinding::new("Flag.language", rh_foundation::BindingStrength::Required, "http://hl7.org/fhir/ValueSet/all-languages|5.0.0").with_description("IETF language tag for a human language"),
    rh_foundation::ElementBinding::new("Flag.status", rh_foundation::BindingStrength::Required, "http://hl7.org/fhir/ValueSet/flag-status|5.0.0").with_description("Indicates whether this flag is active and needs to be displayed to a user, or whether it is no longer needed or was entered in error."),
]
    });
...
impl crate::validation::ValidatableResource for Flag {
