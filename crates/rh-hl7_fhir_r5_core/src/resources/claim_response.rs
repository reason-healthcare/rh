...
pub struct ClaimResponse {
    ...
    ///
    /// Binding: example (The overall result of the claim adjudication.)
    ///
    ...
    #[serde(default, skip_serializing_if = "Vec::is_empty")]
    pub communication_request: Vec<Reference>,
...
pub struct ClaimResponseAdditem {
    ...
    #[serde(default, skip_serializing_if = "Vec::is_empty")]
    pub subdetail_sequence: Vec<PositiveIntType>,
    ...
    #[serde(default, skip_serializing_if = "Vec::is_empty")]
    pub _subdetail_sequence: Vec<Element>,
    /// Number for tracking
    #[serde(rename = "traceNumber")]
    #[serde(default, skip_serializing_if = "Vec::is_empty")]
    pub trace_number: Vec<Identifier>,
...
/// ClaimResponseAdditem nested structure for the 'bodySite' field
#[derive(Debug, Clone, Serialize, Deserialize)]
...
pub struct ClaimResponseError {
    ...
    #[serde(default, skip_serializing_if = "Vec::is_empty")]
    pub expression: Vec<StringType>,
    /// Extension element for the 'expression' primitive field. Contains metadata and extensions.
    #[serde(default, skip_serializing_if = "Vec::is_empty")]
    pub _expression: Vec<Element>,
}
/// ClaimResponse nested structure for the 'event' field
#[derive(Debug, Clone, Serialize, Deserialize)]
...
/// ClaimResponseItem nested structure for the 'reviewOutcome' field
#[derive(Debug, Clone, Serialize, Deserialize)]
...
pub static CARDINALITIES: once_cell::sync::Lazy<Vec<rh_foundation::ElementCardinality>> =
    once_cell::sync::Lazy::new(|| {
        vec![
            ...
            rh_foundation::ElementCardinality::new("ClaimResponse.traceNumber", 0, None),
            ...
            rh_foundation::ElementCardinality::new("ClaimResponse.insurer", 0, Some(1)),
            ...
            rh_foundation::ElementCardinality::new("ClaimResponse.decision", 0, Some(1)),
            ...
            rh_foundation::ElementCardinality::new("ClaimResponse.event", 0, None),
            rh_foundation::ElementCardinality::new("ClaimResponse.event.id", 0, Some(1)),
            rh_foundation::ElementCardinality::new("ClaimResponse.event.extension", 0, None),
            rh_foundation::ElementCardinality::new(
                "ClaimResponse.event.modifierExtension",
                0,
                None,
            ),
            rh_foundation::ElementCardinality::new("ClaimResponse.event.type", 1, Some(1)),
            rh_foundation::ElementCardinality::new("ClaimResponse.event.when[x]", 1, Some(1)),
            rh_foundation::ElementCardinality::new("ClaimResponse.payeeType", 0, Some(1)),
            rh_foundation::ElementCardinality::new("ClaimResponse.encounter", 0, None),
            rh_foundation::ElementCardinality::new(
            ...
            rh_foundation::ElementCardinality::new("ClaimResponse.item.traceNumber", 0, None),
            rh_foundation::ElementCardinality::new("ClaimResponse.item.noteNumber", 0, None),
            rh_foundation::ElementCardinality::new("ClaimResponse.item.reviewOutcome", 0, Some(1)),
            rh_foundation::ElementCardinality::new(
                "ClaimResponse.item.reviewOutcome.id",
                0,
                Some(1),
            ),
            rh_foundation::ElementCardinality::new(
            ...
            rh_foundation::ElementCardinality::new("ClaimResponse.item.adjudication", 0, None),
            rh_foundation::ElementCardinality::new(
            ...
            rh_foundation::ElementCardinality::new("ClaimResponse.addItem.traceNumber", 0, None),
            rh_foundation::ElementCardinality::new("ClaimResponse.addItem.provider", 0, None),
            rh_foundation::ElementCardinality::new("ClaimResponse.addItem.revenue", 0, Some(1)),
            rh_foundation::ElementCardinality::new(
            ...
            rh_foundation::ElementCardinality::new("ClaimResponse.addItem.request", 0, None),
            ...
            rh_foundation::ElementCardinality::new("ClaimResponse.addItem.tax", 0, Some(1)),
            rh_foundation::ElementCardinality::new("ClaimResponse.addItem.net", 0, Some(1)),
            rh_foundation::ElementCardinality::new("ClaimResponse.addItem.bodySite", 0, None),
            rh_foundation::ElementCardinality::new("ClaimResponse.addItem.bodySite.id", 0, Some(1)),
            rh_foundation::ElementCardinality::new(
            ...
            rh_foundation::ElementCardinality::new("ClaimResponse.addItem.bodySite.site", 1, None),
            rh_foundation::ElementCardinality::new(
            ...
            rh_foundation::ElementCardinality::new("ClaimResponse.addItem.adjudication", 0, None),
            ...
            rh_foundation::ElementCardinality::new("ClaimResponse.addItem.detail.tax", 0, Some(1)),
            ...
            rh_foundation::ElementCardinality::new("ClaimResponse.error.expression", 0, None),
        ]
    });
...
impl crate::traits::claim_response::ClaimResponseAccessors for ClaimResponse {
    ...
    fn communication_request(&self) -> &[Reference] {
        self.communication_request.as_slice()
    }
...
impl crate::traits::claim_response::ClaimResponseMutators for ClaimResponse {
    ...
    fn set_communication_request(self, value: Vec<Reference>) -> Self {
        let mut resource = self.clone();
        resource.communication_request = value;
        resource
    }
    fn add_communication_request(self, item: Reference) -> Self {
        let mut resource = self.clone();
        resource.communication_request.push(item);
        resource
    }
...
impl crate::traits::claim_response::ClaimResponseExistence for ClaimResponse {
    ...
    fn has_communication_request(&self) -> bool {
        !self.communication_request.is_empty()
    }
