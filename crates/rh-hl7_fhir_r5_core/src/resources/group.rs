...
pub struct Group {
    ...
    pub membership: GroupMembershipBasis,
    /// Extension element for the 'membership' primitive field. Contains metadata and extensions.
    pub _membership: Option<Element>,
...
impl Default for Group {
    fn default() -> Self {
        Self {
            ...
            membership: GroupMembershipBasis::default(),
