...
pub trait MedicationDispenseAccessors: DomainResourceAccessors {
    ...
    /// Returns a reference to the notPerformedReason field.
...
pub trait MedicationDispenseMutators: DomainResourceMutators {
    ...
    /// # Example
    /// ```rust
    /// use rh_hl7_fhir_r5_core::resources::medication_dispense::MedicationDispense;
    /// use rh_hl7_fhir_r5_core::traits::medication_dispense::MedicationDispenseMutators;
    ///
    ...
    /// Sets the notPerformedReason field and returns self for chaining.
...
pub trait MedicationDispenseExistence: DomainResourceExistence {
    ...
    /// Returns true if the not_performed_reason field is present (Some).
