...
use crate::resources::family_member_history::FamilyMemberHistoryParticipant;
use crate::resources::family_member_history::FamilyMemberHistoryProcedure;
...
pub trait FamilyMemberHistoryMutators: DomainResourceMutators {
    ...
    /// # Example
    /// ```rust
    /// use rh_hl7_fhir_r5_core::resources::family_member_history::FamilyMemberHistory;
    /// use rh_hl7_fhir_r5_core::traits::family_member_history::FamilyMemberHistoryMutators;
    ///
