...
use crate::resources::specimen::SpecimenFeature;
...
pub trait SpecimenMutators: DomainResourceMutators {
    ...
    /// # Example
    /// ```rust
    /// use rh_hl7_fhir_r5_core::resources::specimen::Specimen;
    /// use rh_hl7_fhir_r5_core::traits::specimen::SpecimenMutators;
    ///
    ...
    /// Sets the combined field and returns self for chaining.
    ...
    /// Adds an item to the role field and returns self for chaining.
    fn add_role(self, item: CodeableConcept) -> Self;
    /// Sets the feature field and returns self for chaining.
    fn set_feature(self, value: Vec<SpecimenFeature>) -> Self;
    /// Adds an item to the feature field and returns self for chaining.
...
pub trait SpecimenExistence: DomainResourceExistence {
    ...
    /// Returns true if the combined field is present (Some).
    fn has_combined(&self) -> bool;
    /// Returns true if the role field is not empty.
    fn has_role(&self) -> bool;
    /// Returns true if the feature field is not empty.
