...
use crate::resources::allergy_intolerance::AllergyIntoleranceParticipant;
...
pub trait AllergyIntoleranceMutators: DomainResourceMutators {
    ...
    /// # Example
    /// ```rust
    /// use rh_hl7_fhir_r5_core::resources::allergy_intolerance::AllergyIntolerance;
    /// use rh_hl7_fhir_r5_core::traits::allergy_intolerance::AllergyIntoleranceMutators;
    ///
