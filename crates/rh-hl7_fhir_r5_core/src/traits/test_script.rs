...
use crate::resources::test_script::TestScriptScope;
...
pub trait TestScriptMutators: DomainResourceMutators {
    ...
    /// # Example
    /// ```rust
    /// use rh_hl7_fhir_r5_core::resources::test_script::TestScript;
    /// use rh_hl7_fhir_r5_core::traits::test_script::TestScriptMutators;
    ///
