...
use crate::resources::plan_definition::PlanDefinitionActor;
...
pub trait PlanDefinitionMutators: DomainResourceMutators {
    ...
    /// # Example
    /// ```rust
    /// use rh_hl7_fhir_r5_core::resources::plan_definition::PlanDefinition;
    /// use rh_hl7_fhir_r5_core::traits::plan_definition::PlanDefinitionMutators;
    ///
