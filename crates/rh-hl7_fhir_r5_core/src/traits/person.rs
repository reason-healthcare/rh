...
use crate::resources::person::PersonCommunication;
use crate::resources::person::PersonLink;
...
pub trait PersonAccessors: DomainResourceAccessors {
...
/// - Type: Person
/// - Base Definition: http://hl7.org/fhir/StructureDefinition/DomainResource
pub trait PersonMutators: DomainResourceMutators {
    /// Create a new Person with default/empty values.
    ///
    ...
    /// # Example
    /// ```rust
    /// use rh_hl7_fhir_r5_core::resources::person::Person;
    /// use rh_hl7_fhir_r5_core::traits::person::PersonMutators;
    ///
...
/// - Type: Person
/// - Base Definition: http://hl7.org/fhir/StructureDefinition/DomainResource
pub trait PersonExistence: DomainResourceExistence {
