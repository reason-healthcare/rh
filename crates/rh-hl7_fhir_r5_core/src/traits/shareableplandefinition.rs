...
pub trait ShareableplandefinitionMutators {
    ...
    /// # Example
    /// ```rust
    /// use rh_hl7_fhir_r5_core::profiles::shareableplandefinition::Shareableplandefinition;
    /// use rh_hl7_fhir_r5_core::traits::shareableplandefinition::ShareableplandefinitionMutators;
    ///
