...
pub trait TerminologyCapabilitiesMutators: DomainResourceMutators {
    ...
    /// # Example
    /// ```rust
    /// use rh_hl7_fhir_r5_core::resources::terminology_capabilities::TerminologyCapabilities;
    /// use rh_hl7_fhir_r5_core::traits::terminology_capabilities::TerminologyCapabilitiesMutators;
    ///
