...
pub trait InvoiceAccessors: DomainResourceAccessors {
    ...
    /// Returns a reference to the creation field.
...
pub trait InvoiceMutators: DomainResourceMutators {
    ...
    /// # Example
    /// ```rust
    /// use rh_hl7_fhir_r5_core::resources::invoice::Invoice;
    /// use rh_hl7_fhir_r5_core::traits::invoice::InvoiceMutators;
    ///
    ...
    /// Sets the creation field and returns self for chaining.
...
pub trait InvoiceExistence: DomainResourceExistence {
    ...
    /// Returns true if the creation field is present (Some).
