...
pub trait NutritionOrderAccessors: DomainResourceAccessors {
    ...
    /// Returns a reference to the outsideFoodAllowed field.
...
pub trait NutritionOrderMutators: DomainResourceMutators {
    ...
    /// # Example
    /// ```rust
    /// use rh_hl7_fhir_r5_core::resources::nutrition_order::NutritionOrder;
    /// use rh_hl7_fhir_r5_core::traits::nutrition_order::NutritionOrderMutators;
    ///
    ...
    /// Sets the outsideFoodAllowed field and returns self for chaining.
...
pub trait NutritionOrderExistence: DomainResourceExistence {
    ...
    /// Returns true if the outside_food_allowed field is present (Some).
