...
pub trait MeasureReportAccessors: DomainResourceAccessors {
    ...
    /// Returns a reference to the dataUpdateType field.
    ...
    /// Returns a reference to the reportingVendor field.
    ...
    /// Returns a reference to the inputParameters field.
...
pub trait MeasureReportMutators: DomainResourceMutators {
    ...
    /// # Example
    /// ```rust
    /// use rh_hl7_fhir_r5_core::resources::measure_report::MeasureReport;
    /// use rh_hl7_fhir_r5_core::traits::measure_report::MeasureReportMutators;
    ///
    ...
    /// Sets the dataUpdateType field and returns self for chaining.
    ...
    /// Sets the reportingVendor field and returns self for chaining.
    ...
    /// Sets the inputParameters field and returns self for chaining.
...
pub trait MeasureReportExistence: DomainResourceExistence {
    ...
    /// Returns true if the data_update_type field is present (Some).
    ...
    /// Returns true if the reporting_vendor field is present (Some).
    ...
    /// Returns true if the input_parameters field is present (Some).
