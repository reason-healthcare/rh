...
pub trait EventDefinitionAccessors: DomainResourceAccessors {
    ...
    /// Returns a reference to the trigger field.
...
/// - Type: EventDefinition
/// - Base Definition: http://hl7.org/fhir/StructureDefinition/DomainResource
pub trait EventDefinitionMutators: DomainResourceMutators {
    /// Create a new EventDefinition with default/empty values.
    ///
    ...
    /// # Example
    /// ```rust
    /// use rh_hl7_fhir_r5_core::resources::event_definition::EventDefinition;
    /// use rh_hl7_fhir_r5_core::traits::event_definition::EventDefinitionMutators;
    ///
    ...
    /// Sets the trigger field and returns self for chaining.
    fn set_trigger(self, value: Vec<TriggerDefinition>) -> Self;
    /// Adds an item to the trigger field and returns self for chaining.
    fn add_trigger(self, item: TriggerDefinition) -> Self;
}
/// EventDefinition Existence Checks
///
...
/// - Type: EventDefinition
/// - Base Definition: http://hl7.org/fhir/StructureDefinition/DomainResource
pub trait EventDefinitionExistence: DomainResourceExistence {
    ...
    /// Returns true if the trigger field is not empty.
