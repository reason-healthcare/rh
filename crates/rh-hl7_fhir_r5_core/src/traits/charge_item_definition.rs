...
pub trait ChargeItemDefinitionMutators: DomainResourceMutators {
    ...
    /// # Example
    /// ```rust
    /// use rh_hl7_fhir_r5_core::resources::charge_item_definition::ChargeItemDefinition;
    /// use rh_hl7_fhir_r5_core::traits::charge_item_definition::ChargeItemDefinitionMutators;
    ///
