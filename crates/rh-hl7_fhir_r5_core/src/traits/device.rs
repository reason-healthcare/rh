...
use crate::resources::device::DeviceConformsto;
use crate::resources::device::DeviceName;
...
pub trait DeviceAccessors: DomainResourceAccessors {
    ...
    /// Returns a reference to the displayName field.
    ...
    /// Returns a reference to the availabilityStatus field.
    ...
    /// Returns a reference to the cycle field.
    ...
    /// Returns a reference to the gateway field.
...
pub trait DeviceMutators: DomainResourceMutators {
    ...
    /// # Example
    /// ```rust
    /// use rh_hl7_fhir_r5_core::resources::device::Device;
    /// use rh_hl7_fhir_r5_core::traits::device::DeviceMutators;
    ///
    ...
    /// Sets the displayName field and returns self for chaining.
    ...
    /// Sets the availabilityStatus field and returns self for chaining.
    ...
    /// Sets the cycle field and returns self for chaining.
    ...
    /// Sets the gateway field and returns self for chaining.
    fn set_gateway(self, value: Vec<CodeableReference>) -> Self;
    /// Adds an item to the gateway field and returns self for chaining.
...
pub trait DeviceExistence: DomainResourceExistence {
    ...
    /// Returns true if the display_name field is present (Some).
    ...
    /// Returns true if the availability_status field is present (Some).
    ...
    /// Returns true if the cycle field is present (Some).
    ...
    /// Returns true if the gateway field is not empty.
