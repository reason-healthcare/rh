...
pub trait ImmunizationEvaluationAccessors: DomainResourceAccessors {
    ...
    /// Returns a reference to the doseNumber field.
    fn dose_number(&self) -> Option<StringType>;
    /// Returns a reference to the seriesDoses field.
    fn series_doses(&self) -> Option<StringType>;
}
/// ImmunizationEvaluation Trait
///
/// This trait provides common functionality and access patterns for this FHIR resource type.
...
pub trait ImmunizationEvaluationMutators: DomainResourceMutators {
    ...
    /// # Example
    /// ```rust
    /// use rh_hl7_fhir_r5_core::resources::immunization_evaluation::ImmunizationEvaluation;
    /// use rh_hl7_fhir_r5_core::traits::immunization_evaluation::ImmunizationEvaluationMutators;
    ///
    ...
    /// Sets the doseNumber field and returns self for chaining.
    fn set_dose_number(self, value: String) -> Self;
    /// Sets the seriesDoses field and returns self for chaining.
    fn set_series_doses(self, value: String) -> Self;
}
