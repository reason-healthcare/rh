...
use crate::resources::measure::MeasureTerm;
...
pub trait MeasureAccessors: DomainResourceAccessors {
    ...
    /// Returns a reference to the scoringUnit field.
...
pub trait MeasureMutators: DomainResourceMutators {
    ...
    /// # Example
    /// ```rust
    /// use rh_hl7_fhir_r5_core::resources::measure::Measure;
    /// use rh_hl7_fhir_r5_core::traits::measure::MeasureMutators;
    ///
    ...
    /// Sets the scoringUnit field and returns self for chaining.
...
pub trait MeasureExistence: DomainResourceExistence {
    ...
    /// Returns true if the basis field is present (Some).
    ...
    /// Returns true if the scoring_unit field is present (Some).
