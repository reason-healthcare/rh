...
pub trait OperationDefinitionMutators: DomainResourceMutators {
    ...
    /// # Example
    /// ```rust
    /// use rh_hl7_fhir_r5_core::resources::operation_definition::OperationDefinition;
    /// use rh_hl7_fhir_r5_core::traits::operation_definition::OperationDefinitionMutators;
    ///
