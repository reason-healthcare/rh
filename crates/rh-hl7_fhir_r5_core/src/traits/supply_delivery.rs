...
pub trait SupplyDeliveryMutators: DomainResourceMutators {
    ...
    /// # Example
    /// ```rust
    /// use rh_hl7_fhir_r5_core::resources::supply_delivery::SupplyDelivery;
    /// use rh_hl7_fhir_r5_core::traits::supply_delivery::SupplyDeliveryMutators;
    ///
    ...
    /// Adds an item to the suppliedItem field and returns self for chaining.
...
pub trait SupplyDeliveryExistence: DomainResourceExistence {
    ...
    /// Returns true if the supplied_item field is not empty.
