use crate::bindings::enrollment_outcome::EnrollmentOutcome;
...
pub trait EnrollmentResponseAccessors: DomainResourceAccessors {
    ...
    fn outcome(&self) -> Option<EnrollmentOutcome>;
...
pub trait EnrollmentResponseMutators: DomainResourceMutators {
    ...
    /// # Example
    /// ```rust
    /// use rh_hl7_fhir_r5_core::resources::enrollment_response::EnrollmentResponse;
    /// use rh_hl7_fhir_r5_core::traits::enrollment_response::EnrollmentResponseMutators;
    ///
    ...
    fn set_outcome(self, value: EnrollmentOutcome) -> Self;
