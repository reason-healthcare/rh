...
pub trait SubstanceAccessors: DomainResourceAccessors {
    ...
    /// Returns a reference to the expiry field.
    fn expiry(&self) -> Option<DateTimeType>;
...
pub trait SubstanceMutators: DomainResourceMutators {
    ...
    /// # Example
    /// ```rust
    /// use rh_hl7_fhir_r5_core::resources::substance::Substance;
    /// use rh_hl7_fhir_r5_core::traits::substance::SubstanceMutators;
    ///
    ...
    /// Sets the expiry field and returns self for chaining.
    fn set_expiry(self, value: String) -> Self;
...
pub trait SubstanceExistence: DomainResourceExistence {
    ...
    /// Returns true if the expiry field is present (Some).
