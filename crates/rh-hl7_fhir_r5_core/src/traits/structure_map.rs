...
use crate::resources::structure_map::StructureMapConst;
use crate::resources::structure_map::StructureMapGroup;
use crate::resources::structure_map::StructureMapStructure;
...
pub trait StructureMapAccessors: DomainResourceAccessors {
    ...
    /// Returns a reference to the import field.
    fn import(&self) -> &[StringType];
    /// Returns a reference to the const field.
...
/// - Type: StructureMap
/// - Base Definition: http://hl7.org/fhir/StructureDefinition/DomainResource
pub trait StructureMapMutators: DomainResourceMutators {
    /// Create a new StructureMap with default/empty values.
    ///
    ...
    /// # Example
    /// ```rust
    /// use rh_hl7_fhir_r5_core::resources::structure_map::StructureMap;
    /// use rh_hl7_fhir_r5_core::traits::structure_map::StructureMapMutators;
    ///
    ...
    /// Adds an item to the structure field and returns self for chaining.
    fn add_structure(self, item: StructureMapStructure) -> Self;
    /// Sets the import field and returns self for chaining.
    fn set_import(self, value: Vec<String>) -> Self;
    /// Adds an item to the import field and returns self for chaining.
    fn add_import(self, item: String) -> Self;
    /// Sets the const field and returns self for chaining.
    fn set_const_(self, value: Vec<StructureMapConst>) -> Self;
    /// Adds an item to the const field and returns self for chaining.
...
/// - Type: StructureMap
/// - Base Definition: http://hl7.org/fhir/StructureDefinition/DomainResource
pub trait StructureMapExistence: DomainResourceExistence {
    ...
    /// Returns true if the structure field is not empty.
    fn has_structure(&self) -> bool;
    /// Returns true if the import field is not empty.
    fn has_import(&self) -> bool;
    /// Returns true if the const_ field is not empty.
