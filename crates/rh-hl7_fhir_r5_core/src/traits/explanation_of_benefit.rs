...
use crate::resources::explanation_of_benefit::ExplanationOfBenefitEvent;
...
pub trait ExplanationOfBenefitAccessors: DomainResourceAccessors {
    ...
    /// Returns a reference to the patientPaid field.
...
pub trait ExplanationOfBenefitMutators: DomainResourceMutators {
    ...
    /// # Example
    /// ```rust
    /// use rh_hl7_fhir_r5_core::resources::explanation_of_benefit::ExplanationOfBenefit;
    /// use rh_hl7_fhir_r5_core::traits::explanation_of_benefit::ExplanationOfBenefitMutators;
    ///
    ...
    /// Sets the patientPaid field and returns self for chaining.
...
pub trait ExplanationOfBenefitExistence: DomainResourceExistence {
    ...
    /// Returns true if the patient_paid field is present (Some).
