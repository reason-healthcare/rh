...
use crate::resources::coverage_eligibility_request::CoverageEligibilityRequestEvent;
...
pub trait CoverageEligibilityRequestMutators: DomainResourceMutators {
    ...
    /// # Example
    /// ```rust
    /// use rh_hl7_fhir_r5_core::resources::coverage_eligibility_request::CoverageEligibilityRequest;
    /// use rh_hl7_fhir_r5_core::traits::coverage_eligibility_request::CoverageEligibilityRequestMutators;
    ///
