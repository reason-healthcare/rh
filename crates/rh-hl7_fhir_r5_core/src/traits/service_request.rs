...
use crate::resources::service_request::ServiceRequestOrderdetail;
use crate::resources::service_request::ServiceRequestPatientinstruction;
...
pub trait ServiceRequestMutators: DomainResourceMutators {
    ...
    /// # Example
    /// ```rust
    /// use rh_hl7_fhir_r5_core::resources::service_request::ServiceRequest;
    /// use rh_hl7_fhir_r5_core::traits::service_request::ServiceRequestMutators;
    ///
