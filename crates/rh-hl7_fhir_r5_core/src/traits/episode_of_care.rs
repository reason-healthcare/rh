...
use crate::resources::episode_of_care::EpisodeOfCareReason;
...
pub trait EpisodeOfCareMutators: DomainResourceMutators {
    ...
    /// # Example
    /// ```rust
    /// use rh_hl7_fhir_r5_core::resources::episode_of_care::EpisodeOfCare;
    /// use rh_hl7_fhir_r5_core::traits::episode_of_care::EpisodeOfCareMutators;
    ///
