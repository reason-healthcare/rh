...
pub trait OrganizationAffiliationMutators: DomainResourceMutators {
    ...
    /// # Example
    /// ```rust
    /// use rh_hl7_fhir_r5_core::resources::organization_affiliation::OrganizationAffiliation;
    /// use rh_hl7_fhir_r5_core::traits::organization_affiliation::OrganizationAffiliationMutators;
    ///
