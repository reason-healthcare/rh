...
pub trait BundleAccessors: ResourceAccessors {
    ...
    /// Returns a reference to the issues field.
    fn issues(&self) -> Option<Resource>;
}
/// Bundle Trait
///
/// This trait provides common functionality and access patterns for this FHIR resource type.
...
pub trait BundleMutators: ResourceMutators {
    ...
    /// # Example
    /// ```rust
    /// use rh_hl7_fhir_r5_core::resources::bundle::Bundle;
    /// use rh_hl7_fhir_r5_core::traits::bundle::BundleMutators;
    ///
    ...
    /// Sets the issues field and returns self for chaining.
    fn set_issues(self, value: Resource) -> Self;
}
...
pub trait BundleExistence: ResourceExistence {
    ...
    /// Returns true if the issues field is present (Some).
