...
use crate::resources::organization::OrganizationQualification;
...
pub trait OrganizationMutators: DomainResourceMutators {
    ...
    /// # Example
    /// ```rust
    /// use rh_hl7_fhir_r5_core::resources::organization::Organization;
    /// use rh_hl7_fhir_r5_core::traits::organization::OrganizationMutators;
    ///
