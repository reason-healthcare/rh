...
use crate::resources::concept_map::ConceptMapAdditionalattribute;
use crate::resources::concept_map::ConceptMapGroup;
use crate::resources::concept_map::ConceptMapProperty;
...
pub trait ConceptMapAccessors: DomainResourceAccessors {
    ...
    /// Returns a reference to the additionalAttribute field.
...
pub trait ConceptMapMutators: DomainResourceMutators {
    ...
    /// # Example
    /// ```rust
    /// use rh_hl7_fhir_r5_core::resources::concept_map::ConceptMap;
    /// use rh_hl7_fhir_r5_core::traits::concept_map::ConceptMapMutators;
    ///
    ...
    /// Sets the additionalAttribute field and returns self for chaining.
    fn set_additional_attribute(self, value: Vec<ConceptMapAdditionalattribute>) -> Self;
    /// Adds an item to the additionalAttribute field and returns self for chaining.
...
pub trait ConceptMapExistence: DomainResourceExistence {
    ...
    /// Returns true if the additional_attribute field is not empty.
    fn has_additional_attribute(&self) -> bool;
    /// Returns true if the source_scope field is present (Some).
    fn has_source_scope(&self) -> bool;
    /// Returns true if the target_scope field is present (Some).
