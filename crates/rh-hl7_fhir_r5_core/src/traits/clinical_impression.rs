...
pub trait ClinicalImpressionAccessors: DomainResourceAccessors {
    ...
    /// Returns a reference to the changePattern field.
...
pub trait ClinicalImpressionMutators: DomainResourceMutators {
    ...
    /// # Example
    /// ```rust
    /// use rh_hl7_fhir_r5_core::resources::clinical_impression::ClinicalImpression;
    /// use rh_hl7_fhir_r5_core::traits::clinical_impression::ClinicalImpressionMutators;
    ///
    ...
    /// Sets the changePattern field and returns self for chaining.
...
pub trait ClinicalImpressionExistence: DomainResourceExistence {
    ...
    /// Returns true if the change_pattern field is present (Some).
