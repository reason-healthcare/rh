...
pub trait SupplyRequestAccessors: DomainResourceAccessors {
    ...
    /// Returns a reference to the deliverFor field.
...
pub trait SupplyRequestMutators: DomainResourceMutators {
    ...
    /// # Example
    /// ```rust
    /// use rh_hl7_fhir_r5_core::resources::supply_request::SupplyRequest;
    /// use rh_hl7_fhir_r5_core::traits::supply_request::SupplyRequestMutators;
    ///
    ...
    /// Sets the deliverFor field and returns self for chaining.
...
pub trait SupplyRequestExistence: DomainResourceExistence {
    ...
    /// Returns true if the deliver_for field is present (Some).
