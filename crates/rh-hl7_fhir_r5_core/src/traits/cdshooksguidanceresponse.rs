...
/// C D S  Hooks  Guidance Response Trait
///
...
pub trait CdshooksguidanceresponseMutators {
    ...
    /// # Example
    /// ```rust
    /// use rh_hl7_fhir_r5_core::profiles::cdshooksguidanceresponse::Cdshooksguidanceresponse;
    /// use rh_hl7_fhir_r5_core::traits::cdshooksguidanceresponse::CdshooksguidanceresponseMutators;
    ///
