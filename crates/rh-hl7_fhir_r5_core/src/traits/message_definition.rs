...
pub trait MessageDefinitionMutators: DomainResourceMutators {
    ...
    /// # Example
    /// ```rust
    /// use rh_hl7_fhir_r5_core::resources::message_definition::MessageDefinition;
    /// use rh_hl7_fhir_r5_core::traits::message_definition::MessageDefinitionMutators;
    ///
...
pub trait MessageDefinitionExistence: DomainResourceExistence {
    ...
    /// Returns true if the graph field is present (Some).
