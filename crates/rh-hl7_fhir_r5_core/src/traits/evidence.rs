...
use crate::resources::evidence::EvidenceCertainty;
use crate::resources::evidence::EvidenceStatistic;
use crate::resources::evidence::EvidenceVariabledefinition;
...
pub trait EvidenceAccessors: DomainResourceAccessors {
    ...
    /// Returns a reference to the assertion field.
    fn assertion(&self) -> Option<StringType>;
    /// Returns a reference to the note field.
    fn note(&self) -> &[Annotation];
    /// Returns a reference to the variableDefinition field.
    ...
    /// Returns a reference to the statistic field.
...
/// - Type: Evidence
/// - Base Definition: http://hl7.org/fhir/StructureDefinition/DomainResource
pub trait EvidenceMutators: DomainResourceMutators {
    /// Create a new Evidence with default/empty values.
    ///
    ...
    /// # Example
    /// ```rust
    /// use rh_hl7_fhir_r5_core::resources::evidence::Evidence;
    /// use rh_hl7_fhir_r5_core::traits::evidence::EvidenceMutators;
    ///
    /// let resource = Evidence::new();
    ...
    /// Sets the assertion field and returns self for chaining.
    ...
    /// Sets the variableDefinition field and returns self for chaining.
    fn set_variable_definition(self, value: Vec<EvidenceVariabledefinition>) -> Self;
    /// Adds an item to the variableDefinition field and returns self for chaining.
    ...
    /// Sets the statistic field and returns self for chaining.
    fn set_statistic(self, value: Vec<EvidenceStatistic>) -> Self;
    /// Adds an item to the statistic field and returns self for chaining.
...
/// - Type: Evidence
/// - Base Definition: http://hl7.org/fhir/StructureDefinition/DomainResource
pub trait EvidenceExistence: DomainResourceExistence {
    ...
    /// Returns true if the assertion field is present (Some).
    fn has_assertion(&self) -> bool;
    /// Returns true if the note field is not empty.
    fn has_note(&self) -> bool;
    /// Returns true if the variable_definition field is not empty.
    ...
    /// Returns true if the statistic field is not empty.
