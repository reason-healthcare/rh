...
use crate::resources::coverage_eligibility_response::CoverageEligibilityResponseEvent;
...
pub trait CoverageEligibilityResponseMutators: DomainResourceMutators {
    ...
    /// # Example
    /// ```rust
    /// use rh_hl7_fhir_r5_core::resources::coverage_eligibility_response::CoverageEligibilityResponse;
    /// use rh_hl7_fhir_r5_core::traits::coverage_eligibility_response::CoverageEligibilityResponseMutators;
    ///
