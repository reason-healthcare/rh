...
pub trait CanonicalResourceAccessors: DomainResourceAccessors {
...
/// - Type: CanonicalResource
/// - Base Definition: http://hl7.org/fhir/StructureDefinition/DomainResource
pub trait CanonicalResourceMutators: DomainResourceMutators {
    /// Create a new CanonicalResource with default/empty values.
    ///
    ...
    /// # Example
    /// ```rust
    /// use rh_hl7_fhir_r5_core::resources::canonical_resource::CanonicalResource;
    /// use rh_hl7_fhir_r5_core::traits::canonical_resource::CanonicalResourceMutators;
    ///
...
/// CanonicalResource Existence Checks
///
...
/// - Type: CanonicalResource
/// - Base Definition: http://hl7.org/fhir/StructureDefinition/DomainResource
pub trait CanonicalResourceExistence: DomainResourceExistence {
