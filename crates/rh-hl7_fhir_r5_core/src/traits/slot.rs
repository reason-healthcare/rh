...
pub trait SlotMutators: DomainResourceMutators {
    ...
    /// # Example
    /// ```rust
    /// use rh_hl7_fhir_r5_core::resources::slot::Slot;
    /// use rh_hl7_fhir_r5_core::traits::slot::SlotMutators;
    ///
    ...
    /// Adds an item to the appointmentType field and returns self for chaining.
...
pub trait SlotExistence: DomainResourceExistence {
    ...
    /// Returns true if the appointment_type field is not empty.
