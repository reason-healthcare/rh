...
pub trait SubstanceSourceMaterialMutators: DomainResourceMutators {
    ...
    /// # Example
    /// ```rust
    /// use rh_hl7_fhir_r5_core::resources::substance_source_material::SubstanceSourceMaterial;
    /// use rh_hl7_fhir_r5_core::traits::substance_source_material::SubstanceSourceMaterialMutators;
    ///
