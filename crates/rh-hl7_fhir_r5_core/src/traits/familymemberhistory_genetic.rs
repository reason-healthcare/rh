...
pub trait FamilymemberhistoryGeneticMutators {
    ...
    /// # Example
    /// ```rust
    /// use rh_hl7_fhir_r5_core::profiles::familymemberhistory_genetic::FamilymemberhistoryGenetic;
    /// use rh_hl7_fhir_r5_core::traits::familymemberhistory_genetic::FamilymemberhistoryGeneticMutators;
    ///
