...
pub trait ShareableactivitydefinitionMutators {
    ...
    /// # Example
    /// ```rust
    /// use rh_hl7_fhir_r5_core::profiles::shareableactivitydefinition::Shareableactivitydefinition;
    /// use rh_hl7_fhir_r5_core::traits::shareableactivitydefinition::ShareableactivitydefinitionMutators;
    ///
