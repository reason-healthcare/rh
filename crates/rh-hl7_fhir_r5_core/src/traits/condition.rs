...
use crate::resources::condition::ConditionParticipant;
...
pub trait ConditionMutators: DomainResourceMutators {
    ...
    /// # Example
    /// ```rust
    /// use rh_hl7_fhir_r5_core::resources::condition::Condition;
    /// use rh_hl7_fhir_r5_core::traits::condition::ConditionMutators;
    ///
