...
use crate::resources::immunization::ImmunizationProgrameligibility;
...
pub trait ImmunizationAccessors: DomainResourceAccessors {
    ...
    /// Returns a reference to the administeredProduct field.
...
pub trait ImmunizationMutators: DomainResourceMutators {
    ...
    /// # Example
    /// ```rust
    /// use rh_hl7_fhir_r5_core::resources::immunization::Immunization;
    /// use rh_hl7_fhir_r5_core::traits::immunization::ImmunizationMutators;
    ///
    ...
    /// Sets the administeredProduct field and returns self for chaining.
...
pub trait ImmunizationExistence: DomainResourceExistence {
    ...
    /// Returns true if the administered_product field is present (Some).
