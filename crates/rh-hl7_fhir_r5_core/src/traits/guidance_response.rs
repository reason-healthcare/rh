...
pub trait GuidanceResponseAccessors: DomainResourceAccessors {
    ...
    fn evaluation_message(&self) -> Option<Reference>;
...
pub trait GuidanceResponseMutators: DomainResourceMutators {
    ...
    /// # Example
    /// ```rust
    /// use rh_hl7_fhir_r5_core::resources::guidance_response::GuidanceResponse;
    /// use rh_hl7_fhir_r5_core::traits::guidance_response::GuidanceResponseMutators;
    ///
    ...
    fn set_evaluation_message(self, value: Reference) -> Self;
...
pub trait GuidanceResponseExistence: DomainResourceExistence {
    ...
    /// Returns true if the evaluation_message field is present (Some).
