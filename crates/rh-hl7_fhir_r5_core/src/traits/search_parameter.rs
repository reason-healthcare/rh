...
pub trait SearchParameterAccessors: DomainResourceAccessors {
    ...
    /// Returns a reference to the processingMode field.
    fn processing_mode(&self) -> Option<SearchProcessingmode>;
    /// Returns a reference to the constraint field.
...
pub trait SearchParameterMutators: DomainResourceMutators {
    ...
    /// # Example
    /// ```rust
    /// use rh_hl7_fhir_r5_core::resources::search_parameter::SearchParameter;
    /// use rh_hl7_fhir_r5_core::traits::search_parameter::SearchParameterMutators;
    ///
    ...
    /// Sets the processingMode field and returns self for chaining.
    fn set_processing_mode(self, value: SearchProcessingmode) -> Self;
    /// Sets the constraint field and returns self for chaining.
...
pub trait SearchParameterExistence: DomainResourceExistence {
    ...
    /// Returns true if the processing_mode field is present (Some).
    fn has_processing_mode(&self) -> bool;
    /// Returns true if the constraint field is present (Some).
