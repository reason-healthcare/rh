...
pub trait CommunicationRequestAccessors: DomainResourceAccessors {
    ...
    /// Returns a reference to the informationProvider field.
...
pub trait CommunicationRequestMutators: DomainResourceMutators {
    ...
    /// # Example
    /// ```rust
    /// use rh_hl7_fhir_r5_core::resources::communication_request::CommunicationRequest;
    /// use rh_hl7_fhir_r5_core::traits::communication_request::CommunicationRequestMutators;
    ///
    ...
    /// Sets the informationProvider field and returns self for chaining.
    fn set_information_provider(self, value: Vec<Reference>) -> Self;
    /// Adds an item to the informationProvider field and returns self for chaining.
...
pub trait CommunicationRequestExistence: DomainResourceExistence {
    ...
    /// Returns true if the information_provider field is not empty.
