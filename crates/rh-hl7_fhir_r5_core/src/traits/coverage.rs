...
use crate::resources::coverage::CoveragePaymentby;
...
pub trait CoverageAccessors: DomainResourceAccessors {
    ...
    /// Returns a reference to the paymentBy field.
    ...
    /// Returns a reference to the insurancePlan field.
...
pub trait CoverageMutators: DomainResourceMutators {
    ...
    /// # Example
    /// ```rust
    /// use rh_hl7_fhir_r5_core::resources::coverage::Coverage;
    /// use rh_hl7_fhir_r5_core::traits::coverage::CoverageMutators;
    ///
    ...
    /// Sets the paymentBy field and returns self for chaining.
    fn set_payment_by(self, value: Vec<CoveragePaymentby>) -> Self;
    /// Adds an item to the paymentBy field and returns self for chaining.
    ...
    /// Adds an item to the subscriberId field and returns self for chaining.
    ...
    /// Sets the insurancePlan field and returns self for chaining.
...
pub trait CoverageExistence: DomainResourceExistence {
    ...
    /// Returns true if the payment_by field is not empty.
    ...
    /// Returns true if the subscriber_id field is not empty.
    ...
    /// Returns true if the insurance_plan field is present (Some).
