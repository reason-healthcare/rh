...
use crate::resources::diagnostic_report::DiagnosticReportSupportinginfo;
...
pub trait DiagnosticReportAccessors: DomainResourceAccessors {
    ...
    /// Returns a reference to the composition field.
...
pub trait DiagnosticReportMutators: DomainResourceMutators {
    ...
    /// # Example
    /// ```rust
    /// use rh_hl7_fhir_r5_core::resources::diagnostic_report::DiagnosticReport;
    /// use rh_hl7_fhir_r5_core::traits::diagnostic_report::DiagnosticReportMutators;
    ///
    ...
    /// Sets the composition field and returns self for chaining.
...
pub trait DiagnosticReportExistence: DomainResourceExistence {
    ...
    /// Returns true if the composition field is present (Some).
