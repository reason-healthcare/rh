...
pub trait DevicemetricobservationMutators {
    ...
    /// # Example
    /// ```rust
    /// use rh_hl7_fhir_r5_core::profiles::devicemetricobservation::Devicemetricobservation;
    /// use rh_hl7_fhir_r5_core::traits::devicemetricobservation::DevicemetricobservationMutators;
    ///
