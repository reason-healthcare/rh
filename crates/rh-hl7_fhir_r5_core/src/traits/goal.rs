...
pub trait GoalAccessors: DomainResourceAccessors {
    ...
    /// Returns a reference to the continuous field.
...
pub trait GoalMutators: DomainResourceMutators {
    ...
    /// # Example
    /// ```rust
    /// use rh_hl7_fhir_r5_core::resources::goal::Goal;
    /// use rh_hl7_fhir_r5_core::traits::goal::GoalMutators;
    ///
    ...
    /// Sets the continuous field and returns self for chaining.
...
pub trait GoalExistence: DomainResourceExistence {
    ...
    /// Returns true if the continuous field is present (Some).
