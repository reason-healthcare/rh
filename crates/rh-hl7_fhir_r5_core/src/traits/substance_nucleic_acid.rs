...
pub trait SubstanceNucleicAcidMutators: DomainResourceMutators {
    ...
    /// # Example
    /// ```rust
    /// use rh_hl7_fhir_r5_core::resources::substance_nucleic_acid::SubstanceNucleicAcid;
    /// use rh_hl7_fhir_r5_core::traits::substance_nucleic_acid::SubstanceNucleicAcidMutators;
    ///
