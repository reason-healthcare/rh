...
use crate::resources::body_structure::BodyStructureIncludedstructure;
...
pub trait BodyStructureAccessors: DomainResourceAccessors {
    ...
    /// Returns a reference to the includedStructure field.
...
pub trait BodyStructureMutators: DomainResourceMutators {
    ...
    /// # Example
    /// ```rust
    /// use rh_hl7_fhir_r5_core::resources::body_structure::BodyStructure;
    /// use rh_hl7_fhir_r5_core::traits::body_structure::BodyStructureMutators;
    ///
    ...
    /// Sets the includedStructure field and returns self for chaining.
    fn set_included_structure(self, value: Vec<BodyStructureIncludedstructure>) -> Self;
    /// Adds an item to the includedStructure field and returns self for chaining.
    fn add_included_structure(self, item: BodyStructureIncludedstructure) -> Self;
    /// Sets the excludedStructure field and returns self for chaining.
    fn set_excluded_structure(self, value: Vec<String>) -> Self;
    /// Adds an item to the excludedStructure field and returns self for chaining.
...
pub trait BodyStructureExistence: DomainResourceExistence {
    ...
    /// Returns true if the included_structure field is not empty.
    fn has_included_structure(&self) -> bool;
    /// Returns true if the excluded_structure field is not empty.
