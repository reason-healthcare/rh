...
pub trait StructureDefinitionMutators: DomainResourceMutators {
    ...
    /// # Example
    /// ```rust
    /// use rh_hl7_fhir_r5_core::resources::structure_definition::StructureDefinition;
    /// use rh_hl7_fhir_r5_core::traits::structure_definition::StructureDefinitionMutators;
    ///
