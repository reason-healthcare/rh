...
use crate::resources::requirements::RequirementsStatement;
...
pub trait RequirementsAccessors: DomainResourceAccessors {
    ...
    /// Returns a reference to the statement field.
...
/// - Type: Requirements
/// - Base Definition: http://hl7.org/fhir/StructureDefinition/DomainResource
pub trait RequirementsMutators: DomainResourceMutators {
    /// Create a new Requirements with default/empty values.
    ///
    ...
    /// use rh_hl7_fhir_r5_core::traits::requirements::RequirementsMutators;
    ///
    /// let resource = Requirements::new();
    ...
    /// Sets the statement field and returns self for chaining.
    fn set_statement(self, value: Vec<RequirementsStatement>) -> Self;
    /// Adds an item to the statement field and returns self for chaining.
    fn add_statement(self, item: RequirementsStatement) -> Self;
}
/// Requirements Existence Checks
///
...
/// - Type: Requirements
/// - Base Definition: http://hl7.org/fhir/StructureDefinition/DomainResource
pub trait RequirementsExistence: DomainResourceExistence {
    ...
    /// Returns true if the statement field is not empty.
