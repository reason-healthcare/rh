...
pub trait SubstanceReferenceInformationMutators: DomainResourceMutators {
    ...
    /// # Example
    /// ```rust
    /// use rh_hl7_fhir_r5_core::resources::substance_reference_information::SubstanceReferenceInformation;
    /// use rh_hl7_fhir_r5_core::traits::substance_reference_information::SubstanceReferenceInformationMutators;
    ///
