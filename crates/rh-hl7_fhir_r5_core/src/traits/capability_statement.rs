...
pub trait CapabilityStatementAccessors: DomainResourceAccessors {
    ...
    /// Returns a reference to the acceptLanguage field.
...
pub trait CapabilityStatementMutators: DomainResourceMutators {
    ...
    /// # Example
    /// ```rust
    /// use rh_hl7_fhir_r5_core::resources::capability_statement::CapabilityStatement;
    /// use rh_hl7_fhir_r5_core::traits::capability_statement::CapabilityStatementMutators;
    ///
    ...
    /// Sets the acceptLanguage field and returns self for chaining.
    fn set_accept_language(self, value: Vec<AllLanguages>) -> Self;
    /// Adds an item to the acceptLanguage field and returns self for chaining.
...
pub trait CapabilityStatementExistence: DomainResourceExistence {
    ...
    /// Returns true if the accept_language field is not empty.
