...
/// Computable  Plan Definition Trait
///
...
pub trait ComputableplandefinitionMutators {
    ...
    /// # Example
    /// ```rust
    /// use rh_hl7_fhir_r5_core::profiles::computableplandefinition::Computableplandefinition;
    /// use rh_hl7_fhir_r5_core::traits::computableplandefinition::ComputableplandefinitionMutators;
    ///
