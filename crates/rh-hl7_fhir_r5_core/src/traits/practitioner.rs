...
use crate::resources::practitioner::PractitionerCommunication;
...
pub trait PractitionerMutators: DomainResourceMutators {
    ...
    /// # Example
    /// ```rust
    /// use rh_hl7_fhir_r5_core::resources::practitioner::Practitioner;
    /// use rh_hl7_fhir_r5_core::traits::practitioner::PractitionerMutators;
    ///
