...
use crate::resources::observation::ObservationTriggeredby;
...
pub trait ObservationAccessors: DomainResourceAccessors {
    ...
    /// Returns a reference to the triggeredBy field.
...
pub trait ObservationMutators: DomainResourceMutators {
    ...
    /// # Example
    /// ```rust
    /// use rh_hl7_fhir_r5_core::resources::observation::Observation;
    /// use rh_hl7_fhir_r5_core::traits::observation::ObservationMutators;
    ///
    ...
    /// Sets the triggeredBy field and returns self for chaining.
    fn set_triggered_by(self, value: Vec<ObservationTriggeredby>) -> Self;
    /// Adds an item to the triggeredBy field and returns self for chaining.
...
pub trait ObservationExistence: DomainResourceExistence {
    ...
    /// Returns true if the instantiates field is present (Some).
    fn has_instantiates(&self) -> bool;
    /// Returns true if the based_on field is not empty.
    fn has_based_on(&self) -> bool;
    /// Returns true if the triggered_by field is not empty.
