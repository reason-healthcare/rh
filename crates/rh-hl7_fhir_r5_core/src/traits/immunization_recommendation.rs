...
pub trait ImmunizationRecommendationMutators: DomainResourceMutators {
    ...
    /// # Example
    /// ```rust
    /// use rh_hl7_fhir_r5_core::resources::immunization_recommendation::ImmunizationRecommendation;
    /// use rh_hl7_fhir_r5_core::traits::immunization_recommendation::ImmunizationRecommendationMutators;
    ///
