...
pub struct Moduledefinitionlibrary {
...
pub static CARDINALITIES: once_cell::sync::Lazy<Vec<rh_foundation::ElementCardinality>> =
    once_cell::sync::Lazy::new(|| {
        vec![
            ...
            rh_foundation::ElementCardinality::new("Library.extension", 0, None),
            rh_foundation::ElementCardinality::new("Library.extension", 0, None),
            rh_foundation::ElementCardinality::new("Library.extension", 0, Some(1)),
            rh_foundation::ElementCardinality::new("Library.extension", 0, None),
            rh_foundation::ElementCardinality::new("Library.extension", 0, None),
            ...
            rh_foundation::ElementCardinality::new("Library.content", 0, Some(0)),
        ]
    });

// Trait implementations
impl crate::traits::resource::ResourceAccessors for Moduledefinitionlibrary {
...
impl crate::traits::resource::ResourceMutators for Moduledefinitionlibrary {
    fn new() -> Self {
        Self::default()
    }
...
impl crate::traits::resource::ResourceExistence for Moduledefinitionlibrary {
    fn has_id(&self) -> bool {
        self.base.has_id()
    }
...
impl crate::traits::moduledefinitionlibrary::ModuledefinitionlibraryMutators
    for Moduledefinitionlibrary
{
    fn new() -> Self {
        Self::default()
    }
...
impl crate::validation::ValidatableResource for Moduledefinitionlibrary {
    ...
    fn profile_url() -> Option<&'static str> {
        Some("http://hl7.org/fhir/StructureDefinition/moduledefinitionlibrary")
    }
}

// Re-export traits for convenient importing
// This allows users to just import the resource module and get all associated traits
pub use crate::traits::moduledefinitionlibrary::{
    ModuledefinitionlibraryAccessors, ModuledefinitionlibraryExistence,
    ModuledefinitionlibraryMutators,
};
