...
pub static BINDINGS: once_cell::sync::Lazy<Vec<rh_foundation::ElementBinding>> =
    once_cell::sync::Lazy::new(|| {
        vec![
            ...
            .with_description("LDL Cholesterol codes - measured or calculated."),
            rh_foundation::ElementBinding::new(
...
impl crate::validation::ValidatableResource for Ldlcholesterol {
    ...
    fn profile_url() -> Option<&'static str> {
        Some("http://hl7.org/fhir/StructureDefinition/ldlcholesterol")
    }
}

// Re-export traits for convenient importing
// This allows users to just import the resource module and get all associated traits
pub use crate::traits::ldlcholesterol::{
    LdlcholesterolAccessors, LdlcholesterolExistence, LdlcholesterolMutators,
};
