...
impl crate::traits::resource::ResourceAccessors for TransactionBundle {
...
impl crate::traits::resource::ResourceMutators for TransactionBundle {
    fn new() -> Self {
        Self::default()
    }
...
impl crate::traits::resource::ResourceExistence for TransactionBundle {
    fn has_id(&self) -> bool {
        self.base.has_id()
    }
...
impl crate::traits::transaction_bundle::TransactionBundleMutators for TransactionBundle {
    fn new() -> Self {
        Self::default()
    }
}

impl crate::validation::ValidatableResource for TransactionBundle {
    ...
    fn profile_url() -> Option<&'static str> {
        Some("http://hl7.org/fhir/StructureDefinition/transaction-bundle")
    }
}

// Re-export traits for convenient importing
// This allows users to just import the resource module and get all associated traits
pub use crate::traits::transaction_bundle::{
    TransactionBundleAccessors, TransactionBundleExistence, TransactionBundleMutators,
};
