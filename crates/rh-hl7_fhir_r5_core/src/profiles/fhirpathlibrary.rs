use crate::profiles::logiclibrary::Logiclibrary;
...
pub struct Fhirpathlibrary {
    /// Base definition inherited from FHIR specification
    #[serde(flatten)]
    pub base: Logiclibrary,
}
...
pub static CARDINALITIES: once_cell::sync::Lazy<Vec<rh_foundation::ElementCardinality>> =
    once_cell::sync::Lazy::new(|| {
        vec![
            ...
            rh_foundation::ElementCardinality::new("Library.content", 1, None),
            rh_foundation::ElementCardinality::new("Library.content.id", 1, Some(1)),
            rh_foundation::ElementCardinality::new("Library.content.extension", 0, None),
            rh_foundation::ElementCardinality::new("Library.content.contentType", 1, Some(1)),
            rh_foundation::ElementCardinality::new("Library.content.language", 0, Some(1)),
            rh_foundation::ElementCardinality::new("Library.content.data", 1, Some(1)),
            rh_foundation::ElementCardinality::new("Library.content.url", 0, Some(1)),
            rh_foundation::ElementCardinality::new("Library.content.size", 0, Some(1)),
            rh_foundation::ElementCardinality::new("Library.content.hash", 0, Some(1)),
            rh_foundation::ElementCardinality::new("Library.content.title", 0, Some(1)),
...
impl crate::traits::resource::ResourceAccessors for Fhirpathlibrary {
...
impl crate::traits::resource::ResourceMutators for Fhirpathlibrary {
    fn new() -> Self {
        Self::default()
    }
...
impl crate::traits::resource::ResourceExistence for Fhirpathlibrary {
    fn has_id(&self) -> bool {
        self.base.has_id()
    }
...
impl crate::traits::fhirpathlibrary::FhirpathlibraryMutators for Fhirpathlibrary {
    fn new() -> Self {
        Self::default()
    }
}

impl crate::validation::ValidatableResource for Fhirpathlibrary {
    ...
    fn profile_url() -> Option<&'static str> {
        Some("http://hl7.org/fhir/StructureDefinition/fhirpathlibrary")
    }
}

// Re-export traits for convenient importing
// This allows users to just import the resource module and get all associated traits
pub use crate::traits::fhirpathlibrary::{
    FhirpathlibraryAccessors, FhirpathlibraryExistence, FhirpathlibraryMutators,
};
