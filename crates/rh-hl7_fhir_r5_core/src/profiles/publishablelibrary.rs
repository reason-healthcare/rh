...
pub static CARDINALITIES: once_cell::sync::Lazy<Vec<rh_foundation::ElementCardinality>> =
    once_cell::sync::Lazy::new(|| {
        vec![
            ...
            rh_foundation::ElementCardinality::new("Library.date", 1, Some(1)),
            ...
            rh_foundation::ElementCardinality::new("Library.relatedArtifact.resource", 0, Some(1)),
...
impl crate::traits::resource::ResourceAccessors for Publishablelibrary {
...
impl crate::traits::resource::ResourceMutators for Publishablelibrary {
    fn new() -> Self {
        Self::default()
    }
...
impl crate::traits::resource::ResourceExistence for Publishablelibrary {
    fn has_id(&self) -> bool {
        self.base.has_id()
    }
...
impl crate::traits::publishablelibrary::PublishablelibraryMutators for Publishablelibrary {
    fn new() -> Self {
        Self::default()
    }
}

impl crate::validation::ValidatableResource for Publishablelibrary {
    ...
    fn profile_url() -> Option<&'static str> {
        Some("http://hl7.org/fhir/StructureDefinition/publishablelibrary")
    }
}

// Re-export traits for convenient importing
// This allows users to just import the resource module and get all associated traits
pub use crate::traits::publishablelibrary::{
    PublishablelibraryAccessors, PublishablelibraryExistence, PublishablelibraryMutators,
};
