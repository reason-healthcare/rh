...
impl crate::traits::resource::ResourceAccessors for BatchBundle {
...
impl crate::traits::resource::ResourceMutators for BatchBundle {
    fn new() -> Self {
        Self::default()
    }
...
impl crate::traits::resource::ResourceExistence for BatchBundle {
    fn has_id(&self) -> bool {
        self.base.has_id()
    }
...
impl crate::traits::batch_bundle::BatchBundleMutators for BatchBundle {
    fn new() -> Self {
        Self::default()
    }
}

impl crate::validation::ValidatableResource for BatchBundle {
    ...
    fn profile_url() -> Option<&'static str> {
        Some("http://hl7.org/fhir/StructureDefinition/batch-bundle")
    }
}

// Re-export traits for convenient importing
// This allows users to just import the resource module and get all associated traits
pub use crate::traits::batch_bundle::{
    BatchBundleAccessors, BatchBundleExistence, BatchBundleMutators,
};
