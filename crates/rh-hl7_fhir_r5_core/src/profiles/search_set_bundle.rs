...
pub static CARDINALITIES: once_cell::sync::Lazy<Vec<rh_foundation::ElementCardinality>> =
    once_cell::sync::Lazy::new(|| {
        vec![
            ...
            rh_foundation::ElementCardinality::new("Bundle.entry", 0, Some(1)),
            rh_foundation::ElementCardinality::new("Bundle.entry.id", 0, Some(1)),
            rh_foundation::ElementCardinality::new("Bundle.entry.extension", 0, None),
            rh_foundation::ElementCardinality::new("Bundle.entry.modifierExtension", 0, None),
            rh_foundation::ElementCardinality::new("Bundle.entry.link", 0, None),
            ...
            rh_foundation::ElementCardinality::new("Bundle.entry.search.mode", 1, Some(1)),
            rh_foundation::ElementCardinality::new("Bundle.entry.search.score", 0, Some(1)),
...
impl crate::traits::resource::ResourceAccessors for SearchSetBundle {
...
impl crate::traits::resource::ResourceMutators for SearchSetBundle {
    fn new() -> Self {
        Self::default()
    }
...
impl crate::traits::resource::ResourceExistence for SearchSetBundle {
    fn has_id(&self) -> bool {
        self.base.has_id()
    }
...
impl crate::traits::search_set_bundle::SearchSetBundleMutators for SearchSetBundle {
    fn new() -> Self {
        Self::default()
    }
}

impl crate::validation::ValidatableResource for SearchSetBundle {
    ...
    fn profile_url() -> Option<&'static str> {
        Some("http://hl7.org/fhir/StructureDefinition/search-set-bundle")
    }
}

// Re-export traits for convenient importing
// This allows users to just import the resource module and get all associated traits
pub use crate::traits::search_set_bundle::{
    SearchSetBundleAccessors, SearchSetBundleExistence, SearchSetBundleMutators,
};
