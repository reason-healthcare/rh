...
pub struct BatchResponseBundle {
...
impl crate::traits::resource::ResourceAccessors for BatchResponseBundle {
...
impl crate::traits::resource::ResourceMutators for BatchResponseBundle {
    fn new() -> Self {
        Self::default()
    }
...
impl crate::traits::resource::ResourceExistence for BatchResponseBundle {
    fn has_id(&self) -> bool {
        self.base.has_id()
    }
...
impl crate::traits::batch_response_bundle::BatchResponseBundleMutators for BatchResponseBundle {
    fn new() -> Self {
        Self::default()
    }
}

impl crate::validation::ValidatableResource for BatchResponseBundle {
    ...
    fn profile_url() -> Option<&'static str> {
        Some("http://hl7.org/fhir/StructureDefinition/batch-response-bundle")
    }
}

// Re-export traits for convenient importing
// This allows users to just import the resource module and get all associated traits
pub use crate::traits::batch_response_bundle::{
    BatchResponseBundleAccessors, BatchResponseBundleExistence, BatchResponseBundleMutators,
};
