...
pub struct Publishablevalueset {
...
pub static CARDINALITIES: once_cell::sync::Lazy<Vec<rh_foundation::ElementCardinality>> =
    once_cell::sync::Lazy::new(|| {
        vec![
            ...
            rh_foundation::ElementCardinality::new("ValueSet.date", 1, Some(1)),
            ...
            rh_foundation::ElementCardinality::new("ValueSet.compose.extension", 0, Some(1)),
            rh_foundation::ElementCardinality::new("ValueSet.compose.extension", 0, Some(1)),
...
impl crate::traits::resource::ResourceAccessors for Publishablevalueset {
...
impl crate::traits::resource::ResourceMutators for Publishablevalueset {
    fn new() -> Self {
        Self::default()
    }
...
impl crate::traits::resource::ResourceExistence for Publishablevalueset {
    fn has_id(&self) -> bool {
        self.base.has_id()
    }
...
impl crate::traits::publishablevalueset::PublishablevaluesetMutators for Publishablevalueset {
    fn new() -> Self {
        Self::default()
    }
}

impl crate::validation::ValidatableResource for Publishablevalueset {
    ...
    fn profile_url() -> Option<&'static str> {
        Some("http://hl7.org/fhir/StructureDefinition/publishablevalueset")
    }
}

// Re-export traits for convenient importing
// This allows users to just import the resource module and get all associated traits
pub use crate::traits::publishablevalueset::{
    PublishablevaluesetAccessors, PublishablevaluesetExistence, PublishablevaluesetMutators,
};
