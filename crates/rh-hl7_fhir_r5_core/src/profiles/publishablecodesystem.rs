use crate::profiles::shareablecodesystem::Shareablecodesystem;
...
pub struct Publishablecodesystem {
    /// Base definition inherited from FHIR specification
    #[serde(flatten)]
    pub base: Shareablecodesystem,
}
...
pub static INVARIANTS: once_cell::sync::Lazy<Vec<rh_foundation::Invariant>> =
    ...
    rh_foundation::Invariant::new("csd-1", rh_foundation::Severity::Error, "Within a code system definition, all the codes SHALL be unique", "concept.exists() implies concept.code.combine(%resource.concept.descendants().concept.code).isDistinct()"),
    rh_foundation::Invariant::new("csd-2", rh_foundation::Severity::Warning, "If there is an explicit hierarchy, a hierarchyMeaning should be provided", "concept.concept.exists() implies hierarchyMeaning.exists()"),
    rh_foundation::Invariant::new("csd-3", rh_foundation::Severity::Warning, "If there is an implicit hierarchy, a hierarchyMeaning should be provided", "concept.where(property.code = 'parent' or property.code = 'child').exists() implies hierarchyMeaning.exists()"),
    rh_foundation::Invariant::new("csd-4", rh_foundation::Severity::Error, "If the code system content = supplement, it must nominate what it's a supplement for", "CodeSystem.content = 'supplement' implies CodeSystem.supplements.exists()"),
    rh_foundation::Invariant::new("csd-5", rh_foundation::Severity::Error, "Must have a value for concept.designation.use if concept.designation.additionalUse is present", "additionalUse.exists() implies use.exists()"),
    rh_foundation::Invariant::new("ele-1", rh_foundation::Severity::Error, "All FHIR elements must have a @value or children", "hasValue() or (children().count() > id.count())"),
    rh_foundation::Invariant::new("ext-1", rh_foundation::Severity::Error, "Must have either extensions or value[x], not both", "extension.exists() != value.exists()"),
    rh_foundation::Invariant::new("scs-1", rh_foundation::Severity::Error, "If a codesystem contains nested concepts, it must specify hierarchyMeaning", "concept.concept.exists() implies hierarchyMeaning.exists()"),
    rh_foundation::Invariant::new("scs-2", rh_foundation::Severity::Error, "If a codesystem contains example, fragment, or complete content, it must have at least one concept", "content in ( 'example' | 'fragment' | 'complete' ) implies concept.exists()"),
]
    });
...
pub static BINDINGS: once_cell::sync::Lazy<Vec<rh_foundation::ElementBinding>> =
    once_cell::sync::Lazy::new(|| {
        vec![
    rh_foundation::ElementBinding::new("CodeSystem.concept.designation.language", rh_foundation::BindingStrength::Required, "http://hl7.org/fhir/ValueSet/all-languages|5.0.0").with_description("IETF language tag for a human language"),
    rh_foundation::ElementBinding::new("CodeSystem.content", rh_foundation::BindingStrength::Required, "http://hl7.org/fhir/ValueSet/codesystem-content-mode|5.0.0").with_description("The extent of the content of the code system (the concepts and codes it defines) are represented in a code system resource."),
    rh_foundation::ElementBinding::new("CodeSystem.filter.operator", rh_foundation::BindingStrength::Required, "http://hl7.org/fhir/ValueSet/filter-operator|5.0.0").with_description("The kind of operation to perform as a part of a property based filter."),
    rh_foundation::ElementBinding::new("CodeSystem.hierarchyMeaning", rh_foundation::BindingStrength::Required, "http://hl7.org/fhir/ValueSet/codesystem-hierarchy-meaning|5.0.0").with_description("The meaning of the hierarchy of concepts in a code system."),
    rh_foundation::ElementBinding::new("CodeSystem.language", rh_foundation::BindingStrength::Required, "http://hl7.org/fhir/ValueSet/all-languages|5.0.0").with_description("IETF language tag for a human language"),
    rh_foundation::ElementBinding::new("CodeSystem.property.type", rh_foundation::BindingStrength::Required, "http://hl7.org/fhir/ValueSet/concept-property-type|5.0.0").with_description("The type of a property value."),
    rh_foundation::ElementBinding::new("CodeSystem.status", rh_foundation::BindingStrength::Required, "http://hl7.org/fhir/ValueSet/publication-status|5.0.0").with_description("The lifecycle status of an artifact."),
]
    });
...
pub static CARDINALITIES: once_cell::sync::Lazy<Vec<rh_foundation::ElementCardinality>> =
    once_cell::sync::Lazy::new(|| {
        vec![
            ...
            rh_foundation::ElementCardinality::new("CodeSystem.extension", 0, None),
            rh_foundation::ElementCardinality::new("CodeSystem.extension", 0, Some(1)),
            rh_foundation::ElementCardinality::new("CodeSystem.extension", 0, None),
            ...
            rh_foundation::ElementCardinality::new("CodeSystem.versionAlgorithm[x]", 0, Some(1)),
            rh_foundation::ElementCardinality::new("CodeSystem.name", 0, Some(1)),
            rh_foundation::ElementCardinality::new("CodeSystem.title", 1, Some(1)),
            ...
            rh_foundation::ElementCardinality::new("CodeSystem.date", 1, Some(1)),
            ...
            rh_foundation::ElementCardinality::new("CodeSystem.copyrightLabel", 0, Some(1)),
            rh_foundation::ElementCardinality::new("CodeSystem.approvalDate", 0, Some(1)),
            rh_foundation::ElementCardinality::new("CodeSystem.lastReviewDate", 0, Some(1)),
            rh_foundation::ElementCardinality::new("CodeSystem.effectivePeriod", 0, Some(1)),
            rh_foundation::ElementCardinality::new("CodeSystem.topic", 0, None),
            rh_foundation::ElementCardinality::new("CodeSystem.author", 0, None),
            rh_foundation::ElementCardinality::new("CodeSystem.editor", 0, None),
            rh_foundation::ElementCardinality::new("CodeSystem.reviewer", 0, None),
            rh_foundation::ElementCardinality::new("CodeSystem.endorser", 0, None),
            rh_foundation::ElementCardinality::new("CodeSystem.relatedArtifact", 0, None),
            rh_foundation::ElementCardinality::new("CodeSystem.caseSensitive", 1, Some(1)),
...
impl crate::traits::resource::ResourceAccessors for Publishablecodesystem {
...
impl crate::traits::resource::ResourceMutators for Publishablecodesystem {
    fn new() -> Self {
        Self::default()
    }
...
impl crate::traits::resource::ResourceExistence for Publishablecodesystem {
    fn has_id(&self) -> bool {
        self.base.has_id()
    }
...
impl crate::traits::publishablecodesystem::PublishablecodesystemMutators for Publishablecodesystem {
    fn new() -> Self {
        Self::default()
    }
}

impl crate::validation::ValidatableResource for Publishablecodesystem {
    ...
    fn profile_url() -> Option<&'static str> {
        Some("http://hl7.org/fhir/StructureDefinition/publishablecodesystem")
    }
}

// Re-export traits for convenient importing
// This allows users to just import the resource module and get all associated traits
pub use crate::traits::publishablecodesystem::{
    PublishablecodesystemAccessors, PublishablecodesystemExistence, PublishablecodesystemMutators,
};
