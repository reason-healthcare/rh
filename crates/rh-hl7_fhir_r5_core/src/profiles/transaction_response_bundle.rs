...
pub struct TransactionResponseBundle {
...
impl crate::traits::resource::ResourceAccessors for TransactionResponseBundle {
...
impl crate::traits::resource::ResourceMutators for TransactionResponseBundle {
    fn new() -> Self {
        Self::default()
    }
...
impl crate::traits::resource::ResourceExistence for TransactionResponseBundle {
    fn has_id(&self) -> bool {
        self.base.has_id()
    }
...
impl crate::traits::transaction_response_bundle::TransactionResponseBundleMutators
    for TransactionResponseBundle
{
    fn new() -> Self {
        Self::default()
    }
...
impl crate::validation::ValidatableResource for TransactionResponseBundle {
    ...
    fn profile_url() -> Option<&'static str> {
        Some("http://hl7.org/fhir/StructureDefinition/transaction-response-bundle")
    }
}

// Re-export traits for convenient importing
// This allows users to just import the resource module and get all associated traits
pub use crate::traits::transaction_response_bundle::{
    TransactionResponseBundleAccessors, TransactionResponseBundleExistence,
    TransactionResponseBundleMutators,
};
