...
pub static BINDINGS: once_cell::sync::Lazy<Vec<rh_foundation::ElementBinding>> =
    once_cell::sync::Lazy::new(|| {
        vec![
            ...
            .with_description("The basis for membership in a group"),
            rh_foundation::ElementBinding::new(
                "Group.type",
                rh_foundation::BindingStrength::Required,
...
pub static CARDINALITIES: once_cell::sync::Lazy<Vec<rh_foundation::ElementCardinality>> =
    once_cell::sync::Lazy::new(|| {
        vec![
            rh_foundation::ElementCardinality::new("Group", 1, Some(1)),
            ...
            rh_foundation::ElementCardinality::new("Group.membership", 1, Some(1)),
            rh_foundation::ElementCardinality::new("Group.code", 0, Some(1)),
            rh_foundation::ElementCardinality::new("Group.name", 0, Some(1)),
            rh_foundation::ElementCardinality::new("Group.description", 0, Some(1)),
            ...
            rh_foundation::ElementCardinality::new("Group.characteristic", 1, None),
...
impl crate::traits::resource::ResourceAccessors for Groupdefinition {
...
impl crate::traits::resource::ResourceMutators for Groupdefinition {
    fn new() -> Self {
        Self::default()
    }
...
impl crate::traits::resource::ResourceExistence for Groupdefinition {
    fn has_id(&self) -> bool {
        self.base.has_id()
    }
...
impl crate::traits::groupdefinition::GroupdefinitionMutators for Groupdefinition {
    fn new() -> Self {
        Self::default()
    }
}

impl crate::validation::ValidatableResource for Groupdefinition {
    ...
    fn profile_url() -> Option<&'static str> {
        Some("http://hl7.org/fhir/StructureDefinition/groupdefinition")
    }
}

// Re-export traits for convenient importing
// This allows users to just import the resource module and get all associated traits
pub use crate::traits::groupdefinition::{
    GroupdefinitionAccessors, GroupdefinitionExistence, GroupdefinitionMutators,
};
