...
pub static BINDINGS: once_cell::sync::Lazy<Vec<rh_foundation::ElementBinding>> =
    ...
    rh_foundation::ElementBinding::new("Bundle.identifier.use", rh_foundation::BindingStrength::Required, "http://hl7.org/fhir/ValueSet/identifier-use|5.0.0").with_description("Identifies the purpose for this identifier, if known ."),
...
pub static CARDINALITIES: once_cell::sync::Lazy<Vec<rh_foundation::ElementCardinality>> =
    once_cell::sync::Lazy::new(|| {
        vec![
            ...
            rh_foundation::ElementCardinality::new("Bundle.identifier", 1, Some(1)),
            rh_foundation::ElementCardinality::new("Bundle.identifier.id", 0, Some(1)),
            rh_foundation::ElementCardinality::new("Bundle.identifier.extension", 0, None),
            rh_foundation::ElementCardinality::new("Bundle.identifier.use", 0, Some(1)),
            rh_foundation::ElementCardinality::new("Bundle.identifier.type", 0, Some(1)),
            rh_foundation::ElementCardinality::new("Bundle.identifier.system", 1, Some(1)),
            rh_foundation::ElementCardinality::new("Bundle.identifier.value", 1, Some(1)),
            rh_foundation::ElementCardinality::new("Bundle.identifier.period", 0, Some(1)),
            rh_foundation::ElementCardinality::new("Bundle.identifier.assigner", 0, Some(1)),
            rh_foundation::ElementCardinality::new("Bundle.type", 1, Some(1)),
            rh_foundation::ElementCardinality::new("Bundle.timestamp", 1, Some(1)),
            rh_foundation::ElementCardinality::new("Bundle.total", 0, Some(0)),
            ...
            rh_foundation::ElementCardinality::new("Bundle.entry", 1, None),
            ...
            rh_foundation::ElementCardinality::new("Bundle.entry.request", 0, Some(0)),
            ...
            rh_foundation::ElementCardinality::new("Bundle.entry.response", 0, Some(0)),
            ...
            rh_foundation::ElementCardinality::new("Bundle.issues", 0, Some(0)),
        ]
    });

// Trait implementations
impl crate::traits::resource::ResourceAccessors for DocumentBundle {
...
impl crate::traits::resource::ResourceMutators for DocumentBundle {
    fn new() -> Self {
        Self::default()
    }
...
impl crate::traits::resource::ResourceExistence for DocumentBundle {
    fn has_id(&self) -> bool {
        self.base.has_id()
    }
...
impl crate::traits::document_bundle::DocumentBundleMutators for DocumentBundle {
    fn new() -> Self {
        Self::default()
    }
}

impl crate::validation::ValidatableResource for DocumentBundle {
    ...
    fn profile_url() -> Option<&'static str> {
        Some("http://hl7.org/fhir/StructureDefinition/document-bundle")
    }
}

// Re-export traits for convenient importing
// This allows users to just import the resource module and get all associated traits
pub use crate::traits::document_bundle::{
    DocumentBundleAccessors, DocumentBundleExistence, DocumentBundleMutators,
};
