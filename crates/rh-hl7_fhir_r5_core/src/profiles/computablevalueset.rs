...
pub static INVARIANTS: once_cell::sync::Lazy<Vec<rh_foundation::Invariant>> =
    ...
    rh_foundation::Invariant::new("cvs-1", rh_foundation::Severity::Error, "Only one of rulesText, expression, or a compose definition SHALL be provided", "extension('http://hl7.org/fhir/StructureDefinition/valueset-rules-text').exists() xor extension('http://hl7.org/fhir/StructureDefinition/valueset-expression').exists() xor compose.exists()"),
...
impl crate::traits::resource::ResourceAccessors for Computablevalueset {
...
impl crate::traits::resource::ResourceMutators for Computablevalueset {
    fn new() -> Self {
        Self::default()
    }
...
impl crate::traits::resource::ResourceExistence for Computablevalueset {
    fn has_id(&self) -> bool {
        self.base.has_id()
    }
...
impl crate::traits::computablevalueset::ComputablevaluesetMutators for Computablevalueset {
    fn new() -> Self {
        Self::default()
    }
}

impl crate::validation::ValidatableResource for Computablevalueset {
    ...
    fn profile_url() -> Option<&'static str> {
        Some("http://hl7.org/fhir/StructureDefinition/computablevalueset")
    }
}

// Re-export traits for convenient importing
// This allows users to just import the resource module and get all associated traits
pub use crate::traits::computablevalueset::{
    ComputablevaluesetAccessors, ComputablevaluesetExistence, ComputablevaluesetMutators,
};
