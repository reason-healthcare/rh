use crate::resources::naming_system::NamingSystem;
use serde::{Deserialize, Serialize};
/// Shareable NamingSystem
///
...
/// - Kind: resource
/// - Type: NamingSystem
/// - Base Definition: http://hl7.org/fhir/StructureDefinition/NamingSystem
#[derive(Debug, Clone, Serialize, Deserialize, Default)]
pub struct Shareablenamingsystem {
    /// Base definition inherited from FHIR specification
    #[serde(flatten)]
    pub base: NamingSystem,
}
...
impl crate::traits::resource::ResourceAccessors for Shareablenamingsystem {
...
impl crate::traits::resource::ResourceMutators for Shareablenamingsystem {
    fn new() -> Self {
        Self::default()
    }
...
impl crate::traits::resource::ResourceExistence for Shareablenamingsystem {
    fn has_id(&self) -> bool {
        self.base.has_id()
    }
...
impl crate::traits::shareablenamingsystem::ShareablenamingsystemMutators for Shareablenamingsystem {
    fn new() -> Self {
        Self::default()
    }
}

impl crate::validation::ValidatableResource for Shareablenamingsystem {
    ...
    fn profile_url() -> Option<&'static str> {
        Some("http://hl7.org/fhir/StructureDefinition/shareablenamingsystem")
    }
}

// Re-export traits for convenient importing
// This allows users to just import the resource module and get all associated traits
pub use crate::traits::shareablenamingsystem::{
    ShareablenamingsystemAccessors, ShareablenamingsystemExistence, ShareablenamingsystemMutators,
};
