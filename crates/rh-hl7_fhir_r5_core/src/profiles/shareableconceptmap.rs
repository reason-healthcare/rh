use crate::resources::concept_map::ConceptMap;
use serde::{Deserialize, Serialize};
/// Shareable ConceptMap
///
...
pub struct Shareableconceptmap {
...
impl crate::traits::resource::ResourceAccessors for Shareableconceptmap {
...
impl crate::traits::resource::ResourceMutators for Shareableconceptmap {
    fn new() -> Self {
        Self::default()
    }
...
impl crate::traits::resource::ResourceExistence for Shareableconceptmap {
    fn has_id(&self) -> bool {
        self.base.has_id()
    }
...
impl crate::traits::shareableconceptmap::ShareableconceptmapMutators for Shareableconceptmap {
    fn new() -> Self {
        Self::default()
    }
}

impl crate::validation::ValidatableResource for Shareableconceptmap {
    ...
    fn profile_url() -> Option<&'static str> {
        Some("http://hl7.org/fhir/StructureDefinition/shareableconceptmap")
    }
}

// Re-export traits for convenient importing
// This allows users to just import the resource module and get all associated traits
pub use crate::traits::shareableconceptmap::{
    ShareableconceptmapAccessors, ShareableconceptmapExistence, ShareableconceptmapMutators,
};
