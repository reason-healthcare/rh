...
impl crate::traits::resource::ResourceAccessors for Elmlibrary {
...
impl crate::traits::resource::ResourceMutators for Elmlibrary {
    fn new() -> Self {
        Self::default()
    }
...
impl crate::traits::resource::ResourceExistence for Elmlibrary {
    fn has_id(&self) -> bool {
        self.base.has_id()
    }
...
impl crate::traits::elmlibrary::ElmlibraryMutators for Elmlibrary {
    fn new() -> Self {
        Self::default()
    }
}

impl crate::validation::ValidatableResource for Elmlibrary {
    ...
    fn profile_url() -> Option<&'static str> {
        Some("http://hl7.org/fhir/StructureDefinition/elmlibrary")
    }
}

// Re-export traits for convenient importing
// This allows users to just import the resource module and get all associated traits
pub use crate::traits::elmlibrary::{ElmlibraryAccessors, ElmlibraryExistence, ElmlibraryMutators};
