...
pub static CARDINALITIES: once_cell::sync::Lazy<Vec<rh_foundation::ElementCardinality>> =
    once_cell::sync::Lazy::new(|| {
        vec![
            ...
            rh_foundation::ElementCardinality::new("PlanDefinition.library", 1, Some(1)),
...
impl crate::validation::ValidatableResource for Computableplandefinition {
    ...
    fn profile_url() -> Option<&'static str> {
        Some("http://hl7.org/fhir/StructureDefinition/computableplandefinition")
    }
}

// Re-export traits for convenient importing
// This allows users to just import the resource module and get all associated traits
pub use crate::traits::computableplandefinition::{
    ComputableplandefinitionAccessors, ComputableplandefinitionExistence,
    ComputableplandefinitionMutators,
};
