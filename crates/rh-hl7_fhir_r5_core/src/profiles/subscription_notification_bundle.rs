...
pub struct SubscriptionNotificationBundle {
...
pub static CARDINALITIES: once_cell::sync::Lazy<Vec<rh_foundation::ElementCardinality>> =
    once_cell::sync::Lazy::new(|| {
        vec![
            ...
            rh_foundation::ElementCardinality::new("Bundle.entry", 1, Some(1)),
            rh_foundation::ElementCardinality::new("Bundle.entry.id", 0, Some(1)),
            rh_foundation::ElementCardinality::new("Bundle.entry.extension", 0, None),
            rh_foundation::ElementCardinality::new("Bundle.entry.modifierExtension", 0, None),
            rh_foundation::ElementCardinality::new("Bundle.entry.link", 0, None),
...
impl crate::traits::resource::ResourceAccessors for SubscriptionNotificationBundle {
...
impl crate::traits::resource::ResourceMutators for SubscriptionNotificationBundle {
    fn new() -> Self {
        Self::default()
    }
...
impl crate::traits::resource::ResourceExistence for SubscriptionNotificationBundle {
    fn has_id(&self) -> bool {
        self.base.has_id()
    }
...
impl crate::traits::subscription_notification_bundle::SubscriptionNotificationBundleMutators
    for SubscriptionNotificationBundle
{
    fn new() -> Self {
        Self::default()
    }
...
impl crate::validation::ValidatableResource for SubscriptionNotificationBundle {
    ...
    fn profile_url() -> Option<&'static str> {
        Some("http://hl7.org/fhir/StructureDefinition/subscription-notification-bundle")
    }
}

// Re-export traits for convenient importing
// This allows users to just import the resource module and get all associated traits
pub use crate::traits::subscription_notification_bundle::{
    SubscriptionNotificationBundleAccessors, SubscriptionNotificationBundleExistence,
    SubscriptionNotificationBundleMutators,
};
