...
pub struct CQFContactReference {
    /// Base definition inherited from FHIR specification
    #[serde(flatten)]
    pub base: Extension,
}

impl Default for CQFContactReference {
    fn default() -> Self {
        Self {
...
impl crate::validation::ValidatableResource for CQFContactReference {
    ...
    fn profile_url() -> Option<&'static str> {
        Some("http://hl7.org/fhir/StructureDefinition/cqf-contactReference")
    }
}
