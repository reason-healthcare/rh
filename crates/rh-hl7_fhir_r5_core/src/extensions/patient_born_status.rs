...
/// Patient Born Status
///
/// The living/delivery status of the fetus (patient).
///
/// **Source:**
...
pub struct PatientBornStatus {
    /// Base definition inherited from FHIR specification
    #[serde(flatten)]
    pub base: Extension,
}

impl Default for PatientBornStatus {
    fn default() -> Self {
        Self {
...
pub static BINDINGS: once_cell::sync::Lazy<Vec<rh_foundation::ElementBinding>> =
    once_cell::sync::Lazy::new(|| {
        vec![rh_foundation::ElementBinding::new(
            ...
            "http://hl7.org/fhir/ValueSet/patient-bornstatus",
        )]
    });
...
impl crate::validation::ValidatableResource for PatientBornStatus {
    ...
    fn profile_url() -> Option<&'static str> {
        Some("http://hl7.org/fhir/StructureDefinition/patient-bornStatus")
    }
}
