...
pub struct CQFSupportedCqlVersion {
    /// Base definition inherited from FHIR specification
    #[serde(flatten)]
    pub base: Extension,
}

impl Default for CQFSupportedCqlVersion {
    fn default() -> Self {
        Self {
...
impl crate::validation::ValidatableResource for CQFSupportedCqlVersion {
    ...
    fn profile_url() -> Option<&'static str> {
        Some("http://hl7.org/fhir/StructureDefinition/cqf-supportedCqlVersion")
    }
}
