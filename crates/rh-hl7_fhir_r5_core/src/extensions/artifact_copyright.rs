...
pub struct ArtifactCopyright {
    /// Base definition inherited from FHIR specification
    #[serde(flatten)]
    pub base: Extension,
}

impl Default for ArtifactCopyright {
    fn default() -> Self {
        Self {
...
impl crate::validation::ValidatableResource for ArtifactCopyright {
    ...
    fn profile_url() -> Option<&'static str> {
        Some("http://hl7.org/fhir/StructureDefinition/artifact-copyright")
    }
}
