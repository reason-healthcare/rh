...
pub struct SpecimenAdditive {
    /// Base definition inherited from FHIR specification
    #[serde(flatten)]
    pub base: Extension,
}

impl Default for SpecimenAdditive {
    fn default() -> Self {
        Self {
...
impl crate::validation::ValidatableResource for SpecimenAdditive {
    ...
    fn profile_url() -> Option<&'static str> {
        Some("http://hl7.org/fhir/StructureDefinition/specimen-additive")
    }
}
