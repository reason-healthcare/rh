...
pub struct MedicationdispenseRefillsRemaining {
    /// Base definition inherited from FHIR specification
    #[serde(flatten)]
    pub base: Extension,
}

impl Default for MedicationdispenseRefillsRemaining {
    fn default() -> Self {
        Self {
...
impl crate::validation::ValidatableResource for MedicationdispenseRefillsRemaining {
    ...
    fn profile_url() -> Option<&'static str> {
        Some("http://hl7.org/fhir/StructureDefinition/medicationdispense-refillsRemaining")
    }
}
