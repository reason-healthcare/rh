...
pub struct ResearchStudySiteRecruitment {
    /// Base definition inherited from FHIR specification
    #[serde(flatten)]
    pub base: Extension,
}

impl Default for ResearchStudySiteRecruitment {
    fn default() -> Self {
        Self {
...
impl crate::validation::ValidatableResource for ResearchStudySiteRecruitment {
    ...
    fn profile_url() -> Option<&'static str> {
        Some("http://hl7.org/fhir/StructureDefinition/researchStudy-siteRecruitment")
    }
}
