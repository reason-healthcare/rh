...
///
/// The Patient Access Endpoint's FHIR Version. This Extension is a denormalization to help clients focus on supported endpoints.
///
/// **Source:**
...
pub struct EndpointFHIRVersion {
    /// Base definition inherited from FHIR specification
    #[serde(flatten)]
    pub base: Extension,
}

impl Default for EndpointFHIRVersion {
    fn default() -> Self {
        Self {
...
impl crate::validation::ValidatableResource for EndpointFHIRVersion {
    ...
    fn profile_url() -> Option<&'static str> {
        Some("http://hl7.org/fhir/StructureDefinition/endpoint-fhir-version")
    }
}
