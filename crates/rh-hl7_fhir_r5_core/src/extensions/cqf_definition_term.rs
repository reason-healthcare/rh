...
pub struct CQFDefinitionTerm {
    /// Base definition inherited from FHIR specification
    #[serde(flatten)]
    pub base: Extension,
}

impl Default for CQFDefinitionTerm {
    fn default() -> Self {
        Self {
...
impl crate::validation::ValidatableResource for CQFDefinitionTerm {
    ...
    fn profile_url() -> Option<&'static str> {
        Some("http://hl7.org/fhir/StructureDefinition/cqf-definitionTerm")
    }
}
