...
pub struct CQFContributionTime {
    /// Base definition inherited from FHIR specification
    #[serde(flatten)]
    pub base: Extension,
}

impl Default for CQFContributionTime {
    fn default() -> Self {
        Self {
...
impl crate::validation::ValidatableResource for CQFContributionTime {
    ...
    fn profile_url() -> Option<&'static str> {
        Some("http://hl7.org/fhir/StructureDefinition/cqf-contributionTime")
    }
}
