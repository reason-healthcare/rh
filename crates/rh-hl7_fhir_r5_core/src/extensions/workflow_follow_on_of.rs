...
pub struct WorkflowFollowOnOf {
    /// Base definition inherited from FHIR specification
    #[serde(flatten)]
    pub base: Extension,
}

impl Default for WorkflowFollowOnOf {
    fn default() -> Self {
        Self {
...
impl crate::validation::ValidatableResource for WorkflowFollowOnOf {
    ...
    fn profile_url() -> Option<&'static str> {
        Some("http://hl7.org/fhir/StructureDefinition/workflow-followOnOf")
    }
}
