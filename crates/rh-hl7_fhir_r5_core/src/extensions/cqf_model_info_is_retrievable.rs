...
pub struct CQFModelInfoIsRetrievable {
    /// Base definition inherited from FHIR specification
    #[serde(flatten)]
    pub base: Extension,
}

impl Default for CQFModelInfoIsRetrievable {
    fn default() -> Self {
        Self {
...
impl crate::validation::ValidatableResource for CQFModelInfoIsRetrievable {
    ...
    fn profile_url() -> Option<&'static str> {
        Some("http://hl7.org/fhir/StructureDefinition/cqf-modelInfo-isRetrievable")
    }
}
