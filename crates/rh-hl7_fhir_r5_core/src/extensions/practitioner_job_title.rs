...
pub struct PractitionerJobTitle {
    /// Base definition inherited from FHIR specification
    #[serde(flatten)]
    pub base: Extension,
}

impl Default for PractitionerJobTitle {
    fn default() -> Self {
        Self {
...
impl crate::validation::ValidatableResource for PractitionerJobTitle {
    ...
    fn profile_url() -> Option<&'static str> {
        Some("http://hl7.org/fhir/StructureDefinition/practitioner-job-title")
    }
}
