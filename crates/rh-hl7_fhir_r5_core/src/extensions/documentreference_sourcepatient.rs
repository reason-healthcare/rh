...
pub struct DocumentreferenceSourcepatient {
    /// Base definition inherited from FHIR specification
    #[serde(flatten)]
    pub base: Extension,
}

impl Default for DocumentreferenceSourcepatient {
    fn default() -> Self {
        Self {
...
impl crate::validation::ValidatableResource for DocumentreferenceSourcepatient {
    ...
    fn profile_url() -> Option<&'static str> {
        Some("http://hl7.org/fhir/StructureDefinition/documentreference-sourcepatient")
    }
}
