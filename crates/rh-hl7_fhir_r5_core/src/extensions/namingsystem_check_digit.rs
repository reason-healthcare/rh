...
pub struct NamingsystemCheckDigit {
    /// Base definition inherited from FHIR specification
    #[serde(flatten)]
    pub base: Extension,
}

impl Default for NamingsystemCheckDigit {
    fn default() -> Self {
        Self {
...
impl crate::validation::ValidatableResource for NamingsystemCheckDigit {
    ...
    fn profile_url() -> Option<&'static str> {
        Some("http://hl7.org/fhir/StructureDefinition/namingsystem-checkDigit")
    }
}
