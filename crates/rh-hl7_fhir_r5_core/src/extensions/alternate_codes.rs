...
pub struct AlternateCodes {
    /// Base definition inherited from FHIR specification
    #[serde(flatten)]
    pub base: Extension,
}

impl Default for AlternateCodes {
    fn default() -> Self {
        Self {
...
impl crate::validation::ValidatableResource for AlternateCodes {
    ...
    fn profile_url() -> Option<&'static str> {
        Some("http://hl7.org/fhir/StructureDefinition/alternate-codes")
    }
}
