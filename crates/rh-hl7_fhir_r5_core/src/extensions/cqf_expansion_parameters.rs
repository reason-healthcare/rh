...
pub struct CQFExpansionParameters {
    /// Base definition inherited from FHIR specification
    #[serde(flatten)]
    pub base: Extension,
}

impl Default for CQFExpansionParameters {
    fn default() -> Self {
        Self {
...
impl crate::validation::ValidatableResource for CQFExpansionParameters {
    ...
    fn profile_url() -> Option<&'static str> {
        Some("http://hl7.org/fhir/StructureDefinition/cqf-expansionParameters")
    }
}
