...
pub struct ValuesetComposeIncludeValueSetTitle {
    /// Base definition inherited from FHIR specification
    #[serde(flatten)]
    pub base: Extension,
}

impl Default for ValuesetComposeIncludeValueSetTitle {
    fn default() -> Self {
        Self {
...
impl crate::validation::ValidatableResource for ValuesetComposeIncludeValueSetTitle {
    ...
    fn profile_url() -> Option<&'static str> {
        Some("http://hl7.org/fhir/StructureDefinition/valueset-compose-include-valueSetTitle")
    }
}
