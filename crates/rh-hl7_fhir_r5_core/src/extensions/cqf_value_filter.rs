...
pub struct CQFValueFilter {
    /// Base definition inherited from FHIR specification
    #[serde(flatten)]
    pub base: Extension,
}

impl Default for CQFValueFilter {
    fn default() -> Self {
        Self {
...
pub static BINDINGS: once_cell::sync::Lazy<Vec<rh_foundation::ElementBinding>> =
    once_cell::sync::Lazy::new(|| {
        ...
        .with_description("The comparator operator to use")]
    });
...
impl crate::validation::ValidatableResource for CQFValueFilter {
    ...
    fn profile_url() -> Option<&'static str> {
        Some("http://hl7.org/fhir/StructureDefinition/cqf-valueFilter")
    }
}
