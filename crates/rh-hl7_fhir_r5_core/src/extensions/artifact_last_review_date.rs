...
pub struct ArtifactLastReviewDate {
    /// Base definition inherited from FHIR specification
    #[serde(flatten)]
    pub base: Extension,
}

impl Default for ArtifactLastReviewDate {
    fn default() -> Self {
        Self {
...
impl crate::validation::ValidatableResource for ArtifactLastReviewDate {
    ...
    fn profile_url() -> Option<&'static str> {
        Some("http://hl7.org/fhir/StructureDefinition/artifact-lastReviewDate")
    }
}
