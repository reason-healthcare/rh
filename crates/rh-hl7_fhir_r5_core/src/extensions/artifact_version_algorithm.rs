...
pub struct ArtifactVersionAlgorithm {
    /// Base definition inherited from FHIR specification
    #[serde(flatten)]
    pub base: Extension,
}

impl Default for ArtifactVersionAlgorithm {
    fn default() -> Self {
        Self {
...
impl crate::validation::ValidatableResource for ArtifactVersionAlgorithm {
    ...
    fn profile_url() -> Option<&'static str> {
        Some("http://hl7.org/fhir/StructureDefinition/artifact-versionAlgorithm")
    }
}
