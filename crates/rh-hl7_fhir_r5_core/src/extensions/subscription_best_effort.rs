...
pub struct SubscriptionBestEffort {
    /// Base definition inherited from FHIR specification
    #[serde(flatten)]
    pub base: Extension,
}

impl Default for SubscriptionBestEffort {
    fn default() -> Self {
        Self {
...
impl crate::validation::ValidatableResource for SubscriptionBestEffort {
    ...
    fn profile_url() -> Option<&'static str> {
        Some("http://hl7.org/fhir/StructureDefinition/subscription-best-effort")
    }
}
