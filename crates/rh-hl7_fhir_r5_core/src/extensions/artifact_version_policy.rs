...
impl Default for ArtifactVersionPolicy {
    fn default() -> Self {
        Self {
...
impl crate::validation::ValidatableResource for ArtifactVersionPolicy {
    ...
    fn profile_url() -> Option<&'static str> {
        Some("http://hl7.org/fhir/StructureDefinition/artifact-versionPolicy")
    }
}
