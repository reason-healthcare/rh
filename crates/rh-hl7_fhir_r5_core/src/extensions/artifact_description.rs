...
impl Default for ArtifactDescription {
    fn default() -> Self {
        Self {
...
impl crate::validation::ValidatableResource for ArtifactDescription {
    ...
    fn profile_url() -> Option<&'static str> {
        Some("http://hl7.org/fhir/StructureDefinition/artifact-description")
    }
}
