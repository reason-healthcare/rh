...
impl crate::validation::ValidatableResource for ArtifactContactDetailReference {
    ...
    fn profile_url() -> Option<&'static str> {
        Some("http://hl7.org/fhir/StructureDefinition/artifact-contactDetailReference")
    }
}
