...
pub struct DocumentreferenceThumbnail {
    /// Base definition inherited from FHIR specification
    #[serde(flatten)]
    pub base: Extension,
}

impl Default for DocumentreferenceThumbnail {
    fn default() -> Self {
        Self {
...
impl crate::validation::ValidatableResource for DocumentreferenceThumbnail {
    ...
    fn profile_url() -> Option<&'static str> {
        Some("http://hl7.org/fhir/StructureDefinition/documentreference-thumbnail")
    }
}
