...
pub struct OperationoutcomeMessageId {
    /// Base definition inherited from FHIR specification
    #[serde(flatten)]
    pub base: Extension,
}

impl Default for OperationoutcomeMessageId {
    fn default() -> Self {
        Self {
...
impl crate::validation::ValidatableResource for OperationoutcomeMessageId {
