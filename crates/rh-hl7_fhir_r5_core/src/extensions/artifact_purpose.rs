...
impl Default for ArtifactPurpose {
    fn default() -> Self {
        Self {
...
impl crate::validation::ValidatableResource for ArtifactPurpose {
    ...
    fn profile_url() -> Option<&'static str> {
        Some("http://hl7.org/fhir/StructureDefinition/artifact-purpose")
    }
}
