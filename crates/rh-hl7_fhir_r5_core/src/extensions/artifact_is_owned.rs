...
pub struct ArtifactIsOwned {
    /// Base definition inherited from FHIR specification
    #[serde(flatten)]
    pub base: Extension,
}

impl Default for ArtifactIsOwned {
    fn default() -> Self {
        Self {
...
impl crate::validation::ValidatableResource for ArtifactIsOwned {
    ...
    fn profile_url() -> Option<&'static str> {
        Some("http://hl7.org/fhir/StructureDefinition/artifact-isOwned")
    }
}
