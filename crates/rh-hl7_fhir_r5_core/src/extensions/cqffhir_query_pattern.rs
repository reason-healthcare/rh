...
pub struct CQFFHIRQueryPattern {
    /// Base definition inherited from FHIR specification
    #[serde(flatten)]
    pub base: Extension,
}

impl Default for CQFFHIRQueryPattern {
    fn default() -> Self {
        Self {
...
impl crate::validation::ValidatableResource for CQFFHIRQueryPattern {
    ...
    fn profile_url() -> Option<&'static str> {
        Some("http://hl7.org/fhir/StructureDefinition/cqf-fhirQueryPattern")
    }
}
