...
pub struct WorkflowShallComplyWith {
    /// Base definition inherited from FHIR specification
    #[serde(flatten)]
    pub base: Extension,
}

impl Default for WorkflowShallComplyWith {
    fn default() -> Self {
        Self {
...
impl crate::validation::ValidatableResource for WorkflowShallComplyWith {
    ...
    fn profile_url() -> Option<&'static str> {
        Some("http://hl7.org/fhir/StructureDefinition/workflow-shallComplyWith")
    }
}
