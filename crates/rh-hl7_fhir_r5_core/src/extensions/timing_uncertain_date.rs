...
pub struct TimingUncertainDate {
    /// Base definition inherited from FHIR specification
    #[serde(flatten)]
    pub base: Extension,
}

impl Default for TimingUncertainDate {
    fn default() -> Self {
        Self {
...
impl crate::validation::ValidatableResource for TimingUncertainDate {
    ...
    fn profile_url() -> Option<&'static str> {
        Some("http://hl7.org/fhir/StructureDefinition/timing-uncertainDate")
    }
}
