...
pub struct StructuredefinitionImposeProfile {
    /// Base definition inherited from FHIR specification
    #[serde(flatten)]
    pub base: Extension,
}

impl Default for StructuredefinitionImposeProfile {
    fn default() -> Self {
        Self {
...
impl crate::validation::ValidatableResource for StructuredefinitionImposeProfile {
