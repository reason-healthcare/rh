...
pub struct ElementdefinitionConceptmap {
    /// Base definition inherited from FHIR specification
    #[serde(flatten)]
    pub base: Extension,
}

impl Default for ElementdefinitionConceptmap {
    fn default() -> Self {
        Self {
...
impl crate::validation::ValidatableResource for ElementdefinitionConceptmap {
    ...
    fn profile_url() -> Option<&'static str> {
        Some("http://hl7.org/fhir/StructureDefinition/elementdefinition-conceptmap")
    }
}
