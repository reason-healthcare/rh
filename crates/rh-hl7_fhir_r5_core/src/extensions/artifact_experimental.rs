...
pub struct ArtifactExperimental {
    /// Base definition inherited from FHIR specification
    #[serde(flatten)]
    pub base: Extension,
}

impl Default for ArtifactExperimental {
    fn default() -> Self {
        Self {
...
impl crate::validation::ValidatableResource for ArtifactExperimental {
    ...
    fn profile_url() -> Option<&'static str> {
        Some("http://hl7.org/fhir/StructureDefinition/artifact-experimental")
    }
}
