...
pub struct ElementdefinitionTypeMustSupport {
    /// Base definition inherited from FHIR specification
    #[serde(flatten)]
    pub base: Extension,
}

impl Default for ElementdefinitionTypeMustSupport {
    fn default() -> Self {
        Self {
...
impl crate::validation::ValidatableResource for ElementdefinitionTypeMustSupport {
