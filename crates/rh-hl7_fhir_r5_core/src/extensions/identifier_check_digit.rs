...
pub struct IdentifierCheckDigit {
    /// Base definition inherited from FHIR specification
    #[serde(flatten)]
    pub base: Extension,
}

impl Default for IdentifierCheckDigit {
    fn default() -> Self {
        Self {
...
impl crate::validation::ValidatableResource for IdentifierCheckDigit {
    ...
    fn profile_url() -> Option<&'static str> {
        Some("http://hl7.org/fhir/StructureDefinition/identifier-checkDigit")
    }
}
