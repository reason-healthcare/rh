...
pub struct CQFDefaultValue {
    /// Base definition inherited from FHIR specification
    #[serde(flatten)]
    pub base: Extension,
}

impl Default for CQFDefaultValue {
    fn default() -> Self {
        Self {
...
impl crate::validation::ValidatableResource for CQFDefaultValue {
    ...
    fn profile_url() -> Option<&'static str> {
        Some("http://hl7.org/fhir/StructureDefinition/cqf-defaultValue")
    }
}
