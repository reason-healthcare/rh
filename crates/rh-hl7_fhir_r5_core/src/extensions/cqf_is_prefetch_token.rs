...
pub struct CQFIsPrefetchToken {
    /// Base definition inherited from FHIR specification
    #[serde(flatten)]
    pub base: Extension,
}

impl Default for CQFIsPrefetchToken {
    fn default() -> Self {
        Self {
...
impl crate::validation::ValidatableResource for CQFIsPrefetchToken {
    ...
    fn profile_url() -> Option<&'static str> {
        Some("http://hl7.org/fhir/StructureDefinition/cqf-isPrefetchToken")
    }
}
