...
pub struct ReferencesContained {
    /// Base definition inherited from FHIR specification
    #[serde(flatten)]
    pub base: Extension,
}

impl Default for ReferencesContained {
    fn default() -> Self {
        Self {
...
impl crate::validation::ValidatableResource for ReferencesContained {
    ...
    fn profile_url() -> Option<&'static str> {
        Some("http://hl7.org/fhir/StructureDefinition/referencesContained")
    }
}
