...
pub struct ValuesetWorkflowStatusDescription {
    /// Base definition inherited from FHIR specification
    #[serde(flatten)]
    pub base: Extension,
}

impl Default for ValuesetWorkflowStatusDescription {
    fn default() -> Self {
        Self {
...
impl crate::validation::ValidatableResource for ValuesetWorkflowStatusDescription {
    ...
    fn profile_url() -> Option<&'static str> {
        Some("http://hl7.org/fhir/StructureDefinition/valueset-workflowStatusDescription")
    }
}
