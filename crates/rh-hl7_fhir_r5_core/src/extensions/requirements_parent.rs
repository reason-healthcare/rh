...
/// Requirements Parent
///
/// A larger/more generic set of requirements that this set of requirements helps to refine and enable.
///
/// **Source:**
...
pub struct RequirementsParent {
    /// Base definition inherited from FHIR specification
    #[serde(flatten)]
    pub base: Extension,
}

impl Default for RequirementsParent {
    fn default() -> Self {
        Self {
...
impl crate::validation::ValidatableResource for RequirementsParent {
    ...
    fn profile_url() -> Option<&'static str> {
        Some("http://hl7.org/fhir/StructureDefinition/requirements-parent")
    }
}
