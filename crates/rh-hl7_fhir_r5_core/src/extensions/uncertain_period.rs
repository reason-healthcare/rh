...
pub struct UncertainPeriod {
    /// Base definition inherited from FHIR specification
    #[serde(flatten)]
    pub base: Extension,
}

impl Default for UncertainPeriod {
    fn default() -> Self {
        Self {
...
impl crate::validation::ValidatableResource for UncertainPeriod {
    ...
    fn profile_url() -> Option<&'static str> {
        Some("http://hl7.org/fhir/StructureDefinition/uncertainPeriod")
    }
}
