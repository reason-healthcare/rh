...
pub struct BiologicallyderivedproductCollectionProcedure {
    /// Base definition inherited from FHIR specification
    #[serde(flatten)]
    pub base: Extension,
}

impl Default for BiologicallyderivedproductCollectionProcedure {
    fn default() -> Self {
        Self {
...
impl crate::validation::ValidatableResource for BiologicallyderivedproductCollectionProcedure {
    ...
    fn profile_url() -> Option<&'static str> {
        Some("http://hl7.org/fhir/StructureDefinition/biologicallyderivedproduct-collection-procedure")
    }
}
