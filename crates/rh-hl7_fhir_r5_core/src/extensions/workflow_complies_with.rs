...
pub struct WorkflowCompliesWith {
    /// Base definition inherited from FHIR specification
    #[serde(flatten)]
    pub base: Extension,
}

impl Default for WorkflowCompliesWith {
    fn default() -> Self {
        Self {
...
impl crate::validation::ValidatableResource for WorkflowCompliesWith {
    ...
    fn profile_url() -> Option<&'static str> {
        Some("http://hl7.org/fhir/StructureDefinition/workflow-compliesWith")
    }
}
