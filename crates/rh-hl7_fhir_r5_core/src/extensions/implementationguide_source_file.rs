...
pub struct ImplementationguideSourceFile {
    /// Base definition inherited from FHIR specification
    #[serde(flatten)]
    pub base: Extension,
}

impl Default for ImplementationguideSourceFile {
    fn default() -> Self {
        Self {
...
impl crate::validation::ValidatableResource for ImplementationguideSourceFile {
    ...
    fn profile_url() -> Option<&'static str> {
        Some("http://hl7.org/fhir/StructureDefinition/implementationguide-sourceFile")
    }
}
