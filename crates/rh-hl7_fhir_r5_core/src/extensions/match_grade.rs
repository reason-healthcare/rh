...
pub static BINDINGS: once_cell::sync::Lazy<Vec<rh_foundation::ElementBinding>> =
    once_cell::sync::Lazy::new(|| {
        vec![
    rh_foundation::ElementBinding::new("Extension.value[x]", rh_foundation::BindingStrength::Required, "http://hl7.org/fhir/ValueSet/match-grade").with_description("A Master Patient Index (MPI) assessment of whether a candidate patient record is a match or not."),
]
    });
