...
pub struct ResearchStudyStudyRegistration {
    /// Base definition inherited from FHIR specification
    #[serde(flatten)]
    pub base: Extension,
}

impl Default for ResearchStudyStudyRegistration {
    fn default() -> Self {
        Self {
...
impl crate::validation::ValidatableResource for ResearchStudyStudyRegistration {
    ...
    fn profile_url() -> Option<&'static str> {
        Some("http://hl7.org/fhir/StructureDefinition/researchStudy-studyRegistration")
    }
}
