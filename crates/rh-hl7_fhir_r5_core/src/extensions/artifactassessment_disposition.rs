...
impl crate::validation::ValidatableResource for ArtifactassessmentDisposition {
    ...
    fn profile_url() -> Option<&'static str> {
        Some("http://hl7.org/fhir/StructureDefinition/artifactassessment-disposition")
    }
}
