...
pub struct QuestionnaireresponseAttester {
    /// Base definition inherited from FHIR specification
    #[serde(flatten)]
    pub base: Extension,
}

impl Default for QuestionnaireresponseAttester {
    fn default() -> Self {
        Self {
...
impl crate::validation::ValidatableResource for QuestionnaireresponseAttester {
    ...
    fn profile_url() -> Option<&'static str> {
        Some("http://hl7.org/fhir/StructureDefinition/questionnaireresponse-attester")
    }
}
