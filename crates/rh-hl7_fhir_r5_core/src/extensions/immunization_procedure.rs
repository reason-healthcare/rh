...
pub struct ImmunizationProcedure {
    /// Base definition inherited from FHIR specification
    #[serde(flatten)]
    pub base: Extension,
}

impl Default for ImmunizationProcedure {
    fn default() -> Self {
        Self {
...
impl crate::validation::ValidatableResource for ImmunizationProcedure {
    ...
    fn profile_url() -> Option<&'static str> {
        Some("http://hl7.org/fhir/StructureDefinition/immunization-procedure")
    }
}
