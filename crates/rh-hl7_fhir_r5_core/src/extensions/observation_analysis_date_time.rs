...
/// Observation AnalysisDateTime
///
/// The time stamp associated with the generation of the analytical result.
///
/// **Source:**
...
pub struct ObservationAnalysisDateTime {
    /// Base definition inherited from FHIR specification
    #[serde(flatten)]
    pub base: Extension,
}

impl Default for ObservationAnalysisDateTime {
    fn default() -> Self {
        Self {
...
impl crate::validation::ValidatableResource for ObservationAnalysisDateTime {
    ...
    fn profile_url() -> Option<&'static str> {
        Some("http://hl7.org/fhir/StructureDefinition/observation-analysis-date-time")
    }
}
