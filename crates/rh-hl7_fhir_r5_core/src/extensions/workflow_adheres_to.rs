...
pub struct WorkflowAdheresTo {
    /// Base definition inherited from FHIR specification
    #[serde(flatten)]
    pub base: Extension,
}

impl Default for WorkflowAdheresTo {
    fn default() -> Self {
        Self {
...
impl crate::validation::ValidatableResource for WorkflowAdheresTo {
    ...
    fn profile_url() -> Option<&'static str> {
        Some("http://hl7.org/fhir/StructureDefinition/workflow-adheresTo")
    }
}
