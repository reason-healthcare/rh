...
pub struct ConditionReviewed {
    /// Base definition inherited from FHIR specification
    #[serde(flatten)]
    pub base: Extension,
}

impl Default for ConditionReviewed {
    fn default() -> Self {
        Self {
...
impl crate::validation::ValidatableResource for ConditionReviewed {
    ...
    fn profile_url() -> Option<&'static str> {
        Some("http://hl7.org/fhir/StructureDefinition/condition-reviewed")
    }
}
