...
pub struct ArtifactReleaseLabel {
    /// Base definition inherited from FHIR specification
    #[serde(flatten)]
    pub base: Extension,
}

impl Default for ArtifactReleaseLabel {
    fn default() -> Self {
        Self {
...
impl crate::validation::ValidatableResource for ArtifactReleaseLabel {
    ...
    fn profile_url() -> Option<&'static str> {
        Some("http://hl7.org/fhir/StructureDefinition/artifact-releaseLabel")
    }
}
