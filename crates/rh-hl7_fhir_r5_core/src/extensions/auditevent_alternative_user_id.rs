...
pub struct AuditeventAlternativeUserID {
    /// Base definition inherited from FHIR specification
    #[serde(flatten)]
    pub base: Extension,
}

impl Default for AuditeventAlternativeUserID {
    fn default() -> Self {
        Self {
...
impl crate::validation::ValidatableResource for AuditeventAlternativeUserID {
    ...
    fn profile_url() -> Option<&'static str> {
        Some("http://hl7.org/fhir/StructureDefinition/auditevent-AlternativeUserID")
    }
}
