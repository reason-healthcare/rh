...
pub struct AllergyintoleranceAbatement {
    /// Base definition inherited from FHIR specification
    #[serde(flatten)]
    pub base: Extension,
}

impl Default for AllergyintoleranceAbatement {
    fn default() -> Self {
        Self {
...
impl crate::validation::ValidatableResource for AllergyintoleranceAbatement {
    ...
    fn profile_url() -> Option<&'static str> {
        Some("http://hl7.org/fhir/StructureDefinition/allergyintolerance-abatement")
    }
}
