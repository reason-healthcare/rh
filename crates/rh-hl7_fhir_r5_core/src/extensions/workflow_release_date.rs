...
pub struct WorkflowReleaseDate {
    /// Base definition inherited from FHIR specification
    #[serde(flatten)]
    pub base: Extension,
}

impl Default for WorkflowReleaseDate {
    fn default() -> Self {
        Self {
...
impl crate::validation::ValidatableResource for WorkflowReleaseDate {
    ...
    fn profile_url() -> Option<&'static str> {
        Some("http://hl7.org/fhir/StructureDefinition/workflow-releaseDate")
    }
}
