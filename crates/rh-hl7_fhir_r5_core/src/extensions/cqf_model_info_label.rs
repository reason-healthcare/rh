...
pub struct CQFModelInfoLabel {
    /// Base definition inherited from FHIR specification
    #[serde(flatten)]
    pub base: Extension,
}

impl Default for CQFModelInfoLabel {
    fn default() -> Self {
        Self {
...
impl crate::validation::ValidatableResource for CQFModelInfoLabel {
    ...
    fn profile_url() -> Option<&'static str> {
        Some("http://hl7.org/fhir/StructureDefinition/cqf-modelInfo-label")
    }
}
