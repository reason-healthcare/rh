...
pub struct StructuredefinitionStandardsStatusReason {
    /// Base definition inherited from FHIR specification
    #[serde(flatten)]
    pub base: Extension,
}

impl Default for StructuredefinitionStandardsStatusReason {
    fn default() -> Self {
        Self {
...
impl crate::validation::ValidatableResource for StructuredefinitionStandardsStatusReason {
