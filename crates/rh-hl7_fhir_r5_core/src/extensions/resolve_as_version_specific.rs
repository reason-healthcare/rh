...
pub struct ResolveAsVersionSpecific {
    /// Base definition inherited from FHIR specification
    #[serde(flatten)]
    pub base: Extension,
}

impl Default for ResolveAsVersionSpecific {
    fn default() -> Self {
        Self {
...
impl crate::validation::ValidatableResource for ResolveAsVersionSpecific {
    ...
    fn profile_url() -> Option<&'static str> {
        Some("http://hl7.org/fhir/StructureDefinition/resolve-as-version-specific")
    }
}
