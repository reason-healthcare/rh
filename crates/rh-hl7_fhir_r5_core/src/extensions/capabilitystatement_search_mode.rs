...
pub struct CapabilitystatementSearchMode {
    /// Base definition inherited from FHIR specification
    #[serde(flatten)]
    pub base: Extension,
}

impl Default for CapabilitystatementSearchMode {
    fn default() -> Self {
        Self {
...
pub static BINDINGS: once_cell::sync::Lazy<Vec<rh_foundation::ElementBinding>> =
    once_cell::sync::Lazy::new(|| {
        vec![rh_foundation::ElementBinding::new(
            ...
            "http://hl7.org/fhir/ValueSet/capabilitystatement-search-mode",
        )]
    });
...
impl crate::validation::ValidatableResource for CapabilitystatementSearchMode {
    ...
    fn profile_url() -> Option<&'static str> {
        Some("http://hl7.org/fhir/StructureDefinition/capabilitystatement-search-mode")
    }
}
