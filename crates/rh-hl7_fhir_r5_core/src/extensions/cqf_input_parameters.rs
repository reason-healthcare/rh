...
pub struct CQFInputParameters {
    /// Base definition inherited from FHIR specification
    #[serde(flatten)]
    pub base: Extension,
}

impl Default for CQFInputParameters {
    fn default() -> Self {
        Self {
...
impl crate::validation::ValidatableResource for CQFInputParameters {
    ...
    fn profile_url() -> Option<&'static str> {
        Some("http://hl7.org/fhir/StructureDefinition/cqf-inputParameters")
    }
}
