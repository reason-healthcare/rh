...
pub struct CQFDirectReferenceCode {
    /// Base definition inherited from FHIR specification
    #[serde(flatten)]
    pub base: Extension,
}

impl Default for CQFDirectReferenceCode {
    fn default() -> Self {
        Self {
...
impl crate::validation::ValidatableResource for CQFDirectReferenceCode {
    ...
    fn profile_url() -> Option<&'static str> {
        Some("http://hl7.org/fhir/StructureDefinition/cqf-directReferenceCode")
    }
}
