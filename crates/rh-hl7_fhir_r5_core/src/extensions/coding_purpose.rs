...
pub struct CodingPurpose {
    /// Base definition inherited from FHIR specification
    #[serde(flatten)]
    pub base: Extension,
}

impl Default for CodingPurpose {
    fn default() -> Self {
        Self {
...
impl crate::validation::ValidatableResource for CodingPurpose {
    ...
    fn profile_url() -> Option<&'static str> {
        Some("http://hl7.org/fhir/StructureDefinition/coding-purpose")
    }
}
