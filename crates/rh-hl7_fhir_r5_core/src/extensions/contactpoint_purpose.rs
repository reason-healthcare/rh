...
///
/// Indicates the reasons that are considered appropriate to reach out to the contactable entity via this particular mechanism.  Only for use when the ContactPoint is NOT nested inside ExtendedContactDetail.
///
/// **Source:**
...
pub struct ContactpointPurpose {
    /// Base definition inherited from FHIR specification
    #[serde(flatten)]
    pub base: Extension,
}

impl Default for ContactpointPurpose {
    fn default() -> Self {
        Self {
...
impl crate::validation::ValidatableResource for ContactpointPurpose {
    ...
    fn profile_url() -> Option<&'static str> {
        Some("http://hl7.org/fhir/StructureDefinition/contactpoint-purpose")
    }
}
