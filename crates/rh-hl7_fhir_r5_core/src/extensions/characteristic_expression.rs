...
pub struct CharacteristicExpression {
    /// Base definition inherited from FHIR specification
    #[serde(flatten)]
    pub base: Extension,
}

impl Default for CharacteristicExpression {
    fn default() -> Self {
        Self {
...
impl crate::validation::ValidatableResource for CharacteristicExpression {
    ...
    fn profile_url() -> Option<&'static str> {
        Some("http://hl7.org/fhir/StructureDefinition/characteristicExpression")
    }
}
