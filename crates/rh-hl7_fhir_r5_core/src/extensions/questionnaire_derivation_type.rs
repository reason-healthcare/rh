...
/// Questionnaire Derivation Type
///
/// Provides more precision about the type of derivation relationship that exists.
///
/// **Source:**
...
pub struct QuestionnaireDerivationType {
    /// Base definition inherited from FHIR specification
    #[serde(flatten)]
    pub base: Extension,
}

impl Default for QuestionnaireDerivationType {
    fn default() -> Self {
        Self {
...
impl crate::validation::ValidatableResource for QuestionnaireDerivationType {
    ...
    fn profile_url() -> Option<&'static str> {
        Some("http://hl7.org/fhir/StructureDefinition/questionnaire-derivationType")
    }
}
