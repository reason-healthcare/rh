...
pub struct DeviceCommercialBrand {
    /// Base definition inherited from FHIR specification
    #[serde(flatten)]
    pub base: Extension,
}

impl Default for DeviceCommercialBrand {
    fn default() -> Self {
        Self {
...
impl crate::validation::ValidatableResource for DeviceCommercialBrand {
    ...
    fn profile_url() -> Option<&'static str> {
        Some("http://hl7.org/fhir/StructureDefinition/device-commercialBrand")
    }
}
