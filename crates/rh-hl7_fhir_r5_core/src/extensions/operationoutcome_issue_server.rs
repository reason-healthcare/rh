...
/// OperationOutcome Server
///
/// Identifies the server that is responsible for creating the issue
///
/// **Source:**
...
pub struct OperationoutcomeIssueServer {
    /// Base definition inherited from FHIR specification
    #[serde(flatten)]
    pub base: Extension,
}

impl Default for OperationoutcomeIssueServer {
    fn default() -> Self {
        Self {
...
impl crate::validation::ValidatableResource for OperationoutcomeIssueServer {
    ...
    fn profile_url() -> Option<&'static str> {
        Some("http://hl7.org/fhir/StructureDefinition/operationoutcome-issue-server")
    }
}
