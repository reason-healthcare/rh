...
pub struct QuestionnaireOptionRestriction {
    /// Base definition inherited from FHIR specification
    #[serde(flatten)]
    pub base: Extension,
}

impl Default for QuestionnaireOptionRestriction {
    fn default() -> Self {
        Self {
...
impl crate::validation::ValidatableResource for QuestionnaireOptionRestriction {
    ...
    fn profile_url() -> Option<&'static str> {
        Some("http://hl7.org/fhir/StructureDefinition/questionnaire-optionRestriction")
    }
}
