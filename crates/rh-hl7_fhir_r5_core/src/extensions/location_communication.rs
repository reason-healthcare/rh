...
pub struct LocationCommunication {
    /// Base definition inherited from FHIR specification
    #[serde(flatten)]
    pub base: Extension,
}

impl Default for LocationCommunication {
    fn default() -> Self {
        Self {
...
impl crate::validation::ValidatableResource for LocationCommunication {
    ...
    fn profile_url() -> Option<&'static str> {
        Some("http://hl7.org/fhir/StructureDefinition/location-communication")
    }
}
