...
impl Default for ParametersDefinition {
    fn default() -> Self {
        Self {
...
impl crate::validation::ValidatableResource for ParametersDefinition {
    ...
    fn profile_url() -> Option<&'static str> {
        Some("http://hl7.org/fhir/StructureDefinition/parameters-definition")
    }
}
