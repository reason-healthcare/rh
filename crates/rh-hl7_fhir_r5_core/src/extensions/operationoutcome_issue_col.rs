...
pub struct OperationoutcomeIssueCol {
    /// Base definition inherited from FHIR specification
    #[serde(flatten)]
    pub base: Extension,
}

impl Default for OperationoutcomeIssueCol {
    fn default() -> Self {
        Self {
...
impl crate::validation::ValidatableResource for OperationoutcomeIssueCol {
    ...
    fn profile_url() -> Option<&'static str> {
        Some("http://hl7.org/fhir/StructureDefinition/operationoutcome-issue-col")
    }
}
