...
pub struct ValuesetComposeCreatedBy {
    /// Base definition inherited from FHIR specification
    #[serde(flatten)]
    pub base: Extension,
}

impl Default for ValuesetComposeCreatedBy {
    fn default() -> Self {
        Self {
...
impl crate::validation::ValidatableResource for ValuesetComposeCreatedBy {
    ...
    fn profile_url() -> Option<&'static str> {
        Some("http://hl7.org/fhir/StructureDefinition/valueset-compose-createdBy")
    }
}
