...
pub struct ContactpointComment {
    /// Base definition inherited from FHIR specification
    #[serde(flatten)]
    pub base: Extension,
}

impl Default for ContactpointComment {
    fn default() -> Self {
        Self {
...
impl crate::validation::ValidatableResource for ContactpointComment {
    ...
    fn profile_url() -> Option<&'static str> {
        Some("http://hl7.org/fhir/StructureDefinition/contactpoint-comment")
    }
}
