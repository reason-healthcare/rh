...
pub struct DiagnosticReportFocus {
    /// Base definition inherited from FHIR specification
    #[serde(flatten)]
    pub base: Extension,
}

impl Default for DiagnosticReportFocus {
    fn default() -> Self {
        Self {
...
impl crate::validation::ValidatableResource for DiagnosticReportFocus {
    ...
    fn profile_url() -> Option<&'static str> {
        Some("http://hl7.org/fhir/StructureDefinition/diagnosticReport-focus")
    }
}
