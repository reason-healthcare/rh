...
pub struct AdditionalIdentifier {
    /// Base definition inherited from FHIR specification
    #[serde(flatten)]
    pub base: Extension,
}

impl Default for AdditionalIdentifier {
    fn default() -> Self {
        Self {
...
impl crate::validation::ValidatableResource for AdditionalIdentifier {
    ...
    fn profile_url() -> Option<&'static str> {
        Some("http://hl7.org/fhir/StructureDefinition/additionalIdentifier")
    }
}
