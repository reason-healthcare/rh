...
pub struct ConsentResearchStudyContext {
    /// Base definition inherited from FHIR specification
    #[serde(flatten)]
    pub base: Extension,
}

impl Default for ConsentResearchStudyContext {
    fn default() -> Self {
        Self {
...
impl crate::validation::ValidatableResource for ConsentResearchStudyContext {
    ...
    fn profile_url() -> Option<&'static str> {
        Some("http://hl7.org/fhir/StructureDefinition/consent-ResearchStudyContext")
    }
}
