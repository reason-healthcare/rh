...
impl Default for ArtifactPublisher {
    fn default() -> Self {
        Self {
...
impl crate::validation::ValidatableResource for ArtifactPublisher {
    ...
    fn profile_url() -> Option<&'static str> {
        Some("http://hl7.org/fhir/StructureDefinition/artifact-publisher")
    }
}
