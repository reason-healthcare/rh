...
pub struct ConditionDiseaseCourse {
    /// Base definition inherited from FHIR specification
    #[serde(flatten)]
    pub base: Extension,
}

impl Default for ConditionDiseaseCourse {
    fn default() -> Self {
        Self {
...
impl crate::validation::ValidatableResource for ConditionDiseaseCourse {
    ...
    fn profile_url() -> Option<&'static str> {
        Some("http://hl7.org/fhir/StructureDefinition/condition-diseaseCourse")
    }
}
