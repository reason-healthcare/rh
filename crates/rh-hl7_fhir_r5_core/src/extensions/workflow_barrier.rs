...
impl Default for WorkflowBarrier {
    fn default() -> Self {
        Self {
...
impl crate::validation::ValidatableResource for WorkflowBarrier {
    ...
    fn profile_url() -> Option<&'static str> {
        Some("http://hl7.org/fhir/StructureDefinition/workflow-barrier")
    }
}
