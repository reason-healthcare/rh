...
///
/// Marks that the resource definition represents an [interface](uml.html#interface) rather than a resource.
///
/// **Source:**
...
pub struct StructuredefinitionInterface {
    /// Base definition inherited from FHIR specification
    #[serde(flatten)]
    pub base: Extension,
}

impl Default for StructuredefinitionInterface {
    fn default() -> Self {
        Self {
...
impl crate::validation::ValidatableResource for StructuredefinitionInterface {
    ...
    fn profile_url() -> Option<&'static str> {
        Some("http://hl7.org/fhir/StructureDefinition/structuredefinition-interface")
    }
}
