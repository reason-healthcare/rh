...
pub struct PatientContactPriority {
    /// Base definition inherited from FHIR specification
    #[serde(flatten)]
    pub base: Extension,
}

impl Default for PatientContactPriority {
    fn default() -> Self {
        Self {
...
impl crate::validation::ValidatableResource for PatientContactPriority {
    ...
    fn profile_url() -> Option<&'static str> {
        Some("http://hl7.org/fhir/StructureDefinition/patient-contactPriority")
    }
}
