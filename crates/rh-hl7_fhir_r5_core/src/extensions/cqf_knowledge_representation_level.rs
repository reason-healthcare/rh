...
/// CQF knowledge representation level
///
...
pub struct CQFKnowledgeRepresentationLevel {
    /// Base definition inherited from FHIR specification
    #[serde(flatten)]
    pub base: Extension,
}

impl Default for CQFKnowledgeRepresentationLevel {
    fn default() -> Self {
        Self {
...
impl crate::validation::ValidatableResource for CQFKnowledgeRepresentationLevel {
    ...
    fn profile_url() -> Option<&'static str> {
        Some("http://hl7.org/fhir/StructureDefinition/cqf-knowledgeRepresentationLevel")
    }
}
