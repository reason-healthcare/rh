...
pub struct ArtifactCanonicalReference {
    /// Base definition inherited from FHIR specification
    #[serde(flatten)]
    pub base: Extension,
}

impl Default for ArtifactCanonicalReference {
    fn default() -> Self {
        Self {
...
impl crate::validation::ValidatableResource for ArtifactCanonicalReference {
    ...
    fn profile_url() -> Option<&'static str> {
        Some("http://hl7.org/fhir/StructureDefinition/artifact-canonicalReference")
    }
}
