...
pub struct WorkflowTriggeredBy {
    /// Base definition inherited from FHIR specification
    #[serde(flatten)]
    pub base: Extension,
}

impl Default for WorkflowTriggeredBy {
    fn default() -> Self {
        Self {
...
impl crate::validation::ValidatableResource for WorkflowTriggeredBy {
    ...
    fn profile_url() -> Option<&'static str> {
        Some("http://hl7.org/fhir/StructureDefinition/workflow-triggeredBy")
    }
}
