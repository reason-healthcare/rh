...
pub struct CQFLogicDefinition {
    /// Base definition inherited from FHIR specification
    #[serde(flatten)]
    pub base: Extension,
}

impl Default for CQFLogicDefinition {
    fn default() -> Self {
        Self {
...
impl crate::validation::ValidatableResource for CQFLogicDefinition {
    ...
    fn profile_url() -> Option<&'static str> {
        Some("http://hl7.org/fhir/StructureDefinition/cqf-logicDefinition")
    }
}
