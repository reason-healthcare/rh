...
pub struct CQFContactAddress {
    /// Base definition inherited from FHIR specification
    #[serde(flatten)]
    pub base: Extension,
}

impl Default for CQFContactAddress {
    fn default() -> Self {
        Self {
...
impl crate::validation::ValidatableResource for CQFContactAddress {
    ...
    fn profile_url() -> Option<&'static str> {
        Some("http://hl7.org/fhir/StructureDefinition/cqf-contactAddress")
    }
}
