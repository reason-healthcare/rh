...
pub struct CQFMessages {
    /// Base definition inherited from FHIR specification
    #[serde(flatten)]
    pub base: Extension,
}

impl Default for CQFMessages {
    fn default() -> Self {
        Self {
...
impl crate::validation::ValidatableResource for CQFMessages {
    ...
    fn profile_url() -> Option<&'static str> {
        Some("http://hl7.org/fhir/StructureDefinition/cqf-messages")
    }
}
