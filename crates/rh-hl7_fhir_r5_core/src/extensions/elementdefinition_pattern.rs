...
pub struct ElementdefinitionPattern {
...
impl crate::validation::ValidatableResource for ElementdefinitionPattern {
    ...
    fn profile_url() -> Option<&'static str> {
        Some("http://hl7.org/fhir/StructureDefinition/elementdefinition-pattern")
    }
}
