...
pub struct PatientSexParameterForClinicalUse {
    /// Base definition inherited from FHIR specification
    #[serde(flatten)]
    pub base: Extension,
}

impl Default for PatientSexParameterForClinicalUse {
    fn default() -> Self {
        Self {
...
impl crate::validation::ValidatableResource for PatientSexParameterForClinicalUse {
    ...
    fn profile_url() -> Option<&'static str> {
        Some("http://hl7.org/fhir/StructureDefinition/patient-sexParameterForClinicalUse")
    }
}
