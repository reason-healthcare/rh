...
/// Part Of
///
/// Specifies an overall specification artifact that this manifest or release is part of.
///
/// **Source:**
...
pub struct CQFPartOf {
    /// Base definition inherited from FHIR specification
    #[serde(flatten)]
    pub base: Extension,
}

impl Default for CQFPartOf {
    fn default() -> Self {
        Self {
...
impl crate::validation::ValidatableResource for CQFPartOf {
    ...
    fn profile_url() -> Option<&'static str> {
        Some("http://hl7.org/fhir/StructureDefinition/cqf-partOf")
    }
}
