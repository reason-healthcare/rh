...
impl crate::validation::ValidatableResource for BiologicallyderivedproductManipulation {
    ...
    fn profile_url() -> Option<&'static str> {
        Some("http://hl7.org/fhir/StructureDefinition/biologicallyderivedproduct-manipulation")
    }
}
