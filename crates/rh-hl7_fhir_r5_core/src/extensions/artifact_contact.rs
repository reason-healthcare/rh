...
/// - Base Definition: http://hl7.org/fhir/StructureDefinition/Extension
#[derive(Debug, Clone, Serialize, Deserialize)]
pub struct ArtifactContactDetailReference {
    /// Base definition inherited from FHIR specification
    #[serde(flatten)]
    pub base: Extension,
}

impl Default for ArtifactContact {
    fn default() -> Self {
        Self {
...
impl Default for ArtifactContactDetailReference {
    fn default() -> Self {
        Self {
            base: Extension::default(),
        }
...
impl crate::validation::ValidatableResource for ArtifactContact {
    ...
    fn profile_url() -> Option<&'static str> {
        Some("http://hl7.org/fhir/StructureDefinition/artifact-contact")
    }
}
