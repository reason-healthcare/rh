...
pub struct ObservationV2Subid {
    /// Base definition inherited from FHIR specification
    #[serde(flatten)]
    pub base: Extension,
}

impl Default for ObservationV2Subid {
    fn default() -> Self {
        Self {
...
impl crate::validation::ValidatableResource for ObservationV2Subid {
    ...
    fn profile_url() -> Option<&'static str> {
        Some("http://hl7.org/fhir/StructureDefinition/observation-v2-subid")
    }
}
