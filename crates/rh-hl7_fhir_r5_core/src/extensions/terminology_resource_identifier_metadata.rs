...
pub struct TerminologyResourceIdentifierMetadata {
    /// Base definition inherited from FHIR specification
    #[serde(flatten)]
    pub base: Extension,
}

impl Default for TerminologyResourceIdentifierMetadata {
    fn default() -> Self {
        Self {
...
impl crate::validation::ValidatableResource for TerminologyResourceIdentifierMetadata {
    ...
    fn profile_url() -> Option<&'static str> {
        Some("http://hl7.org/fhir/StructureDefinition/terminology-resource-identifier-metadata")
    }
}
