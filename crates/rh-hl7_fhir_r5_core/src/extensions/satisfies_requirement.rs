...
impl Default for SatisfiesRequirement {
    fn default() -> Self {
        Self {
...
impl crate::validation::ValidatableResource for SatisfiesRequirement {
    ...
    fn profile_url() -> Option<&'static str> {
        Some("http://hl7.org/fhir/StructureDefinition/satisfies-requirement")
    }
}
