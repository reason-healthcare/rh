...
pub struct IndividualPronouns {
    /// Base definition inherited from FHIR specification
    #[serde(flatten)]
    pub base: Extension,
}

impl Default for IndividualPronouns {
    fn default() -> Self {
        Self {
...
impl crate::validation::ValidatableResource for IndividualPronouns {
    ...
    fn profile_url() -> Option<&'static str> {
        Some("http://hl7.org/fhir/StructureDefinition/individual-pronouns")
    }
}
