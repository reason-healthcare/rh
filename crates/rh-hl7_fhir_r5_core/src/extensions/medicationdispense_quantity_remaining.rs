...
pub struct MedicationdispenseQuantityRemaining {
    /// Base definition inherited from FHIR specification
    #[serde(flatten)]
    pub base: Extension,
}

impl Default for MedicationdispenseQuantityRemaining {
    fn default() -> Self {
        Self {
...
impl crate::validation::ValidatableResource for MedicationdispenseQuantityRemaining {
    ...
    fn profile_url() -> Option<&'static str> {
        Some("http://hl7.org/fhir/StructureDefinition/medicationdispense-quantityRemaining")
    }
}
