...
pub struct CQFTargetInvariant {
    /// Base definition inherited from FHIR specification
    #[serde(flatten)]
    pub base: Extension,
}

impl Default for CQFTargetInvariant {
    fn default() -> Self {
        Self {
...
impl crate::validation::ValidatableResource for CQFTargetInvariant {
    ...
    fn profile_url() -> Option<&'static str> {
        Some("http://hl7.org/fhir/StructureDefinition/cqf-targetInvariant")
    }
}
