...
pub struct ResourceInstanceDescription {
    /// Base definition inherited from FHIR specification
    #[serde(flatten)]
    pub base: Extension,
}

impl Default for ResourceInstanceDescription {
    fn default() -> Self {
        Self {
...
pub static INVARIANTS: once_cell::sync::Lazy<Vec<rh_foundation::Invariant>> =
    ...
    rh_foundation::Invariant::new("rid-1", rh_foundation::Severity::Error, "Cannot be used where description already exists or description is of type string or markdown.", "%resource.description.exists().not() or ((%resource.description is string).not() and (%resource.description is markdown).not())"),
]
    });
...
impl crate::validation::ValidatableResource for ResourceInstanceDescription {
    ...
    fn profile_url() -> Option<&'static str> {
        Some("http://hl7.org/fhir/StructureDefinition/resource-instance-description")
    }
}
