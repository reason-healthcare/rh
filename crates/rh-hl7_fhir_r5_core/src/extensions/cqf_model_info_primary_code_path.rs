...
pub struct CQFModelInfoPrimaryCodePath {
    /// Base definition inherited from FHIR specification
    #[serde(flatten)]
    pub base: Extension,
}

impl Default for CQFModelInfoPrimaryCodePath {
    fn default() -> Self {
        Self {
...
impl crate::validation::ValidatableResource for CQFModelInfoPrimaryCodePath {
    ...
    fn profile_url() -> Option<&'static str> {
        Some("http://hl7.org/fhir/StructureDefinition/cqf-modelInfo-primaryCodePath")
    }
}
