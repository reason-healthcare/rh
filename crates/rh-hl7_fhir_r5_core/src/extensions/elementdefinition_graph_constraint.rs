...
pub struct ElementdefinitionGraphConstraint {
    /// Base definition inherited from FHIR specification
    #[serde(flatten)]
    pub base: Extension,
}

impl Default for ElementdefinitionGraphConstraint {
    fn default() -> Self {
        Self {
...
impl crate::validation::ValidatableResource for ElementdefinitionGraphConstraint {
    ...
    fn profile_url() -> Option<&'static str> {
        Some("http://hl7.org/fhir/StructureDefinition/elementdefinition-graphConstraint")
    }
}
