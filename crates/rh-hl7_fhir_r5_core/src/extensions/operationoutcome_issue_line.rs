...
pub struct OperationoutcomeIssueLine {
    /// Base definition inherited from FHIR specification
    #[serde(flatten)]
    pub base: Extension,
}

impl Default for OperationoutcomeIssueLine {
    fn default() -> Self {
        Self {
...
impl crate::validation::ValidatableResource for OperationoutcomeIssueLine {
    ...
    fn profile_url() -> Option<&'static str> {
        Some("http://hl7.org/fhir/StructureDefinition/operationoutcome-issue-line")
    }
}
