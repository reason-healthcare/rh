...
pub struct CanonicalresourceShortDescription {
    /// Base definition inherited from FHIR specification
    #[serde(flatten)]
    pub base: Extension,
}

impl Default for CanonicalresourceShortDescription {
    fn default() -> Self {
        Self {
...
impl crate::validation::ValidatableResource for CanonicalresourceShortDescription {
    ...
    fn profile_url() -> Option<&'static str> {
        Some("http://hl7.org/fhir/StructureDefinition/canonicalresource-short-description")
    }
}
