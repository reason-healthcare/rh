...
pub struct ResourceInstanceName {
    /// Base definition inherited from FHIR specification
    #[serde(flatten)]
    pub base: Extension,
}

impl Default for ResourceInstanceName {
    fn default() -> Self {
        Self {
    ...
    once_cell::sync::Lazy::new(|| {
        vec![
            ...
            rh_foundation::Invariant::new(
                "rin-1",
                rh_foundation::Severity::Error,
                "Cannot be used where title already exists.",
                "%resource.title.exists().not()",
            ),
        ]
    });
...
impl crate::validation::ValidatableResource for ResourceInstanceName {
    ...
    fn profile_url() -> Option<&'static str> {
        Some("http://hl7.org/fhir/StructureDefinition/resource-instance-name")
    }
}
