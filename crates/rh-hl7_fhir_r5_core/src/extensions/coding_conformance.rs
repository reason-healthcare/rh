...
pub struct CodingConformance {
    /// Base definition inherited from FHIR specification
    #[serde(flatten)]
    pub base: Extension,
}

impl Default for CodingConformance {
    fn default() -> Self {
        Self {
...
impl crate::validation::ValidatableResource for CodingConformance {
    ...
    fn profile_url() -> Option<&'static str> {
        Some("http://hl7.org/fhir/StructureDefinition/coding-conformance")
    }
}
