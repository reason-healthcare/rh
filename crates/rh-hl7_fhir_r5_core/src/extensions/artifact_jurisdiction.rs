...
pub struct ArtifactJurisdiction {
    /// Base definition inherited from FHIR specification
    #[serde(flatten)]
    pub base: Extension,
}

impl Default for ArtifactJurisdiction {
    fn default() -> Self {
        Self {
...
impl crate::validation::ValidatableResource for ArtifactJurisdiction {
    ...
    fn profile_url() -> Option<&'static str> {
        Some("http://hl7.org/fhir/StructureDefinition/artifact-jurisdiction")
    }
}
