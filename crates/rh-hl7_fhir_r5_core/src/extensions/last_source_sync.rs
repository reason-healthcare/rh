...
pub struct LastSourceSync {
    /// Base definition inherited from FHIR specification
    #[serde(flatten)]
    pub base: Extension,
}

impl Default for LastSourceSync {
    fn default() -> Self {
        Self {
...
impl crate::validation::ValidatableResource for LastSourceSync {
    ...
    fn profile_url() -> Option<&'static str> {
        Some("http://hl7.org/fhir/StructureDefinition/lastSourceSync")
    }
}
