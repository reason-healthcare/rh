...
/// Dosage - Minimum Gap Between Doses
///
...
pub struct DosageMinimumGapBetweenDose {
    /// Base definition inherited from FHIR specification
    #[serde(flatten)]
    pub base: Extension,
}

impl Default for DosageMinimumGapBetweenDose {
    fn default() -> Self {
        Self {
...
pub static CARDINALITIES: once_cell::sync::Lazy<Vec<rh_foundation::ElementCardinality>> =
    once_cell::sync::Lazy::new(|| {
        vec![
            ...
            rh_foundation::ElementCardinality::new("Extension.extension.extension", 1, None),
...
impl crate::validation::ValidatableResource for DosageMinimumGapBetweenDose {
    ...
    fn profile_url() -> Option<&'static str> {
        Some("http://hl7.org/fhir/StructureDefinition/dosage-minimumGapBetweenDose")
    }
}
