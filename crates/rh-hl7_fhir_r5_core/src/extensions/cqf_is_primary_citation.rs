...
pub struct CQFIsPrimaryCitation {
    /// Base definition inherited from FHIR specification
    #[serde(flatten)]
    pub base: Extension,
}

impl Default for CQFIsPrimaryCitation {
    fn default() -> Self {
        Self {
...
impl crate::validation::ValidatableResource for CQFIsPrimaryCitation {
    ...
    fn profile_url() -> Option<&'static str> {
        Some("http://hl7.org/fhir/StructureDefinition/cqf-isPrimaryCitation")
    }
}
