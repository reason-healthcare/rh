...
pub struct CitationSocietyAffiliation {
    /// Base definition inherited from FHIR specification
    #[serde(flatten)]
    pub base: Extension,
}

impl Default for CitationSocietyAffiliation {
    fn default() -> Self {
        Self {
...
impl crate::validation::ValidatableResource for CitationSocietyAffiliation {
    ...
    fn profile_url() -> Option<&'static str> {
        Some("http://hl7.org/fhir/StructureDefinition/citation-societyAffiliation")
    }
}
