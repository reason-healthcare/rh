...
/// ValueSet Supplement
///
/// This extension declares that a value set depends on a particular [CodeSystem supplement](codesystem.html#supplements) and should not be used in its absence.
///
/// **Source:**
...
impl crate::validation::ValidatableResource for ValuesetSupplement {
