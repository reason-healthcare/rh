...
pub struct CodesystemAuthoritativeSource {
    /// Base definition inherited from FHIR specification
    #[serde(flatten)]
    pub base: Extension,
}

impl Default for CodesystemAuthoritativeSource {
    fn default() -> Self {
        Self {
...
impl crate::validation::ValidatableResource for CodesystemAuthoritativeSource {
    ...
    fn profile_url() -> Option<&'static str> {
        Some("http://hl7.org/fhir/StructureDefinition/codesystem-authoritativeSource")
    }
}
