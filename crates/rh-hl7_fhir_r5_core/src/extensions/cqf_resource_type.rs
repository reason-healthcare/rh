...
pub struct CQFResourceType {
    /// Base definition inherited from FHIR specification
    #[serde(flatten)]
    pub base: Extension,
}

impl Default for CQFResourceType {
    fn default() -> Self {
        Self {
...
impl crate::validation::ValidatableResource for CQFResourceType {
    ...
    fn profile_url() -> Option<&'static str> {
        Some("http://hl7.org/fhir/StructureDefinition/cqf-resourceType")
    }
}
