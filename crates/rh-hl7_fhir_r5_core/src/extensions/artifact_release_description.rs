...
pub struct ArtifactReleaseDescription {
    /// Base definition inherited from FHIR specification
    #[serde(flatten)]
    pub base: Extension,
}

impl Default for ArtifactReleaseDescription {
    fn default() -> Self {
        Self {
...
impl crate::validation::ValidatableResource for ArtifactReleaseDescription {
    ...
    fn profile_url() -> Option<&'static str> {
        Some("http://hl7.org/fhir/StructureDefinition/artifact-releaseDescription")
    }
}
