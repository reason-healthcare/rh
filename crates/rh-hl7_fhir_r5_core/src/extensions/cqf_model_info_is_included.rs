...
pub struct CQFModelInfoIsIncluded {
    /// Base definition inherited from FHIR specification
    #[serde(flatten)]
    pub base: Extension,
}

impl Default for CQFModelInfoIsIncluded {
    fn default() -> Self {
        Self {
...
impl crate::validation::ValidatableResource for CQFModelInfoIsIncluded {
    ...
    fn profile_url() -> Option<&'static str> {
        Some("http://hl7.org/fhir/StructureDefinition/cqf-modelInfo-isIncluded")
    }
}
