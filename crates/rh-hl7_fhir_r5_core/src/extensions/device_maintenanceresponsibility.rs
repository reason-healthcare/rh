...
///
/// Extension containing the information about the person and/or organization responsible for the maintenance of the device.
///
/// **Source:**
...
pub struct DeviceMaintenanceresponsibility {
    /// Base definition inherited from FHIR specification
    #[serde(flatten)]
    pub base: Extension,
}

impl Default for DeviceMaintenanceresponsibility {
    fn default() -> Self {
        Self {
...
impl crate::validation::ValidatableResource for DeviceMaintenanceresponsibility {
    ...
    fn profile_url() -> Option<&'static str> {
        Some("http://hl7.org/fhir/StructureDefinition/device-maintenanceresponsibility")
    }
}
