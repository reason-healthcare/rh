...
pub struct ArtifactEffectivePeriod {
    /// Base definition inherited from FHIR specification
    #[serde(flatten)]
    pub base: Extension,
}

impl Default for ArtifactEffectivePeriod {
    fn default() -> Self {
        Self {
...
impl crate::validation::ValidatableResource for ArtifactEffectivePeriod {
    ...
    fn profile_url() -> Option<&'static str> {
        Some("http://hl7.org/fhir/StructureDefinition/artifact-effectivePeriod")
    }
}
