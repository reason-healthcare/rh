...
pub struct CQFArtifactComment {
    /// Base definition inherited from FHIR specification
    #[serde(flatten)]
    pub base: Extension,
}

impl Default for CQFArtifactComment {
    fn default() -> Self {
        Self {
...
impl crate::validation::ValidatableResource for CQFArtifactComment {
    ...
    fn profile_url() -> Option<&'static str> {
        Some("http://hl7.org/fhir/StructureDefinition/cqf-artifactComment")
    }
}
