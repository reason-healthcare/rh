...
pub struct WorkflowGeneratedFrom {
    /// Base definition inherited from FHIR specification
    #[serde(flatten)]
    pub base: Extension,
}

impl Default for WorkflowGeneratedFrom {
    fn default() -> Self {
        Self {
...
impl crate::validation::ValidatableResource for WorkflowGeneratedFrom {
    ...
    fn profile_url() -> Option<&'static str> {
        Some("http://hl7.org/fhir/StructureDefinition/workflow-generatedFrom")
    }
}
