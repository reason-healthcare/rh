...
impl crate::validation::ValidatableResource for BiologicallyderivedproductProcessing {
    ...
    fn profile_url() -> Option<&'static str> {
        Some("http://hl7.org/fhir/StructureDefinition/biologicallyderivedproduct-processing")
    }
}
