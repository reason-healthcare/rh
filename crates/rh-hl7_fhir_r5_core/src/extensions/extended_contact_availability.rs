...
pub struct ExtendedContactAvailability {
    /// Base definition inherited from FHIR specification
    #[serde(flatten)]
    pub base: Extension,
}

impl Default for ExtendedContactAvailability {
    fn default() -> Self {
        Self {
...
impl crate::validation::ValidatableResource for ExtendedContactAvailability {
    ...
    fn profile_url() -> Option<&'static str> {
        Some("http://hl7.org/fhir/StructureDefinition/extended-contact-availability")
    }
}
