...
pub struct AuditeventLifecycle {
    /// Base definition inherited from FHIR specification
    #[serde(flatten)]
    pub base: Extension,
}

impl Default for AuditeventLifecycle {
    fn default() -> Self {
        Self {
...
impl crate::validation::ValidatableResource for AuditeventLifecycle {
    ...
    fn profile_url() -> Option<&'static str> {
        Some("http://hl7.org/fhir/StructureDefinition/auditevent-Lifecycle")
    }
}
