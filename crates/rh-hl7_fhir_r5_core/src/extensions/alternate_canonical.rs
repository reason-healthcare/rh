...
pub struct AlternateCanonical {
    /// Base definition inherited from FHIR specification
    #[serde(flatten)]
    pub base: Extension,
}

impl Default for AlternateCanonical {
    fn default() -> Self {
        Self {
...
impl crate::validation::ValidatableResource for AlternateCanonical {
    ...
    fn profile_url() -> Option<&'static str> {
        Some("http://hl7.org/fhir/StructureDefinition/alternate-canonical")
    }
}
