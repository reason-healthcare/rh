...
pub struct OperationoutcomeFile {
    /// Base definition inherited from FHIR specification
    #[serde(flatten)]
    pub base: Extension,
}

impl Default for OperationoutcomeFile {
    fn default() -> Self {
        Self {
...
impl crate::validation::ValidatableResource for OperationoutcomeFile {
    ...
    fn profile_url() -> Option<&'static str> {
        Some("http://hl7.org/fhir/StructureDefinition/operationoutcome-file")
    }
}
