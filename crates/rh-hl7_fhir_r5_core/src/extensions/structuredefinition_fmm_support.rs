...
pub struct StructuredefinitionFmmSupport {
    /// Base definition inherited from FHIR specification
    #[serde(flatten)]
    pub base: Extension,
}

impl Default for StructuredefinitionFmmSupport {
    fn default() -> Self {
        Self {
...
impl crate::validation::ValidatableResource for StructuredefinitionFmmSupport {
    ...
    fn profile_url() -> Option<&'static str> {
        Some("http://hl7.org/fhir/StructureDefinition/structuredefinition-fmm-support")
    }
}
