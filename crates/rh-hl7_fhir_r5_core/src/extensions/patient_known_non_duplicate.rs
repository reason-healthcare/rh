...
pub struct PatientKnownNonDuplicate {
    /// Base definition inherited from FHIR specification
    #[serde(flatten)]
    pub base: Extension,
}

impl Default for PatientKnownNonDuplicate {
    fn default() -> Self {
        Self {
...
impl crate::validation::ValidatableResource for PatientKnownNonDuplicate {
    ...
    fn profile_url() -> Option<&'static str> {
        Some("http://hl7.org/fhir/StructureDefinition/patient-knownNonDuplicate")
    }
}
