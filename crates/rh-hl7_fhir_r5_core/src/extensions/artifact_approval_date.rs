...
pub struct ArtifactApprovalDate {
    /// Base definition inherited from FHIR specification
    #[serde(flatten)]
    pub base: Extension,
}

impl Default for ArtifactApprovalDate {
    fn default() -> Self {
        Self {
...
impl crate::validation::ValidatableResource for ArtifactApprovalDate {
    ...
    fn profile_url() -> Option<&'static str> {
        Some("http://hl7.org/fhir/StructureDefinition/artifact-approvalDate")
    }
}
