...
pub struct ArtifactUseContext {
    /// Base definition inherited from FHIR specification
    #[serde(flatten)]
    pub base: Extension,
}

impl Default for ArtifactUseContext {
    fn default() -> Self {
        Self {
...
impl crate::validation::ValidatableResource for ArtifactUseContext {
    ...
    fn profile_url() -> Option<&'static str> {
        Some("http://hl7.org/fhir/StructureDefinition/artifact-useContext")
    }
}
