...
pub struct CQFCqlOptions {
    /// Base definition inherited from FHIR specification
    #[serde(flatten)]
    pub base: Extension,
}

impl Default for CQFCqlOptions {
    fn default() -> Self {
        Self {
...
impl crate::validation::ValidatableResource for CQFCqlOptions {
    ...
    fn profile_url() -> Option<&'static str> {
        Some("http://hl7.org/fhir/StructureDefinition/cqf-cqlOptions")
    }
}
