...
pub struct CQFAlternativeExpression {
    /// Base definition inherited from FHIR specification
    #[serde(flatten)]
    pub base: Extension,
}

impl Default for CQFAlternativeExpression {
    fn default() -> Self {
        Self {
...
impl crate::validation::ValidatableResource for CQFAlternativeExpression {
    ...
    fn profile_url() -> Option<&'static str> {
        Some("http://hl7.org/fhir/StructureDefinition/cqf-alternativeExpression")
    }
}
