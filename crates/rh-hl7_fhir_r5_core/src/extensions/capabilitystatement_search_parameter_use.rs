...
pub struct CapabilitystatementSearchParameterUse {
    /// Base definition inherited from FHIR specification
    #[serde(flatten)]
    pub base: Extension,
}

impl Default for CapabilitystatementSearchParameterUse {
    fn default() -> Self {
        Self {
...
impl crate::validation::ValidatableResource for CapabilitystatementSearchParameterUse {
    ...
    fn profile_url() -> Option<&'static str> {
        Some("http://hl7.org/fhir/StructureDefinition/capabilitystatement-search-parameter-use")
    }
}
