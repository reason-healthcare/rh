...
pub struct CQFModelInfoSettings {
    /// Base definition inherited from FHIR specification
    #[serde(flatten)]
    pub base: Extension,
}

impl Default for CQFModelInfoSettings {
    fn default() -> Self {
        Self {
...
impl crate::validation::ValidatableResource for CQFModelInfoSettings {
    ...
    fn profile_url() -> Option<&'static str> {
        Some("http://hl7.org/fhir/StructureDefinition/cqf-modelInfoSettings")
    }
}
