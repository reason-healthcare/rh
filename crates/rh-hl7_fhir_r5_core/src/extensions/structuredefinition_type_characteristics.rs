...
pub struct StructuredefinitionTypeCharacteristics {
    /// Base definition inherited from FHIR specification
    #[serde(flatten)]
    pub base: Extension,
}

impl Default for StructuredefinitionTypeCharacteristics {
    fn default() -> Self {
        Self {
...
impl crate::validation::ValidatableResource for StructuredefinitionTypeCharacteristics {
