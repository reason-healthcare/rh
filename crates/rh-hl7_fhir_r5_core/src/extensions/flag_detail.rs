...
/// Flag details
///
/// Points to the Observation, AllergyIntolerance or other record that provides additional supporting information about this flag. Note that This extension will be replaced by Flag.supportingInfo in the FHIR R6 release.
///
/// **Source:**
...
impl crate::validation::ValidatableResource for FlagDetail {
    ...
    fn profile_url() -> Option<&'static str> {
        Some("http://hl7.org/fhir/StructureDefinition/flag-detail")
    }
}
