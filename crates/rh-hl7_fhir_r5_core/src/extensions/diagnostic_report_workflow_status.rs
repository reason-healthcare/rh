...
/// DiagnosticReport Workflow Status
///
...
pub struct DiagnosticReportWorkflowStatus {
    /// Base definition inherited from FHIR specification
    #[serde(flatten)]
    pub base: Extension,
}

impl Default for DiagnosticReportWorkflowStatus {
    fn default() -> Self {
        Self {
...
impl crate::validation::ValidatableResource for DiagnosticReportWorkflowStatus {
    ...
    fn profile_url() -> Option<&'static str> {
        Some("http://hl7.org/fhir/StructureDefinition/diagnosticReport-workflowStatus")
    }
}
