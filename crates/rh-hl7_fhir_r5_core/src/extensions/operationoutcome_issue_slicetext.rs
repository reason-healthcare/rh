...
/// OperationOutcome Slice Text
///
/// Provides additional information about why an element doesn't match a slice
///
/// **Source:**
...
pub struct OperationoutcomeIssueSlicetext {
    /// Base definition inherited from FHIR specification
    #[serde(flatten)]
    pub base: Extension,
}

impl Default for OperationoutcomeIssueSlicetext {
    fn default() -> Self {
        Self {
...
impl crate::validation::ValidatableResource for OperationoutcomeIssueSlicetext {
    ...
    fn profile_url() -> Option<&'static str> {
        Some("http://hl7.org/fhir/StructureDefinition/operationoutcome-issue-slicetext")
    }
}
