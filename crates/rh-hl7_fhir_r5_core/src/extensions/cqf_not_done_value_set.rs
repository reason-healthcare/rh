...
pub struct CQFNotDoneValueSet {
    /// Base definition inherited from FHIR specification
    #[serde(flatten)]
    pub base: Extension,
}

impl Default for CQFNotDoneValueSet {
    fn default() -> Self {
        Self {
...
impl crate::validation::ValidatableResource for CQFNotDoneValueSet {
    ...
    fn profile_url() -> Option<&'static str> {
        Some("http://hl7.org/fhir/StructureDefinition/cqf-notDoneValueSet")
    }
}
