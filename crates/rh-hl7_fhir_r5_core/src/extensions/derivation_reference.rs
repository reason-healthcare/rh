...
impl Default for DerivationReference {
    fn default() -> Self {
        Self {
...
pub static INVARIANTS: once_cell::sync::Lazy<Vec<rh_foundation::Invariant>> =
    once_cell::sync::Lazy::new(|| {
        vec![
    rh_foundation::Invariant::new("der-1", rh_foundation::Severity::Error, "Cannot have length if offset is missing.", "extension.where(url='length').exists() implies extension.where(url='offset').exists()"),
...
impl crate::validation::ValidatableResource for DerivationReference {
    ...
    fn profile_url() -> Option<&'static str> {
        Some("http://hl7.org/fhir/StructureDefinition/derivation-reference")
    }
}
