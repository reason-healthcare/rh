...
pub struct OrganizationPortal {
    /// Base definition inherited from FHIR specification
    #[serde(flatten)]
    pub base: Extension,
}

impl Default for OrganizationPortal {
    fn default() -> Self {
        Self {
...
impl crate::validation::ValidatableResource for OrganizationPortal {
    ...
    fn profile_url() -> Option<&'static str> {
        Some("http://hl7.org/fhir/StructureDefinition/organization-portal")
    }
}
