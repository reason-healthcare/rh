...
pub struct AlternateReference {
    /// Base definition inherited from FHIR specification
    #[serde(flatten)]
    pub base: Extension,
}

impl Default for AlternateReference {
    fn default() -> Self {
        Self {
...
impl crate::validation::ValidatableResource for AlternateReference {
    ...
    fn profile_url() -> Option<&'static str> {
        Some("http://hl7.org/fhir/StructureDefinition/alternate-reference")
    }
}
