...
pub struct WorkflowProtectiveFactor {
    /// Base definition inherited from FHIR specification
    #[serde(flatten)]
    pub base: Extension,
}

impl Default for WorkflowProtectiveFactor {
    fn default() -> Self {
        Self {
...
impl crate::validation::ValidatableResource for WorkflowProtectiveFactor {
    ...
    fn profile_url() -> Option<&'static str> {
        Some("http://hl7.org/fhir/StructureDefinition/workflow-protectiveFactor")
    }
}
