...
pub struct VersionSpecificUse {
    /// Base definition inherited from FHIR specification
    #[serde(flatten)]
    pub base: Extension,
}

impl Default for VersionSpecificUse {
    fn default() -> Self {
        Self {
...
impl crate::validation::ValidatableResource for VersionSpecificUse {
    ...
    fn profile_url() -> Option<&'static str> {
        Some("http://hl7.org/fhir/StructureDefinition/version-specific-use")
    }
}
