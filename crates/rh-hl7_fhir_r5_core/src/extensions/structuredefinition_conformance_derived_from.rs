...
pub struct StructuredefinitionConformanceDerivedFrom {
    /// Base definition inherited from FHIR specification
    #[serde(flatten)]
    pub base: Extension,
}

impl Default for StructuredefinitionConformanceDerivedFrom {
    fn default() -> Self {
        Self {
...
impl crate::validation::ValidatableResource for StructuredefinitionConformanceDerivedFrom {
    ...
    fn profile_url() -> Option<&'static str> {
        Some("http://hl7.org/fhir/StructureDefinition/structuredefinition-conformance-derivedFrom")
    }
}
