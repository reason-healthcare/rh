...
pub struct ArtifactTopic {
    /// Base definition inherited from FHIR specification
    #[serde(flatten)]
    pub base: Extension,
}

impl Default for ArtifactTopic {
    fn default() -> Self {
        Self {
...
impl crate::validation::ValidatableResource for ArtifactTopic {
    ...
    fn profile_url() -> Option<&'static str> {
        Some("http://hl7.org/fhir/StructureDefinition/artifact-topic")
    }
}
