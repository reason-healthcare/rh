...
/// MetadataResource Publish Date
///
/// The date this artifact was first published.
///
/// **Source:**
...
pub struct MetadataresourcePublishDate {
    /// Base definition inherited from FHIR specification
    #[serde(flatten)]
    pub base: Extension,
}

impl Default for MetadataresourcePublishDate {
    fn default() -> Self {
        Self {
...
impl crate::validation::ValidatableResource for MetadataresourcePublishDate {
    ...
    fn profile_url() -> Option<&'static str> {
        Some("http://hl7.org/fhir/StructureDefinition/metadataresource-publish-date")
    }
}
