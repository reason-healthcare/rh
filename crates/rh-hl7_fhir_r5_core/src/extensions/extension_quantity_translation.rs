...
pub struct ExtensionQuantityTranslation {
    /// Base definition inherited from FHIR specification
    #[serde(flatten)]
    pub base: Extension,
}

impl Default for ExtensionQuantityTranslation {
    fn default() -> Self {
        Self {
...
impl crate::validation::ValidatableResource for ExtensionQuantityTranslation {
    ...
    fn profile_url() -> Option<&'static str> {
        Some("http://hl7.org/fhir/StructureDefinition/extension-quantity-translation")
    }
}
