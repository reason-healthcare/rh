...
impl crate::validation::ValidatableResource for ArtifactassessmentWorkflowStatus {
    ...
    fn profile_url() -> Option<&'static str> {
        Some("http://hl7.org/fhir/StructureDefinition/artifactassessment-workflowStatus")
    }
}
