...
pub struct ArtifactDate {
    /// Base definition inherited from FHIR specification
    #[serde(flatten)]
    pub base: Extension,
}

impl Default for ArtifactDate {
    fn default() -> Self {
        Self {
...
impl crate::validation::ValidatableResource for ArtifactDate {
    ...
    fn profile_url() -> Option<&'static str> {
        Some("http://hl7.org/fhir/StructureDefinition/artifact-date")
    }
}
