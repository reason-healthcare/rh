...
pub struct QuestionnaireDefinitionBased {
    /// Base definition inherited from FHIR specification
    #[serde(flatten)]
    pub base: Extension,
}

impl Default for QuestionnaireDefinitionBased {
    fn default() -> Self {
        Self {
...
impl crate::validation::ValidatableResource for QuestionnaireDefinitionBased {
    ...
    fn profile_url() -> Option<&'static str> {
        Some("http://hl7.org/fhir/StructureDefinition/questionnaire-definitionBased")
    }
}
