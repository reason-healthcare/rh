...
pub struct ArtifactPeriodDuration {
    /// Base definition inherited from FHIR specification
    #[serde(flatten)]
    pub base: Extension,
}

impl Default for ArtifactPeriodDuration {
    fn default() -> Self {
        Self {
...
impl crate::validation::ValidatableResource for ArtifactPeriodDuration {
    ...
    fn profile_url() -> Option<&'static str> {
        Some("http://hl7.org/fhir/StructureDefinition/artifact-periodDuration")
    }
}
