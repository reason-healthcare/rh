...
pub struct DosageConditions {
    /// Base definition inherited from FHIR specification
    #[serde(flatten)]
    pub base: Extension,
}

impl Default for DosageConditions {
    fn default() -> Self {
        Self {
...
impl crate::validation::ValidatableResource for DosageConditions {
    ...
    fn profile_url() -> Option<&'static str> {
        Some("http://hl7.org/fhir/StructureDefinition/dosage-conditions")
    }
}
