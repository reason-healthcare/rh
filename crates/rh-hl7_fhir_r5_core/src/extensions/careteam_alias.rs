...
pub struct CareteamAlias {
    /// Base definition inherited from FHIR specification
    #[serde(flatten)]
    pub base: Extension,
}

impl Default for CareteamAlias {
    fn default() -> Self {
        Self {
...
impl crate::validation::ValidatableResource for CareteamAlias {
    ...
    fn profile_url() -> Option<&'static str> {
        Some("http://hl7.org/fhir/StructureDefinition/careteam-alias")
    }
}
