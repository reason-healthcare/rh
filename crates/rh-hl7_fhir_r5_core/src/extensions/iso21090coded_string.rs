...
pub struct Iso21090CodedString {
    /// Base definition inherited from FHIR specification
    #[serde(flatten)]
    pub base: Extension,
}

impl Default for Iso21090CodedString {
    fn default() -> Self {
        Self {
...
impl crate::validation::ValidatableResource for Iso21090CodedString {
    ...
    fn profile_url() -> Option<&'static str> {
        Some("http://hl7.org/fhir/StructureDefinition/iso21090-codedString")
    }
}
