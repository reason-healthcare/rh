...
pub static BINDINGS: once_cell::sync::Lazy<Vec<rh_foundation::ElementBinding>> =
    once_cell::sync::Lazy::new(|| {
        vec![
    rh_foundation::ElementBinding::new("Extension.value[x]", rh_foundation::BindingStrength::Required, "http://terminology.hl7.org/ValueSet/conformance-expectation").with_description("Indicates the degree of adherence to a specified behavior or capability expected for a system to be deemed conformant with a specification."),
]
    });
...
impl crate::validation::ValidatableResource for CapabilitystatementExpectation {
    ...
    fn profile_url() -> Option<&'static str> {
        Some("http://hl7.org/fhir/StructureDefinition/capabilitystatement-expectation")
    }
}
