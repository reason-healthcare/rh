...
pub struct ElementdefinitionDefaulttype {
    /// Base definition inherited from FHIR specification
    #[serde(flatten)]
    pub base: Extension,
}

impl Default for ElementdefinitionDefaulttype {
    fn default() -> Self {
        Self {
...
impl crate::validation::ValidatableResource for ElementdefinitionDefaulttype {
    ...
    fn profile_url() -> Option<&'static str> {
        Some("http://hl7.org/fhir/StructureDefinition/elementdefinition-defaulttype")
    }
}
