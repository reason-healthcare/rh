...
pub struct ElementdefinitionSuppress {
    /// Base definition inherited from FHIR specification
    #[serde(flatten)]
    pub base: Extension,
}

impl Default for ElementdefinitionSuppress {
    fn default() -> Self {
        Self {
...
impl crate::validation::ValidatableResource for ElementdefinitionSuppress {
    ...
    fn profile_url() -> Option<&'static str> {
        Some("http://hl7.org/fhir/StructureDefinition/elementdefinition-suppress")
    }
}
