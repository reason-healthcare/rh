...
/// Device Last maintenance time
///
/// DateTime of the last time the device was subject to maintenance.
///
/// **Source:**
...
pub struct DeviceLastmaintenancetime {
    /// Base definition inherited from FHIR specification
    #[serde(flatten)]
    pub base: Extension,
}

impl Default for DeviceLastmaintenancetime {
    fn default() -> Self {
        Self {
...
impl crate::validation::ValidatableResource for DeviceLastmaintenancetime {
    ...
    fn profile_url() -> Option<&'static str> {
        Some("http://hl7.org/fhir/StructureDefinition/device-lastmaintenancetime")
    }
}
