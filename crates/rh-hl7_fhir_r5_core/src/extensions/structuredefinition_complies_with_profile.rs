...
pub struct StructuredefinitionCompliesWithProfile {
    /// Base definition inherited from FHIR specification
    #[serde(flatten)]
    pub base: Extension,
}

impl Default for StructuredefinitionCompliesWithProfile {
    fn default() -> Self {
        Self {
...
impl crate::validation::ValidatableResource for StructuredefinitionCompliesWithProfile {
    ...
    fn profile_url() -> Option<&'static str> {
        Some("http://hl7.org/fhir/StructureDefinition/structuredefinition-compliesWithProfile")
    }
}
