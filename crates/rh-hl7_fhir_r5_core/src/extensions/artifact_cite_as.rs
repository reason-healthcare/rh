...
/// Artifact Cite As
///
/// How to cite the resource/artifact.
///
/// **Source:**
...
pub struct ArtifactCiteAs {
    /// Base definition inherited from FHIR specification
    #[serde(flatten)]
    pub base: Extension,
}

impl Default for ArtifactCiteAs {
    fn default() -> Self {
        Self {
...
impl crate::validation::ValidatableResource for ArtifactCiteAs {
    ...
    fn profile_url() -> Option<&'static str> {
        Some("http://hl7.org/fhir/StructureDefinition/artifact-citeAs")
    }
}
