...
pub struct OrganizationBrand {
    /// Base definition inherited from FHIR specification
    #[serde(flatten)]
    pub base: Extension,
}

impl Default for OrganizationBrand {
    fn default() -> Self {
        Self {
...
impl crate::validation::ValidatableResource for OrganizationBrand {
    ...
    fn profile_url() -> Option<&'static str> {
        Some("http://hl7.org/fhir/StructureDefinition/organization-brand")
    }
}
