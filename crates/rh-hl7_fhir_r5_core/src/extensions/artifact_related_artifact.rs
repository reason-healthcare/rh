...
pub struct ArtifactRelatedArtifact {
    /// Base definition inherited from FHIR specification
    #[serde(flatten)]
    pub base: Extension,
}

impl Default for ArtifactRelatedArtifact {
    fn default() -> Self {
        Self {
...
impl crate::validation::ValidatableResource for ArtifactRelatedArtifact {
    ...
    fn profile_url() -> Option<&'static str> {
        Some("http://hl7.org/fhir/StructureDefinition/artifact-relatedArtifact")
    }
}
