...
pub struct ArtifactCopyrightLabel {
    /// Base definition inherited from FHIR specification
    #[serde(flatten)]
    pub base: Extension,
}

impl Default for ArtifactCopyrightLabel {
    fn default() -> Self {
        Self {
...
impl crate::validation::ValidatableResource for ArtifactCopyrightLabel {
    ...
    fn profile_url() -> Option<&'static str> {
        Some("http://hl7.org/fhir/StructureDefinition/artifact-copyrightLabel")
    }
}
