...
pub struct NoFixedAddress {
    /// Base definition inherited from FHIR specification
    #[serde(flatten)]
    pub base: Extension,
}

impl Default for NoFixedAddress {
    fn default() -> Self {
        Self {
...
impl crate::validation::ValidatableResource for NoFixedAddress {
    ...
    fn profile_url() -> Option<&'static str> {
        Some("http://hl7.org/fhir/StructureDefinition/no-fixed-address")
    }
}
