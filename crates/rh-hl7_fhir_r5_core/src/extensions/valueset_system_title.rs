...
impl Default for ValuesetSystemTitle {
    fn default() -> Self {
        Self {
...
impl crate::validation::ValidatableResource for ValuesetSystemTitle {
    ...
    fn profile_url() -> Option<&'static str> {
        Some("http://hl7.org/fhir/StructureDefinition/valueset-systemTitle")
    }
}
