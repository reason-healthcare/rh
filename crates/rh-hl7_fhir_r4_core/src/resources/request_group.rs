...
pub static CARDINALITIES: once_cell::sync::Lazy<Vec<rh_foundation::ElementCardinality>> =
    once_cell::sync::Lazy::new(|| {
        vec![
            ...
            rh_foundation::ElementCardinality::new("RequestGroup.identifier", 0, None),
            rh_foundation::ElementCardinality::new("RequestGroup.instantiatesCanonical", 0, None),
            rh_foundation::ElementCardinality::new("RequestGroup.instantiatesUri", 0, None),
...
pub use crate::traits::request_group::{
    RequestGroupAccessors, RequestGroupExistence, RequestGroupMutators,
};
