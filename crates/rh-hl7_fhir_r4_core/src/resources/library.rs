...
pub struct Library {
    ...
    /// Type of individual the library content is focused on (CodeableConcept)
    #[serde(rename = "subjectCodeableConcept")]
    pub subject_codeable_concept: Option<CodeableConcept>,
    /// Type of individual the library content is focused on (Reference)
...
impl crate::traits::resource::ResourceAccessors for Library {
...
impl crate::traits::resource::ResourceMutators for Library {
    fn new() -> Self {
        Self::default()
    }
...
impl crate::traits::resource::ResourceExistence for Library {
    fn has_id(&self) -> bool {
...
impl crate::traits::domain_resource::DomainResourceAccessors for Library {
...
impl crate::traits::domain_resource::DomainResourceMutators for Library {
    fn new() -> Self {
        Self::default()
    }
...
impl crate::traits::domain_resource::DomainResourceExistence for Library {
    fn has_id(&self) -> bool {
        self.base.base.id.is_some()
    }
    fn has_meta(&self) -> bool {
...
impl crate::traits::library::LibraryAccessors for Library {
...
impl crate::traits::library::LibraryMutators for Library {
    fn new() -> Self {
        Self::default()
    }
...
impl crate::traits::library::LibraryExistence for Library {
    fn has_id(&self) -> bool {
        self.base.base.id.is_some()
    }
    fn has_meta(&self) -> bool {
...
impl crate::validation::ValidatableResource for Library {
    ...
    fn profile_url() -> Option<&'static str> {
        Some("http://hl7.org/fhir/StructureDefinition/Library")
    }
}

// Re-export traits for convenient importing
// This allows users to just import the resource module and get all associated traits
pub use crate::traits::library::{LibraryAccessors, LibraryExistence, LibraryMutators};
