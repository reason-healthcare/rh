...
pub trait EvidenceAccessors: DomainResourceAccessors {
    ...
    /// Returns a reference to the exposureBackground field.
    fn exposure_background(&self) -> Reference;
    /// Returns a reference to the exposureVariant field.
...
pub trait EvidenceMutators: DomainResourceMutators {
    ...
    /// # Example
    /// ```rust
    /// use rh_hl7_fhir_r4_core::resources::evidence::Evidence;
    /// use rh_hl7_fhir_r4_core::traits::evidence::EvidenceMutators;
    ///
    ...
    /// Sets the exposureBackground field and returns self for chaining.
    fn set_exposure_background(self, value: Reference) -> Self;
    /// Sets the exposureVariant field and returns self for chaining.
    fn set_exposure_variant(self, value: Vec<Reference>) -> Self;
    /// Adds an item to the exposureVariant field and returns self for chaining.
...
pub trait EvidenceExistence: DomainResourceExistence {
    ...
    /// Returns true if the exposure_background field is present (Some).
    fn has_exposure_background(&self) -> bool;
    /// Returns true if the exposure_variant field is not empty.
