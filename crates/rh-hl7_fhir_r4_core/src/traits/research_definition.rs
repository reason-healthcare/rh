...
pub trait ResearchDefinitionAccessors: DomainResourceAccessors {
...
/// - Type: ResearchDefinition
/// - Base Definition: http://hl7.org/fhir/StructureDefinition/DomainResource
pub trait ResearchDefinitionMutators: DomainResourceMutators {
    /// Create a new ResearchDefinition with default/empty values.
    ///
    ...
    /// # Example
    /// ```rust
    /// use rh_hl7_fhir_r4_core::resources::research_definition::ResearchDefinition;
    /// use rh_hl7_fhir_r4_core::traits::research_definition::ResearchDefinitionMutators;
    ///
    /// let resource = ResearchDefinition::new();
    ...
    /// Adds an item to the comment field and returns self for chaining.
...
/// ResearchDefinition Existence Checks
///
...
/// - Type: ResearchDefinition
/// - Base Definition: http://hl7.org/fhir/StructureDefinition/DomainResource
pub trait ResearchDefinitionExistence: DomainResourceExistence {
    ...
    /// Returns true if the comment field is not empty.
