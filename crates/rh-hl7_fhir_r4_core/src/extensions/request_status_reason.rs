...
pub struct RequestStatusReason {
    /// Base definition inherited from FHIR specification
    #[serde(flatten)]
    pub base: Extension,
}

impl Default for RequestStatusReason {
    fn default() -> Self {
        Self {
...
impl crate::validation::ValidatableResource for RequestStatusReason {
    ...
    fn profile_url() -> Option<&'static str> {
        Some("http://hl7.org/fhir/StructureDefinition/request-statusReason")
    }
}
