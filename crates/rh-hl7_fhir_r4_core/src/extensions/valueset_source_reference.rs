...
impl Default for ValuesetSourceReference {
    fn default() -> Self {
        Self {
...
impl crate::validation::ValidatableResource for ValuesetSourceReference {
    ...
    fn profile_url() -> Option<&'static str> {
        Some("http://hl7.org/fhir/StructureDefinition/valueset-sourceReference")
    }
}
