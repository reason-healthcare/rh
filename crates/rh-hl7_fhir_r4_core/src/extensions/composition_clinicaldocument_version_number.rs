...
impl crate::validation::ValidatableResource for CompositionClinicaldocumentVersionNumber {
    ...
    fn profile_url() -> Option<&'static str> {
        Some("http://hl7.org/fhir/StructureDefinition/composition-clinicaldocument-versionNumber")
    }
}
