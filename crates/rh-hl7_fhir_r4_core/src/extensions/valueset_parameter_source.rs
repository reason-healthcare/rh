...
pub static BINDINGS: once_cell::sync::Lazy<Vec<rh_foundation::ElementBinding>> =
    once_cell::sync::Lazy::new(|| {
        vec![rh_foundation::ElementBinding::new(
            ...
            "http://hl7.org/fhir/ValueSet/expansion-parameter-source|4.0.1",
        )
        .with_description("Declares what the source of a parameter is.")]
    });
...
impl crate::validation::ValidatableResource for ValuesetParameterSource {
    ...
    fn profile_url() -> Option<&'static str> {
        Some("http://hl7.org/fhir/StructureDefinition/valueset-parameterSource")
    }
}
