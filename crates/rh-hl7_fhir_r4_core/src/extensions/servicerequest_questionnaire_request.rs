...
impl crate::validation::ValidatableResource for ServicerequestQuestionnaireRequest {
    ...
    fn profile_url() -> Option<&'static str> {
        Some("http://hl7.org/fhir/StructureDefinition/servicerequest-questionnaireRequest")
    }
}
