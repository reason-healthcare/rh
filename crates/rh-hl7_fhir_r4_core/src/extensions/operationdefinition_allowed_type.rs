...
impl crate::validation::ValidatableResource for OperationdefinitionAllowedType {
    ...
    fn profile_url() -> Option<&'static str> {
        Some("http://hl7.org/fhir/StructureDefinition/operationdefinition-allowed-type")
    }
}
