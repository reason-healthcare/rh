...
impl crate::validation::ValidatableResource for CapabilitystatementSupportedSystem {
    ...
    fn profile_url() -> Option<&'static str> {
        Some("http://hl7.org/fhir/StructureDefinition/capabilitystatement-supported-system")
    }
}
