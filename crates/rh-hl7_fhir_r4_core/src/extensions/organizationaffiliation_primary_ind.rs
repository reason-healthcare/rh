...
impl Default for OrganizationaffiliationPrimaryInd {
    fn default() -> Self {
        Self {
...
impl crate::validation::ValidatableResource for OrganizationaffiliationPrimaryInd {
    ...
    fn profile_url() -> Option<&'static str> {
        Some("http://hl7.org/fhir/StructureDefinition/organizationaffiliation-primaryInd")
    }
}
