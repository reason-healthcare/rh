...
impl crate::validation::ValidatableResource for ElementdefinitionBestpracticeExplanation {
    ...
    fn profile_url() -> Option<&'static str> {
        Some("http://hl7.org/fhir/StructureDefinition/elementdefinition-bestpractice-explanation")
    }
}
