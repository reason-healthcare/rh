...
pub static BINDINGS: once_cell::sync::Lazy<Vec<rh_foundation::ElementBinding>> =
    once_cell::sync::Lazy::new(|| {
        ...
        .with_description("A set of codes for each different representation of a name.")]
    });
...
impl crate::validation::ValidatableResource for Iso21090ENRepresentation {
    ...
    fn profile_url() -> Option<&'static str> {
        Some("http://hl7.org/fhir/StructureDefinition/iso21090-EN-representation")
    }
}
