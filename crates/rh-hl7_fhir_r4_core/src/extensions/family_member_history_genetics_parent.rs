...
pub static BINDINGS: once_cell::sync::Lazy<Vec<rh_foundation::ElementBinding>> =
    once_cell::sync::Lazy::new(|| {
        ...
        .with_description("Parental relationship types.")]
    });
...
impl crate::validation::ValidatableResource for FamilyMemberHistoryGeneticsParent {
    ...
    fn profile_url() -> Option<&'static str> {
        Some("http://hl7.org/fhir/StructureDefinition/family-member-history-genetics-parent")
    }
}
