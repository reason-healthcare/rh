...
impl crate::validation::ValidatableResource for Iso21090ADXPDeliveryAddressLine {
    ...
    fn profile_url() -> Option<&'static str> {
        Some("http://hl7.org/fhir/StructureDefinition/iso21090-ADXP-deliveryAddressLine")
    }
}
