...
pub static BINDINGS: once_cell::sync::Lazy<Vec<rh_foundation::ElementBinding>> =
    once_cell::sync::Lazy::new(|| {
        vec![rh_foundation::ElementBinding::new(
            ...
            "http://hl7.org/fhir/ValueSet/smart-capabilities|4.0.1",
        )
        .with_description("Codes that define what the server is capable of.")]
    });
...
impl crate::validation::ValidatableResource for Capabilities {
    ...
    fn profile_url() -> Option<&'static str> {
        Some("http://fhir-registry.smarthealthit.org/StructureDefinition/capabilities")
    }
}
