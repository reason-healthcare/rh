...
impl crate::validation::ValidatableResource for StructuredefinitionDisplayHint {
    ...
    fn profile_url() -> Option<&'static str> {
        Some("http://hl7.org/fhir/StructureDefinition/structuredefinition-display-hint")
    }
}
