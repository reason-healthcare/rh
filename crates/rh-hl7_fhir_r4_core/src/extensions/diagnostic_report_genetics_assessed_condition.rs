...
impl crate::validation::ValidatableResource for DiagnosticReportGeneticsAssessedCondition {
    ...
    fn profile_url() -> Option<&'static str> {
        Some("http://hl7.org/fhir/StructureDefinition/DiagnosticReport-geneticsAssessedCondition")
    }
}
