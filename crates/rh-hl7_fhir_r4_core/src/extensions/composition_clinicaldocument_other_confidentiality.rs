...
impl crate::validation::ValidatableResource for CompositionClinicaldocumentOtherConfidentiality {
    ...
    fn profile_url() -> Option<&'static str> {
        Some("http://hl7.org/fhir/StructureDefinition/composition-clinicaldocument-otherConfidentiality")
    }
}
