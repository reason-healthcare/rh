...
impl Default for AuditeventInstance {
    fn default() -> Self {
        Self {
...
impl crate::validation::ValidatableResource for AuditeventInstance {
    ...
    fn profile_url() -> Option<&'static str> {
        Some("http://hl7.org/fhir/StructureDefinition/auditevent-Instance")
    }
}
