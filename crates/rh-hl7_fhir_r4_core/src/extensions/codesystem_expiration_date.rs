...
impl Default for CodesystemExpirationDate {
    fn default() -> Self {
        Self {
...
impl crate::validation::ValidatableResource for CodesystemExpirationDate {
    ...
    fn profile_url() -> Option<&'static str> {
        Some("http://hl7.org/fhir/StructureDefinition/codesystem-expirationDate")
    }
}
