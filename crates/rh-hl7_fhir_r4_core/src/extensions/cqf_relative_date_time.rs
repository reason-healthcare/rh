...
pub static BINDINGS: once_cell::sync::Lazy<Vec<rh_foundation::ElementBinding>> =
    once_cell::sync::Lazy::new(|| {
        ...
        .with_description("A type that describes how two events are related in time.")]
    });
...
impl crate::validation::ValidatableResource for CQFRelativeDateTime {
    ...
    fn profile_url() -> Option<&'static str> {
        Some("http://hl7.org/fhir/StructureDefinition/cqf-relativeDateTime")
    }
}
