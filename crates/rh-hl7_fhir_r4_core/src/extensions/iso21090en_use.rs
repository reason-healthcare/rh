...
pub static BINDINGS: once_cell::sync::Lazy<Vec<rh_foundation::ElementBinding>> =
    once_cell::sync::Lazy::new(|| {
        vec![
    rh_foundation::ElementBinding::new("Extension.value[x]", rh_foundation::BindingStrength::Required, "http://terminology.hl7.org/ValueSet/v3-EntityNameUseR2|4.0.1").with_description("A set of codes advising a system or user which name in a set of names to select for a given purpose."),
]
    });
...
impl crate::validation::ValidatableResource for Iso21090ENUse {
    ...
    fn profile_url() -> Option<&'static str> {
        Some("http://hl7.org/fhir/StructureDefinition/iso21090-EN-use")
    }
}
