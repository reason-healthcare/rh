...
impl Default for CodesystemUsage {
    fn default() -> Self {
        Self {
...
impl crate::validation::ValidatableResource for CodesystemUsage {
    ...
    fn profile_url() -> Option<&'static str> {
        Some("http://hl7.org/fhir/StructureDefinition/codesystem-usage")
    }
}
