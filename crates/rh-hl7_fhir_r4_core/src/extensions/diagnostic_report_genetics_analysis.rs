...
impl crate::validation::ValidatableResource for DiagnosticReportGeneticsAnalysis {
    ...
    fn profile_url() -> Option<&'static str> {
        Some("http://hl7.org/fhir/StructureDefinition/DiagnosticReport-geneticsAnalysis")
    }
}
