...
impl crate::validation::ValidatableResource for DiagnosticReportGeneticsReferences {
    ...
    fn profile_url() -> Option<&'static str> {
        Some("http://hl7.org/fhir/StructureDefinition/DiagnosticReport-geneticsReferences")
    }
}
