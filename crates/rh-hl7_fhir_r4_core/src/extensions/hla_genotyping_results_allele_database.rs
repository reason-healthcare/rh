...
impl crate::validation::ValidatableResource for HlaGenotypingResultsAlleleDatabase {
    ...
    fn profile_url() -> Option<&'static str> {
        Some("http://hl7.org/fhir/StructureDefinition/hla-genotyping-results-allele-database")
    }
}
