...
impl crate::validation::ValidatableResource for StructuredefinitionCodegenSuper {
    ...
    fn profile_url() -> Option<&'static str> {
        Some("http://hl7.org/fhir/StructureDefinition/structuredefinition-codegen-super")
    }
}
