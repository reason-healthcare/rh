...
impl crate::validation::ValidatableResource for DiagnosticReportGeneticsFamilyMemberHistory {
    ...
    fn profile_url() -> Option<&'static str> {
        Some("http://hl7.org/fhir/StructureDefinition/DiagnosticReport-geneticsFamilyMemberHistory")
    }
}
