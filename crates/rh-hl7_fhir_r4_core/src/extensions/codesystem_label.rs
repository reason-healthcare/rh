...
impl Default for CodesystemLabel {
    fn default() -> Self {
        Self {
...
impl crate::validation::ValidatableResource for CodesystemLabel {
    ...
    fn profile_url() -> Option<&'static str> {
        Some("http://hl7.org/fhir/StructureDefinition/codesystem-label")
    }
}
