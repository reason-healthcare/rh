...
impl crate::validation::ValidatableResource for StructuredefinitionDependencies {
    ...
    fn profile_url() -> Option<&'static str> {
        Some("http://hl7.org/fhir/StructureDefinition/structuredefinition-dependencies")
    }
}
