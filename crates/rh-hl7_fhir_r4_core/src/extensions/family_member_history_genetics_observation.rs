...
impl crate::validation::ValidatableResource for FamilyMemberHistoryGeneticsObservation {
    ...
    fn profile_url() -> Option<&'static str> {
        Some("http://hl7.org/fhir/StructureDefinition/family-member-history-genetics-observation")
    }
}
