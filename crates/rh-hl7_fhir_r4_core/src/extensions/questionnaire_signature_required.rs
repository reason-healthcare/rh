...
impl crate::validation::ValidatableResource for QuestionnaireSignatureRequired {
    ...
    fn profile_url() -> Option<&'static str> {
        Some("http://hl7.org/fhir/StructureDefinition/questionnaire-signatureRequired")
    }
}
