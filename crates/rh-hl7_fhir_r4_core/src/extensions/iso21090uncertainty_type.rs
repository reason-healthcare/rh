...
pub static BINDINGS: once_cell::sync::Lazy<Vec<rh_foundation::ElementBinding>> =
    once_cell::sync::Lazy::new(|| {
        vec![rh_foundation::ElementBinding::new(
            ...
            "http://hl7.org/fhir/ValueSet/probability-distribution-type|4.0.1",
        )
        .with_description("Codes specifying the type of probability distribution.")]
    });
...
impl crate::validation::ValidatableResource for Iso21090UncertaintyType {
    ...
    fn profile_url() -> Option<&'static str> {
        Some("http://hl7.org/fhir/StructureDefinition/iso21090-uncertaintyType")
    }
}
