...
impl crate::validation::ValidatableResource for StructuredefinitionXMLNoOrder {
    ...
    fn profile_url() -> Option<&'static str> {
        Some("http://hl7.org/fhir/StructureDefinition/structuredefinition-xml-no-order")
    }
}
