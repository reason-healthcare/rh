...
pub static BINDINGS: once_cell::sync::Lazy<Vec<rh_foundation::ElementBinding>> =
    once_cell::sync::Lazy::new(|| {
        vec![rh_foundation::ElementBinding::new(
            ...
            "http://hl7.org/fhir/ValueSet/choice-list-orientation|4.0.1",
        )
        .with_description("Direction in which lists of possible answers should be displayed.")]
    });
...
impl crate::validation::ValidatableResource for QuestionnaireChoiceOrientation {
    ...
    fn profile_url() -> Option<&'static str> {
        Some("http://hl7.org/fhir/StructureDefinition/questionnaire-choiceOrientation")
    }
}
