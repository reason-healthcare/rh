...
impl crate::validation::ValidatableResource for DiagnosticReportLocationPerformed {
    ...
    fn profile_url() -> Option<&'static str> {
        Some("http://hl7.org/fhir/StructureDefinition/diagnosticReport-locationPerformed")
    }
}
