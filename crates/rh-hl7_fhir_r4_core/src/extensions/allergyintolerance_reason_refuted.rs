...
impl crate::validation::ValidatableResource for AllergyintoleranceReasonRefuted {
    ...
    fn profile_url() -> Option<&'static str> {
        Some("http://hl7.org/fhir/StructureDefinition/allergyintolerance-reasonRefuted")
    }
}
