...
impl crate::validation::ValidatableResource for ObservationGeneticsCopyNumberEvent {
    ...
    fn profile_url() -> Option<&'static str> {
        Some("http://hl7.org/fhir/StructureDefinition/observation-geneticsCopyNumberEvent")
    }
}
