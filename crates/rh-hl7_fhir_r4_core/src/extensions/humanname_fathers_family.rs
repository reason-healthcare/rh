...
impl Default for HumannameFathersFamily {
    fn default() -> Self {
        Self {
...
impl crate::validation::ValidatableResource for HumannameFathersFamily {
    ...
    fn profile_url() -> Option<&'static str> {
        Some("http://hl7.org/fhir/StructureDefinition/humanname-fathers-family")
    }
}
