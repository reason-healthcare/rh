...
impl crate::validation::ValidatableResource for ProcedureApproachBodyStructure {
    ...
    fn profile_url() -> Option<&'static str> {
        Some("http://hl7.org/fhir/StructureDefinition/procedure-approachBodyStructure")
    }
}
