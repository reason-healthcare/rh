...
pub struct StructuredefinitionWg {
    /// Base definition inherited from FHIR specification
    #[serde(flatten)]
    pub base: Extension,
}

impl Default for StructuredefinitionWg {
    fn default() -> Self {
        Self {
...
pub static BINDINGS: once_cell::sync::Lazy<Vec<rh_foundation::ElementBinding>> =
    once_cell::sync::Lazy::new(|| {
        vec![rh_foundation::ElementBinding::new(
            ...
            "http://hl7.org/fhir/ValueSet/hl7-work-group|4.0.1",
        )
        .with_description(
...
impl crate::validation::ValidatableResource for StructuredefinitionWg {
    ...
    fn profile_url() -> Option<&'static str> {
        Some("http://hl7.org/fhir/StructureDefinition/structuredefinition-wg")
    }
}
