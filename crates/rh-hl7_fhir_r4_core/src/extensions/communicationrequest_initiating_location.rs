...
impl crate::validation::ValidatableResource for CommunicationrequestInitiatingLocation {
    ...
    fn profile_url() -> Option<&'static str> {
        Some("http://hl7.org/fhir/StructureDefinition/communicationrequest-initiatingLocation")
    }
}
