...
impl crate::validation::ValidatableResource for ElementdefinitionIsCommonBinding {
    ...
    fn profile_url() -> Option<&'static str> {
        Some("http://hl7.org/fhir/StructureDefinition/elementdefinition-isCommonBinding")
    }
}
