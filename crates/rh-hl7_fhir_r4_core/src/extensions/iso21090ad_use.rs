...
pub static BINDINGS: once_cell::sync::Lazy<Vec<rh_foundation::ElementBinding>> =
    once_cell::sync::Lazy::new(|| {
        vec![rh_foundation::ElementBinding::new(
            ...
            "http://hl7.org/fhir/ValueSet/postal-address-use|4.0.1",
        )
        .with_description("Uses of an address not included in Address.use.")]
    });
...
impl crate::validation::ValidatableResource for Iso21090ADUse {
    ...
    fn profile_url() -> Option<&'static str> {
        Some("http://hl7.org/fhir/StructureDefinition/iso21090-AD-use")
    }
}
