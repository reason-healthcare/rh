...
pub struct WorkflowInstantiatesURI {
    /// Base definition inherited from FHIR specification
    #[serde(flatten)]
    pub base: Extension,
}

impl Default for WorkflowInstantiatesURI {
    fn default() -> Self {
        Self {
...
impl crate::validation::ValidatableResource for WorkflowInstantiatesURI {
    ...
    fn profile_url() -> Option<&'static str> {
        Some("http://hl7.org/fhir/StructureDefinition/workflow-instantiatesUri")
    }
}
