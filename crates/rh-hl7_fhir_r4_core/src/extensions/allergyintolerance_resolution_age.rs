...
impl crate::validation::ValidatableResource for AllergyintoleranceResolutionAge {
    ...
    fn profile_url() -> Option<&'static str> {
        Some("http://hl7.org/fhir/StructureDefinition/allergyintolerance-resolutionAge")
    }
}
