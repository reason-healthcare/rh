...
impl crate::validation::ValidatableResource for ElementdefinitionProfileElement {
    ...
    fn profile_url() -> Option<&'static str> {
        Some("http://hl7.org/fhir/StructureDefinition/elementdefinition-profile-element")
    }
}
