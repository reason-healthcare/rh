...
pub static BINDINGS: once_cell::sync::Lazy<Vec<rh_foundation::ElementBinding>> =
    once_cell::sync::Lazy::new(|| {
        vec![rh_foundation::ElementBinding::new(
            ...
            "http://hl7.org/fhir/ValueSet/questionnaireresponse-mode|4.0.1",
        )
        .with_description("Codes indicating how the questionnaire was completed.")]
    });
...
impl crate::validation::ValidatableResource for QuestionnaireresponseCompletionMode {
    ...
    fn profile_url() -> Option<&'static str> {
        Some("http://hl7.org/fhir/StructureDefinition/questionnaireresponse-completionMode")
    }
}
