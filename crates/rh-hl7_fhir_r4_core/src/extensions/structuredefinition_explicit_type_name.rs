...
impl crate::validation::ValidatableResource for StructuredefinitionExplicitTypeName {
    ...
    fn profile_url() -> Option<&'static str> {
        Some("http://hl7.org/fhir/StructureDefinition/structuredefinition-explicit-type-name")
    }
}
