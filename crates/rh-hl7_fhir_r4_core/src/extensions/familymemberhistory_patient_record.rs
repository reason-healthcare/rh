...
impl crate::validation::ValidatableResource for FamilymemberhistoryPatientRecord {
    ...
    fn profile_url() -> Option<&'static str> {
        Some("http://hl7.org/fhir/StructureDefinition/familymemberhistory-patient-record")
    }
}
