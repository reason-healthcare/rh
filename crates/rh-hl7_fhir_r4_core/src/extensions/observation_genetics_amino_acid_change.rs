...
impl crate::validation::ValidatableResource for ObservationGeneticsAminoAcidChange {
    ...
    fn profile_url() -> Option<&'static str> {
        Some("http://hl7.org/fhir/StructureDefinition/observation-geneticsAminoAcidChange")
    }
}
