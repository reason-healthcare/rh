...
impl crate::validation::ValidatableResource for StructuredefinitionApplicableVersion {
    ...
    fn profile_url() -> Option<&'static str> {
        Some("http://hl7.org/fhir/StructureDefinition/structuredefinition-applicable-version")
    }
}
