...
impl crate::validation::ValidatableResource for NutritionorderAdaptiveFeedingDevice {
    ...
    fn profile_url() -> Option<&'static str> {
        Some("http://hl7.org/fhir/StructureDefinition/nutritionorder-adaptiveFeedingDevice")
    }
}
