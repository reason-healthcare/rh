...
pub static BINDINGS: once_cell::sync::Lazy<Vec<rh_foundation::ElementBinding>> =
    once_cell::sync::Lazy::new(|| {
        vec![rh_foundation::ElementBinding::new(
            ...
            "http://hl7.org/fhir/ValueSet/sibling-relationship-codes|4.0.1",
        )
        .with_description("Sibling relationship types.")]
    });
...
impl crate::validation::ValidatableResource for FamilyMemberHistoryGeneticsSibling {
    ...
    fn profile_url() -> Option<&'static str> {
        Some("http://hl7.org/fhir/StructureDefinition/family-member-history-genetics-sibling")
    }
}
