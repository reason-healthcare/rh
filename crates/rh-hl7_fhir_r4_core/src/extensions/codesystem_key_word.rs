...
impl Default for CodesystemKeyWord {
    fn default() -> Self {
        Self {
...
impl crate::validation::ValidatableResource for CodesystemKeyWord {
    ...
    fn profile_url() -> Option<&'static str> {
        Some("http://hl7.org/fhir/StructureDefinition/codesystem-keyWord")
    }
}
