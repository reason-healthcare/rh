...
impl crate::validation::ValidatableResource for AuditeventParticipantObjectContainsStudy {
    ...
    fn profile_url() -> Option<&'static str> {
        Some("http://hl7.org/fhir/StructureDefinition/auditevent-ParticipantObjectContainsStudy")
    }
}
