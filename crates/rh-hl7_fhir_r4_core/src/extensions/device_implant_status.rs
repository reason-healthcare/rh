...
pub static BINDINGS: once_cell::sync::Lazy<Vec<rh_foundation::ElementBinding>> =
    once_cell::sync::Lazy::new(|| {
        vec![rh_foundation::ElementBinding::new(
            ...
            "http://hl7.org/fhir/ValueSet/implantStatus|4.0.1",
        )
        .with_description("A set codes that define the functional status of an implanted device.")]
    });
...
impl crate::validation::ValidatableResource for DeviceImplantStatus {
    ...
    fn profile_url() -> Option<&'static str> {
        Some("http://hl7.org/fhir/StructureDefinition/device-implantStatus")
    }
}
