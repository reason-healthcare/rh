...
impl crate::validation::ValidatableResource for StructuredefinitionNormativeVersion {
    ...
    fn profile_url() -> Option<&'static str> {
        Some("http://hl7.org/fhir/StructureDefinition/structuredefinition-normative-version")
    }
}
