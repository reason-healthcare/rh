...
pub static BINDINGS: once_cell::sync::Lazy<Vec<rh_foundation::ElementBinding>> =
    once_cell::sync::Lazy::new(|| {
        vec![rh_foundation::ElementBinding::new(
            ...
            "http://hl7.org/fhir/ValueSet/goal-acceptance-status|4.0.1",
        )
        .with_description("Codes indicating whether the goal has been accepted by a stakeholder.")]
    });
...
impl crate::validation::ValidatableResource for GoalAcceptance {
    ...
    fn profile_url() -> Option<&'static str> {
        Some("http://hl7.org/fhir/StructureDefinition/goal-acceptance")
    }
}
