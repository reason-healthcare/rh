...
impl crate::validation::ValidatableResource for DevicerequestPatientInstruction {
    ...
    fn profile_url() -> Option<&'static str> {
        Some("http://hl7.org/fhir/StructureDefinition/devicerequest-patientInstruction")
    }
}
