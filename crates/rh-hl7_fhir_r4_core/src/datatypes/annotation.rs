...
pub static CARDINALITIES: once_cell::sync::Lazy<Vec<rh_foundation::ElementCardinality>> =
    once_cell::sync::Lazy::new(|| {
        vec![
            rh_foundation::ElementCardinality::new("Annotation.id", 0, Some(1)),
            rh_foundation::ElementCardinality::new("Annotation.extension", 0, None),
            rh_foundation::ElementCardinality::new("Annotation.author[x]", 0, Some(1)),
            rh_foundation::ElementCardinality::new("Annotation.time", 0, Some(1)),
            rh_foundation::ElementCardinality::new("Annotation.text", 1, Some(1)),
        ]
    });
