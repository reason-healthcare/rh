...
impl crate::validation::ValidatableResource for QuestionnaireresponseSignature {
    ...
    fn profile_url() -> Option<&'static str> {
        Some("http://hl7.org/fhir/StructureDefinition/questionnaireresponse-signature")
    }
}
