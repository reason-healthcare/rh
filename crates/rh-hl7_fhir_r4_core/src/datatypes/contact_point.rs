...
pub static BINDINGS: once_cell::sync::Lazy<Vec<rh_foundation::ElementBinding>> =
    once_cell::sync::Lazy::new(|| {
        vec![
            ...
            .with_description("Telecommunications form for contact point."),
            rh_foundation::ElementBinding::new(
                "ContactPoint.use",
                rh_foundation::BindingStrength::Required,
                "http://hl7.org/fhir/ValueSet/contact-point-use|4.0.1",
            )
            .with_description("Use of contact point."),
        ]
    });
...
pub static CARDINALITIES: once_cell::sync::Lazy<Vec<rh_foundation::ElementCardinality>> =
    once_cell::sync::Lazy::new(|| {
        vec![
            rh_foundation::ElementCardinality::new("ContactPoint.id", 0, Some(1)),
            rh_foundation::ElementCardinality::new("ContactPoint.extension", 0, None),
            rh_foundation::ElementCardinality::new("ContactPoint.system", 0, Some(1)),
            rh_foundation::ElementCardinality::new("ContactPoint.value", 0, Some(1)),
            rh_foundation::ElementCardinality::new("ContactPoint.use", 0, Some(1)),
            rh_foundation::ElementCardinality::new("ContactPoint.rank", 0, Some(1)),
            rh_foundation::ElementCardinality::new("ContactPoint.period", 0, Some(1)),
        ]
    });
