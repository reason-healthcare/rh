...
pub static CARDINALITIES: once_cell::sync::Lazy<Vec<rh_foundation::ElementCardinality>> =
    once_cell::sync::Lazy::new(|| {
        vec![
            rh_foundation::ElementCardinality::new("CodeableConcept.id", 0, Some(1)),
            rh_foundation::ElementCardinality::new("CodeableConcept.extension", 0, None),
            rh_foundation::ElementCardinality::new("CodeableConcept.coding", 0, None),
            rh_foundation::ElementCardinality::new("CodeableConcept.text", 0, Some(1)),
        ]
    });
