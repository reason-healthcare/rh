use crate::resources::evidence_variable::EvidenceVariable;
...
pub struct Picoelement {
    /// Base definition inherited from FHIR specification
    #[serde(flatten)]
    pub base: EvidenceVariable,
}
...
pub static INVARIANTS: once_cell::sync::Lazy<Vec<rh_foundation::Invariant>> =
    ...
    rh_foundation::Invariant::new("evv-0", rh_foundation::Severity::Warning, "Name should be usable as an identifier for the module by machine processing applications such as code generation", "name.matches('[A-Z]([A-Za-z0-9_]){0,254}')").with_xpath("not(exists(f:name/@value)) or matches(f:name/@value, '[A-Z]([A-Za-z0-9_]){0,254}')"),
...
pub static CARDINALITIES: once_cell::sync::Lazy<Vec<rh_foundation::ElementCardinality>> =
    once_cell::sync::Lazy::new(|| {
        vec![
            rh_foundation::ElementCardinality::new("EvidenceVariable", 0, None),
...
impl crate::traits::resource::ResourceAccessors for Picoelement {
...
impl crate::traits::resource::ResourceMutators for Picoelement {
    fn new() -> Self {
        Self::default()
    }
...
impl crate::traits::resource::ResourceExistence for Picoelement {
    fn has_id(&self) -> bool {
        self.base.has_id()
    }
...
impl crate::traits::picoelement::PicoelementMutators for Picoelement {
    fn new() -> Self {
        Self::default()
    }
}

impl crate::validation::ValidatableResource for Picoelement {
    ...
    fn profile_url() -> Option<&'static str> {
        Some("http://hl7.org/fhir/StructureDefinition/picoelement")
    }
}

// Re-export traits for convenient importing
// This allows users to just import the resource module and get all associated traits
pub use crate::traits::picoelement::{
    PicoelementAccessors, PicoelementExistence, PicoelementMutators,
};
