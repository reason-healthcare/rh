...
pub struct Devicemetricobservation {
...
pub static CARDINALITIES: once_cell::sync::Lazy<Vec<rh_foundation::ElementCardinality>> =
    once_cell::sync::Lazy::new(|| {
        vec![
            ...
            rh_foundation::ElementCardinality::new("Observation.encounter", 0, Some(0)),
            ...
            rh_foundation::ElementCardinality::new("Observation.issued", 0, Some(0)),
            ...
            rh_foundation::ElementCardinality::new("Observation.dataAbsentReason", 0, Some(0)),
            ...
            rh_foundation::ElementCardinality::new("Observation.specimen", 0, Some(0)),
            rh_foundation::ElementCardinality::new("Observation.device", 1, Some(1)),
            rh_foundation::ElementCardinality::new("Observation.referenceRange", 0, Some(1)),
...
impl crate::traits::resource::ResourceAccessors for Devicemetricobservation {
...
impl crate::traits::resource::ResourceMutators for Devicemetricobservation {
    fn new() -> Self {
        Self::default()
    }
...
impl crate::traits::resource::ResourceExistence for Devicemetricobservation {
    fn has_id(&self) -> bool {
        self.base.has_id()
    }
...
impl crate::traits::devicemetricobservation::DevicemetricobservationMutators
    for Devicemetricobservation
{
    fn new() -> Self {
        Self::default()
    }
...
impl crate::validation::ValidatableResource for Devicemetricobservation {
    ...
    fn profile_url() -> Option<&'static str> {
        Some("http://hl7.org/fhir/StructureDefinition/devicemetricobservation")
    }
}

// Re-export traits for convenient importing
// This allows users to just import the resource module and get all associated traits
pub use crate::traits::devicemetricobservation::{
    DevicemetricobservationAccessors, DevicemetricobservationExistence,
    DevicemetricobservationMutators,
};
