...
pub static CARDINALITIES: once_cell::sync::Lazy<Vec<rh_foundation::ElementCardinality>> =
    once_cell::sync::Lazy::new(|| {
        vec![
            ...
            rh_foundation::ElementCardinality::new("Library.name", 1, Some(1)),
            ...
            rh_foundation::ElementCardinality::new("Library.experimental", 1, Some(1)),
            ...
            rh_foundation::ElementCardinality::new("Library.publisher", 1, Some(1)),
...
impl crate::traits::resource::ResourceAccessors for Shareablelibrary {
...
impl crate::traits::resource::ResourceMutators for Shareablelibrary {
    fn new() -> Self {
        Self::default()
    }
...
impl crate::traits::resource::ResourceExistence for Shareablelibrary {
    fn has_id(&self) -> bool {
        self.base.has_id()
    }
...
impl crate::traits::shareablelibrary::ShareablelibraryMutators for Shareablelibrary {
    fn new() -> Self {
        Self::default()
    }
}

impl crate::validation::ValidatableResource for Shareablelibrary {
    ...
    fn profile_url() -> Option<&'static str> {
        Some("http://hl7.org/fhir/StructureDefinition/shareablelibrary")
    }
}

// Re-export traits for convenient importing
// This allows users to just import the resource module and get all associated traits
pub use crate::traits::shareablelibrary::{
    ShareablelibraryAccessors, ShareablelibraryExistence, ShareablelibraryMutators,
};
