use crate::resources::activity_definition::ActivityDefinition;
...
pub struct Shareableactivitydefinition {
    /// Base definition inherited from FHIR specification
    #[serde(flatten)]
    pub base: ActivityDefinition,
}
...
pub static CARDINALITIES: once_cell::sync::Lazy<Vec<rh_foundation::ElementCardinality>> =
    once_cell::sync::Lazy::new(|| {
        vec![
            ...
            rh_foundation::ElementCardinality::new("ActivityDefinition.name", 1, Some(1)),
            ...
            rh_foundation::ElementCardinality::new("ActivityDefinition.publisher", 1, Some(1)),
...
impl crate::traits::resource::ResourceAccessors for Shareableactivitydefinition {
...
impl crate::traits::resource::ResourceMutators for Shareableactivitydefinition {
    fn new() -> Self {
        Self::default()
    }
...
impl crate::traits::resource::ResourceExistence for Shareableactivitydefinition {
    fn has_id(&self) -> bool {
        self.base.has_id()
    }
...
impl crate::traits::shareableactivitydefinition::ShareableactivitydefinitionMutators
    for Shareableactivitydefinition
{
    fn new() -> Self {
        Self::default()
    }
...
impl crate::validation::ValidatableResource for Shareableactivitydefinition {
    ...
    fn profile_url() -> Option<&'static str> {
        Some("http://hl7.org/fhir/StructureDefinition/shareableactivitydefinition")
    }
}

// Re-export traits for convenient importing
// This allows users to just import the resource module and get all associated traits
pub use crate::traits::shareableactivitydefinition::{
    ShareableactivitydefinitionAccessors, ShareableactivitydefinitionExistence,
    ShareableactivitydefinitionMutators,
};
