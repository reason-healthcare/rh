...
pub static CARDINALITIES: once_cell::sync::Lazy<Vec<rh_foundation::ElementCardinality>> =
    once_cell::sync::Lazy::new(|| {
        vec![
            rh_foundation::ElementCardinality::new("DiagnosticReport", 1, Some(1)),
            ...
            rh_foundation::ElementCardinality::new("DiagnosticReport.result", 3, Some(4)),
            rh_foundation::ElementCardinality::new("DiagnosticReport.result", 1, Some(1)),
            rh_foundation::ElementCardinality::new("DiagnosticReport.result", 1, Some(1)),
            rh_foundation::ElementCardinality::new("DiagnosticReport.result", 1, Some(1)),
            rh_foundation::ElementCardinality::new("DiagnosticReport.result", 0, Some(1)),
            ...
            rh_foundation::ElementCardinality::new("DiagnosticReport.conclusionCode", 0, Some(0)),
            rh_foundation::ElementCardinality::new("DiagnosticReport.presentedForm", 0, None),
        ]
    });

// Trait implementations
impl crate::traits::resource::ResourceAccessors for Lipidprofile {
...
impl crate::traits::resource::ResourceMutators for Lipidprofile {
    fn new() -> Self {
        Self::default()
    }
...
impl crate::traits::resource::ResourceExistence for Lipidprofile {
    fn has_id(&self) -> bool {
        self.base.has_id()
    }
...
impl crate::traits::lipidprofile::LipidprofileMutators for Lipidprofile {
    fn new() -> Self {
        Self::default()
    }
}

impl crate::validation::ValidatableResource for Lipidprofile {
    ...
    fn profile_url() -> Option<&'static str> {
        Some("http://hl7.org/fhir/StructureDefinition/lipidprofile")
    }
}

// Re-export traits for convenient importing
// This allows users to just import the resource module and get all associated traits
pub use crate::traits::lipidprofile::{
    LipidprofileAccessors, LipidprofileExistence, LipidprofileMutators,
};
