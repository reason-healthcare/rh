...
pub static BINDINGS: once_cell::sync::Lazy<Vec<rh_foundation::ElementBinding>> =
    once_cell::sync::Lazy::new(|| {
        vec![
            ...
            .with_description("Common UCUM units for Body Temperature."),
            rh_foundation::ElementBinding::new(
...
impl crate::traits::resource::ResourceAccessors for Bodytemp {
...
impl crate::traits::resource::ResourceMutators for Bodytemp {
    fn new() -> Self {
        Self::default()
    }
...
impl crate::traits::resource::ResourceExistence for Bodytemp {
    fn has_id(&self) -> bool {
        self.base.has_id()
    }
...
impl crate::traits::bodytemp::BodytempMutators for Bodytemp {
    fn new() -> Self {
        Self::default()
    }
}

impl crate::validation::ValidatableResource for Bodytemp {
    ...
    fn profile_url() -> Option<&'static str> {
        Some("http://hl7.org/fhir/StructureDefinition/bodytemp")
    }
}

// Re-export traits for convenient importing
// This allows users to just import the resource module and get all associated traits
pub use crate::traits::bodytemp::{BodytempAccessors, BodytempExistence, BodytempMutators};
