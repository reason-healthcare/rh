...
pub static CARDINALITIES: once_cell::sync::Lazy<Vec<rh_foundation::ElementCardinality>> =
    once_cell::sync::Lazy::new(|| {
        vec![
            ...
            rh_foundation::ElementCardinality::new("Observation.value[x]", 0, Some(0)),
            ...
            rh_foundation::ElementCardinality::new("Observation.component", 2, None),
            ...
            rh_foundation::ElementCardinality::new("Observation.component", 1, Some(1)),
            rh_foundation::ElementCardinality::new("Observation.component.id", 0, Some(1)),
            rh_foundation::ElementCardinality::new("Observation.component.extension", 0, None),
            rh_foundation::ElementCardinality::new(
                "Observation.component.modifierExtension",
            ...
            rh_foundation::ElementCardinality::new("Observation.component.code", 1, Some(1)),
            rh_foundation::ElementCardinality::new("Observation.component.code.id", 0, Some(1)),
            rh_foundation::ElementCardinality::new("Observation.component.code.extension", 0, None),
            rh_foundation::ElementCardinality::new("Observation.component.code.coding", 0, None),
            rh_foundation::ElementCardinality::new("Observation.component.code.coding", 1, Some(1)),
            rh_foundation::ElementCardinality::new(
            ...
            rh_foundation::ElementCardinality::new("Observation.component.code.text", 0, Some(1)),
            rh_foundation::ElementCardinality::new("Observation.component.value[x]", 0, Some(1)),
            rh_foundation::ElementCardinality::new("Observation.component.value[x].id", 0, Some(1)),
            rh_foundation::ElementCardinality::new(
...
impl crate::traits::resource::ResourceAccessors for Bp {
...
impl crate::traits::resource::ResourceMutators for Bp {
    fn new() -> Self {
        Self::default()
    }
...
impl crate::traits::resource::ResourceExistence for Bp {
    fn has_id(&self) -> bool {
        self.base.has_id()
    }
...
impl crate::traits::bp::BpMutators for Bp {
    fn new() -> Self {
        Self::default()
    }
}

impl crate::validation::ValidatableResource for Bp {
    ...
    fn profile_url() -> Option<&'static str> {
        Some("http://hl7.org/fhir/StructureDefinition/bp")
    }
}

// Re-export traits for convenient importing
// This allows users to just import the resource module and get all associated traits
pub use crate::traits::bp::{BpAccessors, BpExistence, BpMutators};
