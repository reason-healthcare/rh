...
pub static CARDINALITIES: once_cell::sync::Lazy<Vec<rh_foundation::ElementCardinality>> =
    once_cell::sync::Lazy::new(|| {
        vec![
            ...
            rh_foundation::ElementCardinality::new("Observation.value[x]", 1, Some(1)),
...
impl crate::traits::resource::ResourceAccessors for Bmi {
...
impl crate::traits::resource::ResourceMutators for Bmi {
    fn new() -> Self {
        Self::default()
    }
...
impl crate::traits::resource::ResourceExistence for Bmi {
    fn has_id(&self) -> bool {
        self.base.has_id()
    }
...
impl crate::traits::bmi::BmiMutators for Bmi {
    fn new() -> Self {
        Self::default()
    }
}

impl crate::validation::ValidatableResource for Bmi {
    ...
    fn profile_url() -> Option<&'static str> {
        Some("http://hl7.org/fhir/StructureDefinition/bmi")
    }
}

// Re-export traits for convenient importing
// This allows users to just import the resource module and get all associated traits
pub use crate::traits::bmi::{BmiAccessors, BmiExistence, BmiMutators};
