use crate::resources::audit_event::AuditEvent;
...
impl crate::traits::resource::ResourceMutators for EhrsrleAuditevent {
    fn new() -> Self {
        Self::default()
    }
...
impl crate::traits::resource::ResourceExistence for EhrsrleAuditevent {
    fn has_id(&self) -> bool {
        self.base.has_id()
    }
...
impl crate::traits::ehrsrle_auditevent::EhrsrleAuditeventMutators for EhrsrleAuditevent {
    fn new() -> Self {
        Self::default()
    }
}

impl crate::validation::ValidatableResource for EhrsrleAuditevent {
