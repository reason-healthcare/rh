...
impl crate::traits::resource::ResourceMutators for EhrsrleProvenance {
    fn new() -> Self {
        Self::default()
    }
...
impl crate::traits::resource::ResourceExistence for EhrsrleProvenance {
    fn has_id(&self) -> bool {
        self.base.has_id()
    }
...
impl crate::traits::ehrsrle_provenance::EhrsrleProvenanceMutators for EhrsrleProvenance {
    fn new() -> Self {
        Self::default()
    }
}

impl crate::validation::ValidatableResource for EhrsrleProvenance {
