...
pub static BINDINGS: once_cell::sync::Lazy<Vec<rh_foundation::ElementBinding>> =
    once_cell::sync::Lazy::new(|| {
        vec![
    rh_foundation::ElementBinding::new("Observation.component.value[x]", rh_foundation::BindingStrength::Required, "http://hl7.org/fhir/ValueSet/ucum-vitals-common|4.0.1").with_description("Common UCUM units for recording Vital Signs."),
    rh_foundation::ElementBinding::new("Observation.status", rh_foundation::BindingStrength::Required, "http://hl7.org/fhir/ValueSet/observation-status|4.0.1"),
    rh_foundation::ElementBinding::new("Observation.value[x].code", rh_foundation::BindingStrength::Required, "http://hl7.org/fhir/ValueSet/ucum-bodylength|4.0.1").with_description("Common UCUM units for body length measures such as Body Height and Head Circumference."),
    rh_foundation::ElementBinding::new("Observation.value[x].comparator", rh_foundation::BindingStrength::Required, "http://hl7.org/fhir/ValueSet/quantity-comparator|4.0.1").with_description("How the Quantity should be understood and represented."),
]
    });
...
impl crate::traits::resource::ResourceAccessors for Headcircum {
...
impl crate::traits::resource::ResourceMutators for Headcircum {
    fn new() -> Self {
        Self::default()
    }
...
impl crate::traits::resource::ResourceExistence for Headcircum {
    fn has_id(&self) -> bool {
        self.base.has_id()
    }
...
impl crate::traits::headcircum::HeadcircumMutators for Headcircum {
    fn new() -> Self {
        Self::default()
    }
}

impl crate::validation::ValidatableResource for Headcircum {
    ...
    fn profile_url() -> Option<&'static str> {
        Some("http://hl7.org/fhir/StructureDefinition/headcircum")
    }
}

// Re-export traits for convenient importing
// This allows users to just import the resource module and get all associated traits
pub use crate::traits::headcircum::{HeadcircumAccessors, HeadcircumExistence, HeadcircumMutators};
