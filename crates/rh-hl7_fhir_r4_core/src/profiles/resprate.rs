...
impl crate::traits::resource::ResourceAccessors for Resprate {
...
impl crate::traits::resource::ResourceMutators for Resprate {
    fn new() -> Self {
        Self::default()
    }
...
impl crate::traits::resource::ResourceExistence for Resprate {
    fn has_id(&self) -> bool {
        self.base.has_id()
    }
...
impl crate::traits::resprate::ResprateMutators for Resprate {
    fn new() -> Self {
        Self::default()
    }
}

impl crate::validation::ValidatableResource for Resprate {
    ...
    fn profile_url() -> Option<&'static str> {
        Some("http://hl7.org/fhir/StructureDefinition/resprate")
    }
}

// Re-export traits for convenient importing
// This allows users to just import the resource module and get all associated traits
pub use crate::traits::resprate::{ResprateAccessors, ResprateExistence, ResprateMutators};
