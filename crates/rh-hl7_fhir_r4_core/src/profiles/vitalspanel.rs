...
pub static CARDINALITIES: once_cell::sync::Lazy<Vec<rh_foundation::ElementCardinality>> =
    once_cell::sync::Lazy::new(|| {
        vec![
            ...
            rh_foundation::ElementCardinality::new("Observation.code.coding.system", 0, Some(1)),
            rh_foundation::ElementCardinality::new("Observation.code.coding.version", 0, Some(1)),
            rh_foundation::ElementCardinality::new("Observation.code.coding.code", 0, Some(1)),
            ...
            rh_foundation::ElementCardinality::new("Observation.hasMember", 1, None),
...
impl crate::traits::resource::ResourceAccessors for Vitalspanel {
...
impl crate::traits::resource::ResourceMutators for Vitalspanel {
    fn new() -> Self {
        Self::default()
    }
...
impl crate::traits::resource::ResourceExistence for Vitalspanel {
    fn has_id(&self) -> bool {
        self.base.has_id()
    }
...
impl crate::traits::vitalspanel::VitalspanelMutators for Vitalspanel {
    fn new() -> Self {
        Self::default()
    }
}

impl crate::validation::ValidatableResource for Vitalspanel {
    ...
    fn profile_url() -> Option<&'static str> {
        Some("http://hl7.org/fhir/StructureDefinition/vitalspanel")
    }
}

// Re-export traits for convenient importing
// This allows users to just import the resource module and get all associated traits
pub use crate::traits::vitalspanel::{
    VitalspanelAccessors, VitalspanelExistence, VitalspanelMutators,
};
