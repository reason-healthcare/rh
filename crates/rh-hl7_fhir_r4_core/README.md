...
- **Generator command**:
```bash
rh codegen hl7.fhir.r4.core 4.0.1 --output crates/rh-hl7_fhir_r4_core --force --crate-name rh-hl7-fhir-r4-core
```

- **Generation timestamp**: 2026-07-29 03:16:58.925398383 +00:00
...
use rh_hl7_fhir_r4_core::resources::patient::{Patient, PatientMutators};
use rh_hl7_fhir_r4_core::prelude::*;  // Gets base traits (ResourceMutators, etc.)
use rh_hl7_fhir_r4_core::datatypes::human_name::HumanName;
...
```rust
use rh_hl7_fhir_r4_core::prelude::*;  // ValidatableResource, ResourceMutators, etc.
use rh_hl7_fhir_r4_core::resources::patient::{Patient, PatientMutators};
...
use rh_hl7_fhir_r4_core::resources::patient::Patient;
use rh_hl7_fhir_r4_core::datatypes::human_name::HumanName;
use rh_hl7_fhir_r4_core::bindings::administrative_gender::AdministrativeGender;
...
```rust
use rh_hl7_fhir_r4_core::metadata::{resolve_path, get_field_info, FhirFieldType, FhirPrimitiveType};
...
*Generated by RH codegen tool at 2026-07-29 03:16:58.925456911 +00:00*
