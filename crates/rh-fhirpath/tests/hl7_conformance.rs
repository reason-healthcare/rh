...
const KNOWN_WRONG_ANSWERS: &[&str] = &[
    ...
    "testBooleanLogicAnd::testBooleanLogicAnd3",
    "testBooleanLogicAnd::testBooleanLogicAnd7",
    "testBooleanLogicAnd::testBooleanLogicAnd9",
    "testBooleanLogicOr::testBooleanLogicOr6",
    "testBooleanLogicOr::testBooleanLogicOr8",
    "testBooleanLogicOr::testBooleanLogicOr9",
    "testBooleanLogicXOr::testBooleanLogicXOr3",
    "testBooleanLogicXOr::testBooleanLogicXOr6",
    "testBooleanLogicXOr::testBooleanLogicXOr7",
    "testBooleanLogicXOr::testBooleanLogicXOr8",
    "testBooleanLogicXOr::testBooleanLogicXOr9",
    "testCollectionBoolean::testCollectionBoolean1",
    "testCombine()::testCombine1",
    "testDivide::testDivide1",
    "testDivide::testDivide2",
    "testDollar::testDollarOrderNotAllowed",
    "testEquality::testEquality16",
    "testEquality::testEquality19",
    "testEquality::testEquality2",
    "testEquality::testEquality23",
    "testEquality::testEquality24",
    "testEquality::testEquality28",
    "testEquality::testEquality3",
    "testEquivalent::testEquivalent11",
    "testEquivalent::testEquivalent13",
    "testEquivalent::testEquivalent21",
    "testEquivalent::testEquivalent22",
    "testEquivalent::testEquivalent23",
    "testEquivalent::testEquivalent6",
    "testExists::testExists2",
    "testExp::testExp1",
    "testExp::testExp2",
    "testExtension::testExtension1",
    "testGreaterThan::testGreaterThan23",
    "testGreatorOrEqual::testGreatorOrEqual23",
    "testIif::testIif10",
    "testIif::testIif11",
    "testIif::testIif6",
    "testIif::testIif9",
    ...
    "testLessOrEqual::testLessOrEqual23",
    "testLessThan::testLessThan23",
    "testLiterals::testCollectionNotEqualEmpty",
    "testLiterals::testDateNotEqual",
    "testLiterals::testDateNotEqualTimezoneOffsetAfter",
    "testLiterals::testDateNotEqualTimezoneOffsetBefore",
    "testLiterals::testDateNotEqualUTC",
    "testLiterals::testIntegerBooleanNotFalse",
    "testLiterals::testIntegerBooleanNotTrue",
    "testLiterals::testNotInvalid",
    "testMatches::testMatchesSingleLineMode1",
    "testMinus::testMinus3",
    "testMod::testMod4",
    "testNEquality::testNEquality10",
    "testNEquality::testNEquality13",
    "testNEquality::testNEquality17",
    "testNEquality::testNEquality18",
    "testNEquality::testNEquality2",
    "testNotEquivalent::testNotEquivalent12",
    "testNotEquivalent::testNotEquivalent21",
    "testNotEquivalent::testNotEquivalent6",
    "testObservations::testPolymorphismAsA",
    "testObservations::testPolymorphismAsAFunction",
    "testObservations::testPolymorphismB",
    "testObservations::testPolymorphismIsA1",
    "testObservations::testPolymorphismIsA2",
    "testObservations::testPolymorphismIsA3",
    "testPower::testPower3",
    "testPrecedence::testPrecedence3",
    "testPrecedence::testPrecedence4",
    "testQuantity::testQuantity11",
    "testQuantity::testQuantity4",
    "testQuantity::testQuantity5",
    "testQuantity::testQuantity6",
    "testRepeat::testRepeat1",
    "testRepeat::testRepeat5",
    "testReplaceMatches::testReplaceMatches2",
    "testSubstring::testSubstring4",
    "testSubstring::testSubstring5",
    "testToString::testToString4",
    "testType::testType12",
    "testTypes::testBooleanLiteralConvertsToQuantity",
    "testTypes::testDecimalLiteralToInteger",
    "testTypes::testDecimalLiteralToQuantity",
    "testTypes::testDecimalLiteralToString",
    "testTypes::testIntegerLiteralToQuantity",
    "testTypes::testQuantityLiteralWeekToString",
    ...
    "testTypes::testStringQuantityDayLiteralToQuantity",
    "testTypes::testStringQuantityLiteralConvertsToQuantity",
    "testTypes::testStringQuantityLiteralToQuantity",
    "testTypes::testStringQuantityMonthLiteralToQuantity",
    "testTypes::testStringQuantityWeekLiteralToQuantity",
    "testTypes::testStringQuantityYearLiteralToQuantity",
    "testTypes::testStringYearConvertsToDate",
    "testTypes::testStringYearConvertsToDateTime",
