...
**Last updated**: 2026-07-11 (profile-aware instance-tree checkpoint)
...
or remained unverified. The library unit suite passes all 127 tests.
...
Unit tests (127 cases) cover parser, resolver, semantic lowering, dependency loading, definition
