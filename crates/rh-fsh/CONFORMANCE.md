...
**Last updated**: 2026-07-12 (schema-shaped root caret checkpoint)
...
|---|---:|---:|---:|---:|---:|---:|---:|---:|
| CARIN Blue Button | different | pass | 71 | 134 | 134 | 0 | 0 | 76 |
| mCODE | different | pass | 57 | 350 | 350 | 0 | 0 | 157 |
| Da Vinci CRD | different | pass | 69 | 85 | 85 | 0 | 0 | 57 |
| Da Vinci DTR | different | pass | 39 | 75 | 75 | 0 | 0 | 39 |
| Da Vinci PAS | different | pass | 20 | 158 | 158 | 0 | 0 | 109 |
...
identities: there are zero missing and zero extra resources. Of those, 411
match exactly after normalization and 509 have at least one JSON difference.
...
|---|---:|---:|---:|---:|---:|---:|---:|
| CARIN Blue Button | 0 | 31 | 16 | 1 | 0 | 1 | 27 |
| mCODE | 0 | 97 | 53 | 3 | 1 | 1 | 2 |
| Da Vinci CRD | 0 | 10 | 27 | 2 | 3 | 1 | 14 |
| Da Vinci DTR | 0 | 0 | 25 | 5 | 0 | 1 | 8 |
| Da Vinci PAS | 0 | 18 | 70 | 9 | 1 | 1 | 10 |
| IPS | 0 | 12 | 32 | 21 | 0 | 1 | 5 |
| **Total** | **0** | **168** | **223** | **41** | **5** | **6** | **66** |
...
or remained unverified. The library unit suite passes all 138 tests.
...
Unit tests (138 cases) cover parser, resolver, semantic lowering, dependency loading, definition
...
| Project-level exporter parity | High | All identities match, but 509 shared resources still differ in content |
...
| StructureDefinition differential parity | High | 223 resources first differ in constraints, slicing, fixed values, or element merging; extension context export is complete for the measured corpus |
