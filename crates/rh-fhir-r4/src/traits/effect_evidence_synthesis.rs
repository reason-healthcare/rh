...
use crate::resources::effect_evidence_synthesis::EffectEvidenceSynthesisCertainty;
use crate::resources::effect_evidence_synthesis::EffectEvidenceSynthesisEffectestimate;
use crate::resources::effect_evidence_synthesis::EffectEvidenceSynthesisResultsbyexposure;
use crate::resources::effect_evidence_synthesis::EffectEvidenceSynthesisSamplesize;
use crate::traits::domain_resource::DomainResourceAccessors;
use crate::traits::domain_resource::DomainResourceExistence;
use crate::traits::domain_resource::DomainResourceMutators;
/// EffectEvidenceSynthesis Trait
///
...
pub trait EffectEvidenceSynthesisAccessors: DomainResourceAccessors {
    ...
    /// Returns a reference to the exposureAlternative field.
    ...
    /// Returns a reference to the resultsByExposure field.
    fn results_by_exposure(&self) -> &[EffectEvidenceSynthesisResultsbyexposure];
    /// Returns a reference to the effectEstimate field.
...
/// - Type: EffectEvidenceSynthesis
/// - Base Definition: http://hl7.org/fhir/StructureDefinition/DomainResource
pub trait EffectEvidenceSynthesisMutators: DomainResourceMutators {
    /// Create a new EffectEvidenceSynthesis with default/empty values.
    ///
    ...
    /// Sets the exposureAlternative field and returns self for chaining.
    ...
    /// Sets the resultsByExposure field and returns self for chaining.
    fn set_results_by_exposure(self, value: Vec<EffectEvidenceSynthesisResultsbyexposure>) -> Self;
    /// Adds an item to the resultsByExposure field and returns self for chaining.
    fn add_results_by_exposure(self, item: EffectEvidenceSynthesisResultsbyexposure) -> Self;
    /// Sets the effectEstimate field and returns self for chaining.
    fn set_effect_estimate(self, value: Vec<EffectEvidenceSynthesisEffectestimate>) -> Self;
    /// Adds an item to the effectEstimate field and returns self for chaining.
...
/// EffectEvidenceSynthesis Existence Checks
///
...
/// - Type: EffectEvidenceSynthesis
/// - Base Definition: http://hl7.org/fhir/StructureDefinition/DomainResource
pub trait EffectEvidenceSynthesisExistence: DomainResourceExistence {
    ...
    /// Returns true if the exposure_alternative field is present (Some).
    ...
    /// Returns true if the results_by_exposure field is not empty.
    fn has_results_by_exposure(&self) -> bool;
    /// Returns true if the effect_estimate field is not empty.
