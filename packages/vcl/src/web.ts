import initWasm, * as wasm from "../wasm/rh_vcl.js";
import {
...
export const initVcl = initWasm;

function parseOptions(options: VclParseOptions = {}): wasm.ParseOptions {
  const raw = new wasm.ParseOptions();
  raw.format = options.format ?? "json";
  return raw;
}

function translateOptions(options: VclTranslateOptions = {}): wasm.TranslateOptions {
