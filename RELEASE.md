...
2. Bump versions and verify flake.nix
3. Run quality gates
...
- `packages/*/package.json` version fields — see Step 10
...
Verify package versions before publishing:
