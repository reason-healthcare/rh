...
2. Bump versions and package manifests
...
### 3. Bump Versions and Package Manifests
...
git add CHANGELOG.md Cargo.toml Cargo.lock crates/*/Cargo.toml apps/*/Cargo.toml packages/*/package.json pnpm-lock.yaml
...
**Post-merge effort**: ~10 minutes (NPM packages)
