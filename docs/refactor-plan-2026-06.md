...
| WS4 Codegen | 🔶 in progress (2026-06-15) | **4.1 done:** `just regen-r4`/`just regen-r5`/`just regen-check` recipes + CI drift detection job + golden-file tests (resource, datatype, primitive, profile, trait) + property-based parse tests. |
